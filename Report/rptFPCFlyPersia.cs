...
namespace Report
{
    public partial class rptFPCFlyPersia : DevExpress.XtraReports.UI.XtraReport
    {
        public rptFPCFlyPersia()
        {
            InitializeComponent();
        }
        ...
        private void rptFPCFlyPersia_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
          ...
          //  lblCourseId.Text = Convert.ToString(data.CourseId).ToUpper();
           ...
           // xrPictureBox3.Visible = groupcode.StartsWith("0000110") || groupcode.StartsWith("00101") || groupcode.StartsWith("00102") || groupcode.StartsWith("000010602");
            ...
            //lblGenDate.Text = "Date: " + DateTime.Now.ToString("MMM, YYYY");
        ...
        private void rptFPCFlyPersia_AfterPrint(object sender, EventArgs e)
        {
