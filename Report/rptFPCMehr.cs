...
namespace Report
{
    public partial class rptFPCMehr : DevExpress.XtraReports.UI.XtraReport
    {
        public rptFPCMehr()
        {
            InitializeComponent();
        ...
        private void rptFPCMEHR_BeforePrint(object sender, CancelEventArgs e)
        {
            //1437
        ...
        private void rptFPCMEHR_AfterPrint(object sender, EventArgs e)
        {
