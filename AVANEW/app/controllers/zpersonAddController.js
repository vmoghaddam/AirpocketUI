...
$scope.openImage = function (url) {
   ...
   $scope.bind_person_folder = function (callback) {
            ...
            trnService.getPersonFolder($scope.entity.Person.NID).then(function (response) {
			 ...
			 trnService.getCrewFiles($scope.entity.Person.NID).then(function (response) {
                $scope.loadingVisible = false;
                $scope.person_files = response.Data ;
				$scope.root_path_crew = "https://ava.airpocket.app/upload/training/crew/cockpit/" +  $scope.entity.Person.NID + '/';
    ...
    $scope.files_310 = response.Data["310"];
			...
			trnService.getCabinFiles($scope.entity.Person.NID).then(function (response) {
                $scope.loadingVisible = false;
                $scope.person_files = response.Data ;
				$scope.root_path_crew = "https://ava.airpocket.app/upload/training/crew/cabin/" +  $scope.entity.Person.NID + '/';
			...
			trnService.getDspFiles($scope.entity.Person.NID).then(function (response) {
                $scope.loadingVisible = false;
                $scope.person_files = response.Data ;
				$scope.root_path_crew = "https://ava.airpocket.app/upload/training/crew/dispatch/" +  $scope.entity.Person.NID + '/';
				  const data = response.Data;
                  $scope.files_general = response.Data["GENERAL DOCUMENTS"];
                  //$scope.files_lic = response.Data["LICENSES"];
                  //$scope.files_line = response.Data["LINE CHECK RECORDS"];
