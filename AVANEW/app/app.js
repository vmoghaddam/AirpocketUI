...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when("/apps", {
        ...
        templateUrl: "/app/views/apps.html?v=" + "666"
    });
    ...
    $routeProvider.when("/login", {
        ...
        templateUrl: "/app/views/login.html?v=112312"
    });
    ...
    $routeProvider.when("/person", {
        ...
        templateUrl: "/app/views/zperson.html?v=88781"
    });
     $routeProvider.when("/person/crew", {
        controller: "zpersonController",
        templateUrl: "/app/views/zperson.html?v=7776",
        isCrew:true,
    }); 
    ...
    $routeProvider.when("/board", {
        ...
        templateUrl: "/app/views/board.html?v=925",
        isAdmin: true,
    });
