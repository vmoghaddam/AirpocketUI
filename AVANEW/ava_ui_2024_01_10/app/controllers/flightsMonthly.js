'use strict';
app.controller('flightsMonthlyController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', '$window', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route, $window) {
  ...
  { dataField: 'AircraftType', caption: 'A/C Type', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, },
   ...
   { dataField: 'AircraftType', caption: 'A/C Type', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 130, sortIndex: 1, sortOrder: 'asc' },
    ...
    if (!authService.isAuthorized()) {
        ...
        $rootScope.page_title = '>  Flights Summary Report';


        $('.fltmonthreport').fadeIn(400, function () {
