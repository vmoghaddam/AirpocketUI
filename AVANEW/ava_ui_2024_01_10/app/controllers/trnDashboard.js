...
app.controller('trnDashboardController', ['$scope', '$location', '$routeParams', '$rootScope', 'courseService', 'authService', 'ztrnService', '$window', '$compile', function ($scope, $location, $routeParams, $rootScope, courseService, authService, trnService, $window, $compile) {
    ...
    $scope.df = (new Date()).addDays(-90);
    $scope.dt = (new Date()).addDays(90);
    $scope.date_from = {
        type: "date",
        placeholder: 'From',
        width: '100%',
    ...
    $scope.sb_rank = {
        ...
        searchEnabled: false,
        dataSource: ['Cockpit','Cabin','F/D','GRND','COMM','CAMO','MAINTENANCE','TRAINING','LEGAL','QA','FINANCIAL','HR','IT','SECURITY','MANAGEMENT',
	'FLIGT_OPS_STAFF',
	'ENG_AND_MAINT_STAFF',
	'MNG_STAFF',
	'SECURITY_STAFF',
