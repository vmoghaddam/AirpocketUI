...
app.factory('schedulingService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var _getRoutes = function (airlineid) {
        ...
        $http.get(serviceBaseNet + 'odata/flights/routes/airline/' + airlineid).then(function (response) {
    ...
    var _getRoute = function (from, to) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/route/' + from + '/' + to).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRouteDestination = function (airlineid, from) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/routes/destination/airline/' + airlineid + '/' + from).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getAirportByIATA = function (iata) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/airport/iata/' + iata).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getAverageRouteTime = function (from, to) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/routes/averagetime/' + from + '/' + to).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlights = function (cid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/customer/' + cid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getBoxFlights = function (bid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/box/' + bid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _checkPlanErrors = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/plan/checkerrors/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightsGrouped = function (cid, from, to) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/grouped/' + cid + '/' + from + '/' + to).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightsByRegister = function (cid, airport, register, from, to) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/register/' + cid + '/' + airport + '/' + register + '/' + from + '/' + to).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRealRegisters = function (cid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/aircrafts/customer/' + cid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelayCodes = function () {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/delaycodes').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelayCodeCats = function () {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/delaycodecats').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightDelayCodes = function (fid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/delaycodes/' + fid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightDelays = function (fid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/' + fid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getUpdatedFlights = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flights/updated/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getUpdatedFlightsNew = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flights/updated/new/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getPlanBase = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/base/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getPlanItemsGantt = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/plan/items/gantt/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getPlanItemsGanttCrewTest = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/plan/items/gantt/crewtest', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getPlanItemsGanttCrewAssignReg = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/plan/items/gantt/crew/assign/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getPlanLastItem = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/last/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getPlanLastItemByPlan = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/last/id/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getPlanItems = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/items/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getPlanItemsById = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/items/id', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightsGantt = function (cid, from, to, tzoffset, airport, filter) {
        var url = serviceBaseNet + 'odata/flights/gantt/customer/' + cid + '/' + from + '/' + to + '/' + tzoffset;
        if (airport)
            url += '/' + airport;
        // if (utc)
        //    url += '/' + utc;
    ...
    var _getFlightsGanttUTC = function (cid, from, to, tzoffset, airport, filter) {
        var url = serviceBaseNet + 'odata/flights/gantt/utc/customer/' + cid + '/' + from + '/' + to + '/' + tzoffset;
        if (airport)
            url += '/' + airport;
    ...
    var _getFlightsGantt2 = function (cid, from, to, tzoffset, airport, utc, filter) {
        var url = serviceBaseNet + 'odata/flights/gantt2/customer/' + cid + '/' + from + '/' + to + '/' + tzoffset;
        if (airport)
            url += '/' + airport;
    ...
    var _getFlightsGanttByFlights = function (fids, tzoffset, airport, filter) {
        ...
        //var url = serviceBaseNet + 'odata/flights/gantt/' + fids + '/'  + tzoffset;
        var url = serviceBaseNet + 'odata/flights/gantt/';
        if (airport)
            url += '/' + airport;
    ...
    var _getPlanGantt = function (cid, from, to, tzoffset, airport, filter) {
        var url = serviceBaseNet + 'odata/plan/gantt/customer/' + cid + '/' + from + '/' + to + '/' + tzoffset;
        if (airport)
            url += '/' + airport;
    ...
    var _getFlight = function (id) {
        ...
        var url = serviceBaseNet + 'odata/flight/' + id + '/' + offset;
    ...
    var _getFlightPlanGantt = function (pid, offset) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flightplanitems/gantt/plan/' + pid + '/' + offset + '/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightPlan = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flightplan/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightPlanItem = function (id, offset) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flight/plan/item/' + id + '/' + offset).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getPlanItemBoard = function (id, offset) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/plan/item/' + id + '/' + offset).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightPlanView = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flightplan/view/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightPlanSummary = function (id, offset) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flightplan/summary/' + id + '/' + offset).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightPlanAssignedRegisters = function (id, offset) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flightplans/registers/assigned/' + id + '/' + offset + '/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _checkOverlap = function (pid, vid, rid, from, to) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flightplan/register/overlaps/' + pid + '/' + vid + '/' + rid + '/' + from + '/' + to).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightPlanItems = function (pid, offset) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flightplanitems/plan/' + pid + '/' + offset + '/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightPlanItemPermits = function (id, caid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/plan/item/permits/' + id + '/' + caid + '/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightPlanCrew = function (id, caid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/plan/crew/' + id + '/' + caid + '/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightPlanCrewBox = function (boxid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/plan/crew/box/' + boxid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getBoxCrew = function (boxid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/box/crew/' + boxid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightCrew2 = function (flightid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flight/crew/2/' + flightid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFlights = function (id, df, dt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/report/flights/' + id + '?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFlightsTotal = function (df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/report/flights/total/?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewSummary = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/summary/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrew = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/crew', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewGrouped = function (cid, cockpit) {
        ...
        var deferred = $q.defer();
        $http.get($rootScope.serviceUrlNet + url).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightPlanPermits = function (id, caid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/plan/permits/' + id + '/' + caid + '/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightPermits = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/plan/permits/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightsAbnormal = function (cid, airport, std) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/abnormal/' + cid + '/' + airport + '/' + std + '/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRestDayOffCheck = function (date, pid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/rest/check/' + date + '/' + pid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRestValidation = function (boxid, pid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/rest/validation/' + boxid + '/' + pid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getOverDuty = function (date, pid, duty, flight) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/over/' + date + '/' + pid + '/' + duty + '/' + flight).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveCrewCalendar = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/crew/calendar/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightPlanCrew = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/plan/crew/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _offFlights = function (entity, callback) {
        ...
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/fdpitems/onoff', entity).then(function (response) {
    ...
    var _boxItems = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/plan/items/box', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _createFDP = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/fdp/create', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _unboxItems = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/plan/items/unbox', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlight = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/save', entity).then(function (response) {
    ...
    var _saveFlightRegister = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/register/assign', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightRegisterChange = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/register/change', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _cancelFlights = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flights/cancel', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _cancelFlightsGroup = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flights/cancel/group', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightRegisterChange2 = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/register/change2', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightRegisterChangeGroup = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/register/change/group', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightAppy = function (id) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/apply/' + id, null).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _savePlanItems = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplanitems/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _makePlanEditable = function (id) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/editable/' + id, null).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightPlanItemPermit = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flights/plan/item/permits/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _savePlanItem = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/planitem/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _updatePlanItemFlight = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/planitem/flight/update', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _shiftFlight = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flights/shift', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _savePlanItemBoard = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/planitems/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deletePlanItem = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/planitem/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deletePlanItemBoard = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/planitem/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteFlightPlanCrew = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/plan/crew/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteFlight = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteBoxCrew = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/box/crew/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deletePlanRegister = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/plan/register/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deletePlanItemPermit = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/plan/item/permit/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _savePlanRegisters = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/registers/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _savePlanRegister = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/register/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _lockPlanRegister = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/register/lock', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _unlockPlanRegister = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/register/unlock', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _savePlanInterval = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/plan/interval/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _approvePlanRegisters = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/registers/approve', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _applyPlanCalander = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/calander/apply', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _closePlan = function (id) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/close/' + id, null).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _approvePlan60 = function (id) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/approve/60/' + id, null).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _approvePlan70 = function (id) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/approve/70/' + id, null).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _savePlan = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flightplan/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightDep = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/departure/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightLog = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/log/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getLeg = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/leg/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveJLog = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/jlog/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightDelays = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/delays/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightArr = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/arrival/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightOffBlock = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/offblock', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveReportingTime = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/crew/reportingtime', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightOnBlock = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/onblock', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightTakeOff = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/takeoff', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightLanding = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/landing', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightCancel = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/cancel', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightRamp = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/ramp', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightRedirect = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/redirect', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightPax = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/pax', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightCargo = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/cargo', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightFuelArrival = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/fuel/arrival', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightFuelDeparture = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/fuel/departure', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCabinPositions = function () {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/options/1156').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCockpitPositions = function () {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/options/1159').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelaysTotalByCode = function (id, df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/total/code/' + id + '?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getSummary = function (id, df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/summary/' + id + '?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelaysTotalBySource = function (id, df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/total/source/' + id + '?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelaysTotalByRegister = function (id, df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/total/register/' + id + '?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelaysTotalByRoute = function (id, df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/total/route/' + id + '?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelaysDetailsByCode = function (id, code, df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/details/code/' + id + '/' + code + '/' + '?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelaysDetailsBySource = function (id, source, df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/details/source/' + id + '/' + source + '/' + '?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelaysDetailsByRegister = function (id, register, df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/details/register/' + id + '/' + register + '/' + '?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelaysDetailsByRoute = function (id, route, df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/details/route/' + id + '/' + route + '/' + '?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFDPChildren = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/fdp/children/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _notifyFDPCrew = function (id) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/fdp/notify/' + id, null).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFDPAssignedCrew = function (fdp) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/fdp/assigned/' + fdp).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlights = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/fights/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightCrews = function (id, arc) {
        var url = serviceBaseNet + 'odata/flight/crews/' + id;
        if (arc == 1)
            url = serviceBaseNet + 'odata/flight/crews/archive/' + id;
        var deferred = $q.defer();
        $http.get(url).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightFDPs = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flight/fdps/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getJLData = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/jldata/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCLData = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/cldata/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getJLDataLegs = function (ids) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/jldata/legs/' + ids).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCLDataLegs = function (ids) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/cldata/legs/' + ids).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightsLine = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/line/flights/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getReporting = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/fdps/reporting/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFDPs = function (cockpit, year, month) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + url).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getValidCrew = function (fdp, isvalid, cockpit) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/assign/valid/' + fdp + '/' + isvalid + '/' + cockpit).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getValidFDP = function (pid, year, month) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/fdp/assign/valid/' + pid + '/' + year + '/' + month).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getValidFDPDay = function (pid, year, month, day) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/fdp/assign/valid/' + pid + '/' + year + '/' + month + '/' + day).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFDPByYearMonth = function (crewid, year, month) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/fdp/crew/' + crewid + '/' + year + '/' + month).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewDutiesByYearMonth = function (crewid, year, month) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/roster/fdps/' + crewid + '/' + year + '/' + month).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDutiesByDay = function (type, year, month, day) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/roster/duties/' + type + '/' + year + '/' + month + '/' + day).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFDPsByYearMonth = function (year, month) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/fdp/' + year + '/' + month + '?$orderby=DutyStart').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveAssignFDPToCrew = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/crew/assign/fdp', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveAssignFDPToCrews = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/crews/assign/fdp', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveAssignFDPToCrew2 = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/crew/assign/fdp2', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveAssignFDPToCrew2Detail = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/crew/assign/fdp2/detail', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveUpdateFDPPosition = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/crew/assign/fdp/position', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveDeleteFDP = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/fdp/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveDuty = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/duty/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFDP = function (entity) {
        var deferred = $q.defer();
        $http.post(entity.IsAdmin?serviceBaseNetPlan+ 'odata/roster/fdp/save': $rootScope.serviceUrlNet + 'odata/roster/fdp/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveSTBY = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/stby/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _saveRES = function (entity) {
        var deferred = $q.defer();
        $http.post('https://fleet.caspianairlines.com/bidelay/' + 'odata/roster/stby/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteFDP = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/fdp/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveDutyDetail = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/duty/save/detail', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _IsRERRPValid = function (pid, start, end) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/fdp/isrerrpvalid/' + pid + '?start=' + _start + '&end=' + _end).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _IsEventValid = function (pid, start, end, type) {
        ...
        var _end = moment(end).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/fdp/isevent/' + pid + '/' + type + '?start=' + _start + '&end=' + _end).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveAog = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/aog/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getAogs = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/aogs/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveDeleteAog = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/aog/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveRoute = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/routes/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteRoute = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/routes/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveDelayCode = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/delaycodes/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteDelayCode = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/delaycodes/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelayCode = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/delaycodes/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDailyRosterCrew = function (dt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/roster/daily/crew?date=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDailyRosterFlights = function (dt, id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/roster/daily/crew/flight/' + id + '?date=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getSecurityRoster = function (_df, _dt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flight/report/security?dt=' + _dt + '&df=' + _df).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getSecurityRosterDH = function (_df, _dt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flight/report/security/dh?dt=' + _dt + '&df=' + _df).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _notifyDailyRoster = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/notify/roster/daily/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getBoardSummary = function (cid, year, month, day) {
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/board/summary/' + cid + '/' + year + '/' + month + '/' + day).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getBoardSummaryTotal = function (cid, year, month, day, year2, month2, day2) {
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/board/summary/total/' + cid + '/' + year + '/' + month + '/' + day + '/' + year2 + '/' + month2 + '/' + day2).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _roster = function (entity, df, dt) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/method?df=' + df + '&dt=' + dt, entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _rosterDuty = function (entity, df, dt) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/method/duty?df=' + df + '&dt=' + dt, entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _rosterTemp = function (entity, df, dt, crewid) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/method/temp?df=' + df + '&dt=' + dt + (crewid ? '&crewId=' + crewid : ''), entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _rosterPrePost = function (entity, df, dt, crewid) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/prepost?df=' + df + '&dt=' + dt + (crewid ? '&crewId=' + crewid : ''), entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _rosterTempCal = function (entity, df, dt, crewid, year, month) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/method/temp/cal?df=' + df + '&dt=' + dt + (crewid ? '&crewId=' + crewid : '') + '&year=' + year + '&month=' + month, entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _rosterDuties = function (entity, df, dt) {
        ...
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/method/duties?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _rosterSTBYs = function (entity, df, dt, loc, time) {
        ...
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/method/stbys?df=' + df + '&dt=' + dt + '&loc=' + loc + '&time=' + time).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _rosterValidate = function (entity, df, dt) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/method/validate?df=' + df + '&dt=' + dt, entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRosterSheet = function (_df, _dt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/roster/sheet?dt=' + _dt + '&df=' + _df).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRosterSheetReport = function (_df) {
        ...
        var deferred = $q.defer();
        $http.get('https://fleet.caspianairlines.com/bidelay/' + 'odata/roster/sheet/report?df=' + _df).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRosterSheetReportFP = function (_df) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/roster/sheet/report/fp?df=' + _df).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRosterCrewDetails = function (ids) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/roster/crew/details/' + ids).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewDuties = function (df, dt, ca, co) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/duties/' + ca + '/' + co + '?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRosterFDPs = function (df, dt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/roster/fdps/' + '?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getOffItems = function (df, dt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/roster/offitems/' + '?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewDutiesGrouped = function (df, dt, ca, co) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/duties/grouped/' + ca + '/' + co + '?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewForRoster = function (cid) {
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/valid/1').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewForRosterByDate = function (cid, dt) {
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/roster/crew/valid/1?dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFTLByDate = function (crewId, dt) {
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/ftl/crew/' + crewId + '?dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewDutyFlight = function (dt) {
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/dutyflight?df=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFDPStats = function (ids, dh) {
        if (!dh)
            dh = 0;
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/fdp/stat/' + ids + '/' + dh).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _checkStbyActivation = function (extended, stbyid, leg, duty, maxfdp) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/stby/ceased/stat/' + extended + '/' + stbyid + '/' + leg + '/' + duty + '/' + maxfdp).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteKeys = function () {
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delete/keys').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewsFlights = function (_dt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/flights?dt=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _fdpsOff = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/fdps/off', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _fdpsOffbyFlights = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flights/off', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteRosterFDPItems = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/fdpitem/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _activateStby = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/stby/activate', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteActivateStby = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/stby/activate/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getActivatedStbys = function (dt, df) {
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/stby/activated/list?dt=' + dt + '&df=' + df).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _rosterSendSMS = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/sms/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _dutiesSendSMS = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/duties/sms/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _dutiesSendSMSByDate = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/duties/sms/save/date', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _dutiesHideVisible = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/duties/visiblehide', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _dutiesVisible = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/duties/visible', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _dutiesHide = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/duties/hide', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _dutiesVisibleByDates = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/duties/visible/dates', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _sendSMS = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/sms/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _checkSMS = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/sms/status', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _updatePickupSMSStatus = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/sms/status/pickup/update', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _updateSMSStatus = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/sms/status/update', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getViewCrew = function (cid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/' + cid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDispatchSmsEmployees = function (cid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/dispatch/sms/employees/' + cid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightChangeHistory = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flight/change/history/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFinMonthlyReport = function (yf, yt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/fin/monthly/report/' + yf + '/' + yt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRegFlightsMonthlyReport = function (y, m, f) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/reg/flights/monthly/report/' + y + '/' + m + '/' + f).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightsMonthlyReport = function (y) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flights/monthly/report/' + y).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFixTimeMonthlyReport = function (y, m, r) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/fixtime/monthly/report/' + y + '/' + m + '/' + r).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFixTimePeriodReport = function (y, m, r) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/fixtime/period/report/' + y + '/' + m + '/' + r).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFixTimePeriodReportCrew = function (y, m, c) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/fixtime/period/report/crew/' + y + '/' + m + '/' + c).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFixTimePeriodReportCrewNoFDP = function (y, m, c) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/fixtime/period/report/crew/nofdp/' + y + '/' + m + '/' + c).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFormAReport = function (yf, yt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/forma/' + yf + '/' + yt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFormAYearlyReport = function (yf, yt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/forma/yearly/' + yf + '/' + yt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getIPAccess = function () {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/ipaccess/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveIPs = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/ips/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteIPs = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/ips/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteFixTime = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/fixtime/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFixTime = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/fixtime/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFixTimes = function () {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/fixtime/routes/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getNoCrews = function () {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flight/nocrews/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveNoCrewFDP = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/fdp/nocrew/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveNoCrewFDPGroup = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/fdp/nocrew/group/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteNoCrewFDP = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/roster/fdp/nocrew/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelayReportPeriodic = function (_df, _dt, period) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/periodic/report/' + period + '?dt=' + _dt + '&df=' + _df).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelayFlightSummary = function (_df, _dt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/flight/summary/' + '?dt=' + _dt + '&df=' + _df).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getMappedTitle = function () {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delays/mapped/').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightGUID = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/flight/guid/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveRemrak = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/log/remark/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightGroup = function (entity) {
        ...
        $http.post($rootScope.serviceUrlNet + url, entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _activeFlights = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flights/active', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _activeFlightsGroup = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flights/active/group', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteFlightGroup = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrlNet + 'odata/flight/delete/group', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _notifyDelay2 = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/notify/delay2/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _sendMVT = function (flightId, username) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/mail/mvt/' + flightId + '/' + username + '/vahid/Chico1359').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getTrainingSessionConvertingErrors = function () {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/idea/session/update/errors').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewsLight = function () {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/crew/light').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewTrainigDuties = function (crewid) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/training/duties/' + crewid + '/1').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getNiraConflicts = function (df, dt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/nira/conflicts/' + df + '/' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getOFP = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/ofp/flight/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveOFP = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceBaseNetAPI + 'api/ofp/parse/text/input', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveOFPT = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceBaseNetAPI + 'api/ofp/parse/text', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDelayedFlights = function () {
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/delayed/check/' + $rootScope.userName).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFDPsCrewCount = function (d1, d2) {
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/fdps/crew/count?dt1=' + d1 + '&dt2=' + d2).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFTLByCrewIds = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceBaseNetAPI + 'api/ftl/abs/crews/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFTLExceedAll = function (id) {
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/ftl/crew/date/range/exceed/' + '?df&dt&crew=' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDutyTimeLineMonthly = function (year, month, rank, type) {
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/duty/timeline/' + year + '/' + month + '/' + rank + '/' + type).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDutyTimeLine = function (df, dt, rank, type) {
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/duty/timeline/' + rank + '/' + type + '?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDutyTimeLineByCrew = function (df, dt, id) {
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/duty/timeline/crew/' + id + '?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewForRosterByDateNew = function (cid, dt) {
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + 'api/crew/valid/1?dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFTL = function (cid, df) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + "api/ftl/crew/date/?df=" + df + "&crew=" + cid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightTimeYear = function (cid, y) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetAPI + "api/flighttime/crew/year/" + cid + "/" + y).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
            alert(JSON.stringify(err));
            deferred.reject(Exceptions.getMessage(err));
    ...
    var _saveFixTime = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceBaseNetAPI + 'api/fixtime/save/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.saveSTBY = _saveSTBY;
	 serviceFactory.saveRES = _saveRES;
