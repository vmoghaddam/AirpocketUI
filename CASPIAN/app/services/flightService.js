...
app.factory('flightService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var serviceFactory = {};
	   var _sendCaoMVT = function (id ) {
        ...
        $http.get('https://fleet.caspianairlines.com/apicao/' + 'api/cao/mvt/'+id ).then(function (response) {
    ...
    var _getCrewFlightsTotal = function (df, dt) {
      //  var _df = moment(df).format('YYYY-MM-DDTHH:mm:sss');
        //var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/report/flights/total/?from=' + df + '&to=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlight = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl*//*serviceBaseV2*/serviceBaseNetPlan+ 'odata/flight/save', entity).then(function (response) {
	...
	//2023
	 var _cancelFlightsGroup = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl*/'https://fleet.caspianairlines.com/api2023/' + 'odata/flights/cancel/group', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightRegisterChange2 = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl*/serviceBaseNetPlan + 'odata/flight/register/change2', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	 ...
	 var _saveFlightRegisterChangeGroup = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl*//*serviceBaseV2**/serviceBaseNetPlan + 'odata/flight/register/change/group', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _shiftFlight = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl*/'https://fleet.caspianairlines.com/apinetplan/' + 'odata/flights/shift', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightLog = function (entity) {
        var deferred = $q.defer();
        $http.post(/*serviceBaseV2*/zapinet + 'odata/flight/log/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	 ...
	 var _saveFlightLog222 = function (entity) {
        var deferred = $q.defer();
    ...
    // odata/roster/fdpitem/delete
     ...
     var _dutiesSendSMS = function (entity) {
         var deferred = $q.defer();
         $http.post(/*$rootScope.serviceUrl*/'https://fleet.caspianairlines.com/apinetv12/' + 'odata/duties/sms/save', entity).then(function (response) {
             deferred.resolve(response.data);
         }, function (err, status) {
    ...
    var _dutiesSendSMSByDate = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl*/'https://fleet.caspianairlines.com/apinetv12/' + 'odata/duties/sms/save/date', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightGroup = function (entity) {
		...
		var _api=serviceBaseNetPlan;
		if ($rootScope.userName=='demo')
			_api='https://fleet.caspianairlines.com/zplan/';
        var deferred = $q.defer();

        $http.post(/*serviceBaseV2*/ _api+ url, entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _activeFlightsGroup = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl*/'https://fleet.caspianairlines.com/api2023/'  + 'odata/flights/active/group', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _getNiraConflicts = function (df,dt) {
        ...
        var deferred = $q.defer();
        $http.get(apiCAO + 'api/nira/conflicts/' + df + '/'+dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _getNiraConflicted = function (days) {


        var deferred = $q.defer();
        $http.get(apiCAO + 'api/nira/conflicted/' + days).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	 ...
	 var _notifyDelay2 = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseV2 + 'odata/notify/delay2/'+id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _getDelayedFlights = function () {
        var deferred = $q.defer();
        $http.get(serviceBaseV2 + 'odata/delayed/check/'  + $rootScope.userName).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveOFP_X = function (entity) {
        var deferred = $q.defer();
...
var _saveOFPI = function (entity) {
	...
	var _getFDR = function (url) {


        var deferred = $q.defer();
        $http.get(serviceBaseAPI + 'api/fdr/report' + url).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _saveFixTime = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceBaseAPI3 + 'api/fixtime/save/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.saveFixTime = _saveFixTime;
	  ...
	  var _getCrewFixTimePeriodReport = function (y, m, r) {
         ...
         var deferred = $q.defer();
         $http.get(zapinet + 'odata/crew/fixtime/period/report/' + y + '/' + m + '/' + r).then(function (response) {
             deferred.resolve(response.data);
         }, function (err, status) {
    ...
    var _getCrewFixTimePeriodReportNoFDP = function (y, m) {
        ...
        var deferred = $q.defer();
        $http.get(zapinet + 'odata/crew/fixtime/period/report/nofdp/' + y + '/' + m  ).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _deleteFDPs = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceBaseNet + 'odata/fdps/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFixTimePeriodReportCrewOthers = function (y, m, c) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNet + 'odata/crew/fixtime/period/report/crew/other/' + y + '/' + m + '/' + c).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.getCrewFixTimePeriodReportCrewOthers = _getCrewFixTimePeriodReportCrewOthers;
	 ...
	 var _sendMVTAPT = function (flightId,username) {

     
        var deferred = $q.defer();
        $http.get(serviceBaseAPIMSG + 'api/mail/mvt/apt/'+flightId+'/'+username+'/vahid/Chico1359/ISU'  ).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	serviceFactory.sendMVTAPT = _sendMVTAPT;
	...
	var _getCrewFixTimePeriodReportDaily = function (df,dt, r) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetBeta + 'odata/crew/fixtime/period/report/daily/' + df + '/' + dt + '/' + r+'/'+'-1').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFixTimePeriodReportCrewDaily = function (df,dt, c) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetBeta + 'odata/crew/fixtime/period/report/crew/daily/' + c + '/' + df + '/' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFixTimePeriodReportCrewNoFDPDaily = function (df, dt, c) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetBeta + 'odata/crew/fixtime/period/report/crew/nofdp/daily/' + c + '/' + df + '/' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewFixTimePeriodReportCrewOthersDaily = function (df, dt, c) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseNetBeta + 'odata/crew/fixtime/period/report/crew/other/daily/' +c + '/' + df + '/' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _runRAW = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceBaseAPICER + 'api/raw', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _updateATC = function (id,fn) {
        ...
        var deferred = $q.defer();
        $http.get("https://fleet.caspianairlines.com/apiatc/" + 'api/flight/atc/update/' + id + '/' + fn).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _updateATL = function (id, fn) {
        ...
        var deferred = $q.defer();
        $http.get("https://fleet.caspianairlines.com/apiatc/" + 'api/flight/atl/update/'+id+'/'+fn).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.updateATL = _updateATL;
	 ...
	 var _saveATC = function (entity) {
        var deferred = $q.defer();
        $http.post("https://fleet.caspianairlines.com/apiatc/" + 'api/atc/text/input', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getATC = function (id) {
        var deferred = $q.defer();
        $http.get("https://fleet.caspianairlines.com/apiatc/" + 'api/atc/text/get/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.getATC = _getATC;
	 ...
	 var _getLoginInfo = function (df,dt,user,city) {
        var deferred = $q.defer();
        $http.get("https://fleet.caspianairlines.com/apiprofile/" + 'api/login/info/?df=' + df+'&dt='+dt+'&user='+user+'&city='+city).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.getLoginInfo = _getLoginInfo;
    
	
	
	var _sendDelayNira = function (id) {
        var deferred = $q.defer();
        $http.get("https://fleet.caspianairlines.com/apimsg/" + 'api/nira/delay/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.sendDelayNira = _sendDelayNira;
...
serviceFactory.getDelayedFlights = _getDelayedFlights;
	...
	serviceFactory.getNiraConflicted = _getNiraConflicted;
