...
app.factory('authService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', '$location', '$rootScope', function ($http, $q, localStorageService, ngAuthSettings, $location, $rootScope) {
 ...
 console.error("HTTP ERROR:", err); 
	...
	var _disable = function (entity) {
        var deferred = $q.defer();
        $http.post('https://fleet.caspianairlines.com/apinetv12/'+ 'odata/users/disable', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _enable = function (entity) {
        var deferred = $q.defer();
        $http.post('https://fleet.caspianairlines.com/apinetv12/' + 'odata/users/enable', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
