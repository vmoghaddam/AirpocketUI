...
app.factory('fdmService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var _get_fmd_ewma_captain = function (dt1, dt2, cid,position) {
        var deferred = $q.defer();
        $http.get(api_fdm + "api/fdm/V2/EWMACptFo/" + dt1 + "/" + dt2 + "/" + cid+"/" + position).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
        });
        return deferred.promise;
    ...
    var _get_fmd_cpt_pareto = function (dt1, dt2, top, cpt_id,position) {
        var deferred = $q.defer();
        $http.get(api_fdm + "api/fdm/V2/ParetoEventCptFo/" + dt1 + "/" + dt2 + "/" + top + "/" + cpt_id + "/" + position).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
        });
        return deferred.promise;
    ...
    //-----------------------------------------------------------------
    var _get_fmd_monthlyCPT = function (dt1, dt2,cid) {
        var deferred = $q.defer();
        $http.get(api_fdm + "api/fdm/V2/MonthlyCPT/" + dt1 + "/" + dt2 + "/" +cid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
        });
        return deferred.promise;
    ...
    var _get_fmd_crew_id = function (cid, dt1, dt2,position) {
        var deferred = $q.defer();
        $http.get(api_fdm + "api/fdm/V2/crew/" + cid + "/" + dt1 + "/" + dt2 + "/" + position).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
            // deferred.reject(Exeptions.getMessage(err));
        });
    ...
    var _get_fmd_crew_phase_id = function (cid, dt1, dt2,position) {
        var deferred = $q.defer();
        $http.get(api_fdm + "api/fdm/V2/crew/phase/" + cid + "/" + dt1 + "/" + dt2+"/"+position).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
            // deferred.reject(Exeptions.getMessage(err));
        });
    ...
    var _get_fmd_crew_phase_route_id = function (cid, dt1, dt2,position) {
        var deferred = $q.defer();
        $http.get(api_fdm + "api/fdm/V2/crew/route/phase/" + cid + "/" + dt1 + "/" + dt2 + "/" + position).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
            // deferred.reject(Exeptions.getMessage(err));
        });
    ...
    var _get_fmd_event_info_new = function (dt1, dt2, type, register_id, cpt_id, route, phase, severity,position) {
        var deferred = $q.defer();

        $http.get(api_fdm + "api/fdm/V2/eventsInfo/" + dt1 + "/" + dt2 + "/" + type + "/" + register_id + "/" + cpt_id + "/" + encodeURIComponent(route) + "/" + phase + "/" + severity + "/" + position).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
            // deferred.reject(Exeptions.getMessage(err));
        });
