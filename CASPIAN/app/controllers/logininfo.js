...
$scope.user='';
    ...
    $scope.bind = function () {
		   ...
		   var city="-1";
		   var user=$scope.user?$scope.user:"-1";
             $scope.loadingVisible = true;
			       $scope.loadingVisible = true;
        flightService.getLoginInfo(_df, _dt,user,city).then(function (response) {
    ...
    else if ($rootScope.userName.toLowerCase() != 'it.entezari' && $rootScope.userName.toLowerCase() != 'it.ghaffari' && $rootScope.userName.toLowerCase() != 'demo'
       )
