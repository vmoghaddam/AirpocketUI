...
app.controller('reportFDRController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route) {
	...
	$scope.isCodeVisible=$rootScope.userName.toLowerCase().startsWith('qa.');
    ...
    $scope.bind = function () {
		...
		flightService.getFDR(url).then(function (response) {
    ...
    $scope.dg_flight_columns = [
       ...
       
       {
		...
		{ dataField: 'MaxWeightTO', caption: 'T/O Weight', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 120,   },
		{ dataField: 'MaxWeightLND', caption: 'LND Weight', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 120,   },
		{ dataField: 'MaxWeighUnit', caption: 'UNIT', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 90,   },
           ]
       },
      {
          caption: 'Route',
       ...
       },
       {
       ...
       },
        {
            ...
            columns: [
                ...
                { dataField: 'IPCode', caption: 'IP Code', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120,visible:$scope.isCodeVisible },
                { dataField: 'P1SCH', caption: 'P1', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120 },
                { dataField: 'P1Code', caption: 'P1 Code', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120,visible:$scope.isCodeVisible },
                { dataField: 'P2SCH', caption: 'P2', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120 },
                { dataField: 'P2Code', caption: 'P2 Code', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120,visible:$scope.isCodeVisible },
        ...
        },
        {
            caption: 'Fuel',
            columns: [
			 { dataField: 'FPTripFuel', caption: 'OFP Trip', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100 },
			  { dataField: 'FPFuel', caption: 'OFP Total', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100 },
