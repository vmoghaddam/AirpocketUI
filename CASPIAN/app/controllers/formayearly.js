'use strict';
app.controller('formaYearlyController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', '$window', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route, $window) {
    ...
    if (!authService.isAuthorized()) {
        ...
        $rootScope.page_title = '> Air Transport Yearly Report - From A';


        $('.formayearly').fadeIn(400, function () {
    ...
    $scope.btn_print = {
        ...
        onClick: function (e) {
            ...
            $window.open($rootScope.reportServer + '?type=5&year=' + $scope.reportData.Year  , '_blank');
            //$scope.bindReport();
