...
app.controller('niraController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route','$http', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route,$http) {
    ...
    $scope._SyncOLD = function () {
	 ...
	 $scope.Sync = function () {
        ...
        */
        ...
        $http.post(serviceBaseNetPlan + 'odata/ati/nira/all/filtered', entity).then(function (response) {
            $scope.loadingVisible = false;
            General.ShowNotify(Config.Text_SavedOk, 'success');
            $scope.bindErrors();
        }, function (err, status) {
 ...
 { dataField: 'IsConflicted', caption: 'Error',sortIndex: 0, sortOrder: 'desc',visible:false, allowResizing: true, alignment: 'center', dataType: 'boolean', allowEditing: false, width: 100, fixed: true, fixedPosition: 'left', },
               
        //sortIndex: 2, sortOrder: 'asc'
        { dataField: 'Date', caption: 'Date',sortIndex: 1, sortOrder: 'asc', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 120, format: 'yyyy-MM-dd', fixed: true, fixedPosition: 'left' },
        ...
        },
        {
            caption: 'Register', columns: [
                { dataField: 'AirPocket.Register', caption: 'AP',sortIndex: 2, sortOrder: 'asc', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120, fixed: false, fixedPosition: 'left', },
        ...
        {
            caption: 'STD', columns: [
                { dataField: 'AirPocket.STD', caption: 'AP',sortIndex: 3, sortOrder: 'asc', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 100, format: 'HH:mm', },
