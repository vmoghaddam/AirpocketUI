'use strict';
app.controller('zusersController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route) {
 ...
 { dataField: 'LockoutEnabled', caption: 'DIS', allowResizing: true, alignment: 'center', dataType: 'boolean', allowEditing: false, fixed: false, fixedPosition: 'left',width:90 },
    ...
    else if (  $rootScope.userName.toLowerCase() != 'demo' && !$rootScope.HasMenuAccess('user_manager',3))
