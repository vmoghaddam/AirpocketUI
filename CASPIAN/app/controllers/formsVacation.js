...
if($rootScope.userName.toLowerCase()=='ops.bahrami'){
	$scope.isCockpit = 0;
} else if ($rootScope.userName.toLowerCase()=='davoodian'){
	$scope.isCockpit = 1;
}
        ...
        $scope.bind_approved = function (callback) {
            flightService.getReqApproved($scope.isCockpit).then(function (response) {
