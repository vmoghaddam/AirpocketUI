...
//	|| $rootScope.userName.toLowerCase() == 'train.moradi';
	 ...
	 $scope.IsEditable = $rootScope.roles.indexOf('Admin') != -1 || $rootScope.userName.toLowerCase() == 'mohammadifard'
        ...
        || $rootScope.userName.toLowerCase() == 'train.moradi'
		|| $rootScope.userName.toLowerCase() == 'train.barzegar'
		|| $rootScope.userName.toLowerCase().startsWith('train.')
        ;
    ...
    $scope.date_CCRMIssueDate = {
        ...
        onValueChanged: function (e) {
            ...
            $scope.entity.Person.CCRMExpireDate = (new Date(e.value)).addYears(1);
        },
        bindingOptions: {
    ...
    $scope.date_DateIssueNDT = {
        ...
        displayFormat: $rootScope.DateBoxFormat,
		 onValueChanged: function(e) {
			...
			if ($scope.isNew || !$scope.entity.Person.DateExpireNDT)
                      $scope.entity.Person.DateExpireNDT = (new Date(e.value)).addYears(2);
...
$scope.entity.Person.DateJoinAvation = (new Date($scope.entity.Person.DateExpireNDT)).addMinutes(offset);
        $scope.loadingVisible = true;
