...
'#e6ffff', ];
    ...
    $scope.dg_height = $(window).height() - 140;
    $scope.dg = {
    ...
    $scope.getTempDutiesCalendar = function (_crwId,year, month,callback) {
        ...
        flightService.rosterTempCal($scope.outputTemps, _df, _dt, _crwId, year, month).then(function (response) {
            ...
            console.log('_cduties _cduties _cduties _cduties _cduties');
            console.log(_cduties);
            $.each(_cduties, function (_o, _cd) {
                if (_cd.Id >= 0) {
                    _cd.duty.RestTo = _cd.duty.RestUntil;
    ...
    $scope.getTempDutiesSTBY = function () {
        ...
        var prePostentity = Enumerable.From($scope.prePostDs).Where('$.Id==' + $scope.dg_crew_stby_selected.Id).FirstOrDefault();
    ...
    $scope.addCrew = function (_crew) {
        //gooz
        if (/*$scope.IsRulesEnabled &&*/ $scope.FDPStat.IsOver) {
    ...
    $scope.removeAssignedCrew = function (_crew) {
        ...
        var _flightIds = Enumerable.From(_flights).Select('$.FlightId').ToArray().join('_');
        ...
        var dto = { crewId: crewid, flights: _flightIds };
        flightService.deleteRosterFDPItems(dto).then(function (response) {
    ...
    $scope.fillCrew = function () {
        ...
        flightService.getCrewForRosterByDate(1, _dt).then(function (response) {
            ...
            setTimeout(function () {
                //sogol
                $scope.dg_height = $scope.dg_height+5;
                //$scope.dg_instance.repaint();
            }, 500);
            $scope.crewDuties = [];
    ...
    $scope.createEvent = function (_crew, _type, _typeTitle, eventFrom, eventEnd,remark) {
        ...
        if (_type != 10000 && _type != 1169 && _type != 100000 && _type != 100001 && _type != 100002 && _type != 100004 && _type != 100005 && _type != 100006 && _type != 100007) {
                ...
                widget: 'dxButton', location: 'after', options: {
                    type: 'success', text: 'Ok', icon: 'check', validationGroup: 'eventadd2', onClick: function (arg) {
                        ...
                        //}
                              ...
                              || $scope.event_status == 100001 || $scope.event_status == 100003 || $scope.event_status == 1170
                            ) {
                            //nool
                            ...
                            if (check) {
                                ...
                                if (1==2 /*&& (eventFrom >= rosterFrom && eventFrom <= rosterTo) || (eventEnd >= rosterFrom && eventEnd <= rosterTo)*/) {
                                    $scope.cal_crew_ds.push(_event);
                                    $scope.cal_crew_instance.repaint();
                                    $scope.crewDuties.push(_event);
                                    $scope.popup_event_visible = false;
         ...
         // { text: 'Assign Stan By PM', onItemClick: $scope.assign1167, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-1167' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Assign Stand By PM</td></tr></table>", },
            ...
            { text: 'Assign Office', onItemClick: $scope.assign5001, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-5001' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Assign Office</td></tr></table>", },
              { text: 'Assign Training', onItemClick: $scope.assign5000, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-5000' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Assign Training</td></tr></table>", },
               ...
               { text: 'Assign Meeting', onItemClick: $scope.assign100001, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-100001' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Assign Meeting</td></tr></table>", },
               { text: 'Assign Reserve', onItemClick: $scope.assign1170, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-1170' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Assign Reserve</td></tr></table>", },
                { text: 'Assign Vacation', onItemClick: $scope.assign1169, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-1169' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Assign Vacation</td></tr></table>", },
                 { text: 'Assign Ground', onItemClick: $scope.assign100000, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-100000' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Assign Ground</td></tr></table>", },
                  { text: 'Assign Simulator', onItemClick: $scope.assign100003, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-100003' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Assign Simulator</td></tr></table>", },
                   { text: 'Assign Sick', onItemClick: $scope.assign100002, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-100002' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Assign Sick</td></tr></table>", },
                    { text: 'Expired Medical', onItemClick: $scope.assign100005, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-100005' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Expired Medical</td></tr></table>", },
                     { text: 'Expired Licence', onItemClick: $scope.assign100004, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-100004' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Expired Licence</td></tr></table>", },
					  ...
					  { text: 'No Flight', onItemClick: $scope.assign100007, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-100000' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>No Flight</td></tr></table>", },
    ...
    $scope.IsStbyAMVisible = false;
    $scope.IsStbyPMVisible = false;
    $scope.checkDutyPrePostConflict = function (prepost, reporting, endDuty) {
    ...
    $scope.checkStbyAdd = function () {
        ...
        //$scope.checkDutyPrePostConflict
       
        $scope.getPrePost($scope.dg_crew_stby_selected.Id, function (prepost) {
             
            var prepostAM=$scope.checkDutyPrePostConflict(prepost, am.start, am.end);
            var prepostPM = $scope.checkDutyPrePostConflict(prepost, pm.start, pm.end);
           
            $scope.IsStbyAMVisible = !existAM && !prepostAM;
            $scope.IsStbyPMVisible = !existPM && !prepostPM;
 ...
 { dataField: 'DutyTypeTitle', caption: 'Type', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120 },
  { dataField: 'FltNo', caption: 'Flts', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 200 },
   ...
   { dataField: 'Remark', caption: 'Remark', allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, width: 200 },
    ...
    $scope.popup_cduties_title = 'Crew Duties';
    $scope.rptcd_caco = 'COCKPIT';
             ...
             },
             {
                 widget: 'dxButton', location: 'before', options: {
                     type: 'default', text: 'Notify', onClick: function (arg) {
                         ...
                         if (ids.length == 0)
                             return;
                         var dto = { Ids: ids, Date: $scope.rptcd_dateFrom };
                         $scope.loadingVisible = true;
    ...
    $scope.getCrewDutiesGrouped = function (callback) {
        var _df = moment($scope.rptcd_dateFrom).format('YYYY-MM-DDTHH:mm:ss');
        var _dt = moment($scope.rptcd_dateTo).format('YYYY-MM-DDTHH:mm:ss');
        var ca = 0;
        var co = 0;
        $scope.loadingVisible = true;
        flightService.getCrewDutiesGrouped(_df, _dt, ca, co).then(function (response) {
            $scope.loadingVisible = false;
            callback(response);
