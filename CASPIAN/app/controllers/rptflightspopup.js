'use strict';
app.controller('rptflightspopupController', ['$scope', '$location', 'schedulingService', 'authService', '$routeParams', '$rootScope', function ($scope, $location, schedulingService, authService, $routeParams, $rootScope) {
    ...
    $scope.bind = function () {
        ...
        schedulingService.getFlightsFromEFB(qry).then(function (response) {
            $scope.loadingVisible = false;
    ...
    $scope.fillAirports = function () {
        ...
        schedulingService.runQuery(qry).then(function (response) {
