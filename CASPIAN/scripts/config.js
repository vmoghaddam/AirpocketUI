...
Config.Text_Locked = 'The Selected Recorde Is Locked';
Config.Text_Permision = 'You Dont Have Permision To Delete The Row';
Config.Text_UnableToLock = 'Unable To Lock. Some Recored Are Not Validated';
Config.LocalData = {};
...
Config.MenuItems = [
    ...
    { moduleId: 2, key: 'library_conference', title: 'Conferences', url: '/conference', icon: 'content/images/teamwork2.png' },
	  ...
	  { moduleId: 1, key: 'profile_login_history', title: 'Login History', url: '/login/info', icon: 'content/images/shield.png' },
...
{ moduleId: 3, key: 'flight_calendar_cabin', title: 'Calendar (Cabin)', url: '/crewtest', icon: 'content/images/actype2.png' },
 ...
 { moduleId: 3, key: 'delays_report', title: 'Delays Report', url: '/delays', icon: 'content/images/actype2.png' },
  { moduleId: 3, key: 'delays_monitoring', title: 'Delays Monitoring', url: '/delay/main', icon: 'content/images/delaysm.png' },
     { moduleId: 3, key: 'atr_forma', title: 'Form A', url: '/forma', icon: 'content/images/forma.png' },
      ...
      { moduleId: 3, key: 'atr_citypair', title: 'City-Pair Report', url: '/citypair', icon: 'content/images/citypair.png' },
	   { moduleId: 3, key: 'efb', title: 'EFB Report', url: '/flights/efbs', icon: 'content/images/efb.png' },
	     ...
	     { moduleId: 3, key: 'fdm_upload', title: 'Events', url: '/fdm', icon: 'content/images/efb.png' },
		   { moduleId: 3, key: 'fdm_handling', title: 'Events Handling', url: '/fdm/ops', icon: 'content/images/efb.png' },
		     { moduleId: 3, key: 'fdm_summary', title: 'Events Summary', url: '/fdm/qa', icon: 'content/images/efb.png' },
			   { moduleId: 3, key: 'fdm_dashboard', title: 'FDM Main Dashboard', url: '/fdm/dashboard', icon: 'content/images/efb.png' },
			    { moduleId: 3, key: 'fdm_dashboard_cpt', title: 'FDM Crew Dashboard', url: '/fdm/dashboard/cpt/monthly', icon: 'content/images/efb.png' },
