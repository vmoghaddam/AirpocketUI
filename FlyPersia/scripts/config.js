...
Config.MenuItems = [
    ...
    { moduleId: 1, key: 'profile_person', title: 'Profiles', url: '/person', icon: 'content/images/group2.png' },
	 { moduleId: 1, key: 'profile_recency', title: 'Recency', url: '/recency', icon: 'content/images/recency.png' },
    ...
    { moduleId: 1, key: 'profile_training_profile', title: 'Training Profile', url: '/person/certificate', icon: 'content/images/trnprofile.png' },
...
{ moduleId: 3, key: 'profile_training_profile', title: 'Training Profile', url: '/person/certificate', icon: 'content/images/trnprofile.png' },
{ moduleId: 3, key: 'profile_training_profile', title: 'Training Profile (Groups)', url: '/groups/expiring', icon: 'content/images/trnprofile.png' },
{ moduleId: 3, key: 'profile_person_certificate', title: 'Training History', url: '/trn/stat', icon: 'content/images/trnstat.png' },
   { moduleId: 3, key: 'profile_schedules', title: 'Schedules', url: '/trn/schedule/coursetype', icon: 'content/images/trnschedules.png' },
...
{ moduleId: 3, key: 'scheduling', title: 'Crew Scheduler', url: '/scheduling/z', icon: 'content/images/actype2.png' },
{ moduleId: 3, key: 'timeline', title: 'TimeLine', url: '/duty/timeline/z', icon: 'content/images/actype2.png' },
    ...
    { moduleId: 3, key: 'flight_crew', title: 'Crew', url: '/crew/report', icon: 'content/images/actype2.png' },
     ...
     { moduleId: 3, key: 'flight_crew_time', title: 'Crew Flights', url: '/crew/time/report', icon: 'content/images/actype2.png' },
    ...
    { moduleId: 3, key: 'flight_board', title: 'Flight Board 1', url: '/flight/board', icon: 'content/images/actype2.png' },
     { moduleId: 3, key: 'flight_board_ceo', title: 'Flight Board ceo', url: '/flight/board/ceo', icon: 'content/images/actype2.png' },
    ...
    { moduleId: 3, key: 'flight_delay', title: 'Delay', url: '/delay/report', icon: 'content/images/delay.png' },
	  { moduleId: 3, key: 'efb_reports', title: 'EFB Reports', url: '/flights/efbs', icon: 'content/images/actype2.png' },
	{ moduleId: 3, key: 'bi_delay', title: 'Delays Monitoring', url: '/delay/main', icon: 'content/images/delaybi.png' },
     ...
     { moduleId: 3, key: 'fdr_report', title: 'FDR Report', url: '/fdr', icon: 'content/images/actype2.png' },
      ...
      { moduleId: 3, key: 'atr_citypair', title: 'City-Pair Report', url: '/citypair', icon: 'content/images/citypair.png' },
	   ...
	   { moduleId: 3, key: 'summary_flights_report', title: 'Register Fix Time', url: '/flights/monthly', icon: 'content/images/actype2.png' },
		 ...
		 { moduleId: 3, key: 'profile_users', title: 'Users', url: '/users', icon: 'content/images/shield.png' },
		  { moduleId: 3, key: 'recency', title: 'Recency', url: '/recency', icon: 'content/images/recency.png' },
		
		 { moduleId: 5, key: 'hazard_log', title: 'Hazard Log', url: '/qa/hazard/log', icon: 'content/images/efb.png' },
