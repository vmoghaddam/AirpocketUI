'use strict';
app.controller('boardflyController', ['$scope', '$location', '$routeParams', '$rootScope', '$timeout', 'flightService', 'weatherService', 'aircraftService', 'authService', 'notificationService', '$route', '$window', function ($scope, $location, $routeParams, $rootScope, $timeout, flightService, weatherService, aircraftService, authService, notificationService, $route, $window) {
    ...
    $scope.IsCrewMobileVisible = $rootScope.userName.toLowerCase().startsWith('ashrafi') || $rootScope.userName.toLowerCase().startsWith('demo') || $rootScope.userName.toLowerCase().startsWith('razbani');
    ...
    $scope.IsNoCrewVisible = $rootScope.userName.toLowerCase().startsWith('ashrafi') || $rootScope.userName.toLowerCase().startsWith('demo') || $rootScope.userName.toLowerCase().startsWith('razbani')
        ...
        || $rootScope.userName.toLowerCase().startsWith('saraf')
        ;
    $scope.IsCrewMobileVisible = $scope.IsNoCrewVisible;
