...
$scope.dg_instance.columnOption('TRG01','visible',e.value == 'MANAGEMENT' ||  e.value == 'All' || e.value == 'F/D' || e.value == 'GRND' || e.value == 'COMM' || e.value=='SECURITY' || e.value=='QA' || e.value=='CAMO' || e.value == 'MAINTENANCE'  
|| e.value=='LEGAL' || e.value=='IT' || e.value=='FINANCIAL' || e.value=='CEO' || e.value=='HR'  || e.value=='TRAINING' || ['FLIGT_OPS_STAFF',
	'ENG_AND_MAINT_STAFF',
	'MNG_STAFF',
	'SECURITY_STAFF' ].indexOf(e.value)!=-1);			
