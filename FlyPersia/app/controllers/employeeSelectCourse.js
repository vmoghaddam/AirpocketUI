'use strict';
app.controller('employeeSelectCourseController', ['$scope', '$location', 'authService', '$routeParams', '$rootScope', 'trnService','ztrnService', function ($scope, $location, authService, $routeParams, $rootScope,trnService,ztrnService) {
    ...
    $scope.bind = function () {
        ...
        ztrnService.getAllowedPeopleForCourse($scope.course_id).then(function (response) {
            $scope.loadingVisible = false;
