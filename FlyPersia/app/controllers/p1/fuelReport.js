...
app.controller('fuelReportController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'weatherService', 'aircraftService', 'authService', 'notificationService', '$route', function ($scope, $location, $routeParams, $rootScope, flightService, weatherService, aircraftService, authService, notificationService, $route) {
    ...
    $scope.dg_columnsX = [
        {
            ...
            columns: [
                { dataField: 'AircraftType', caption: 'AC Type', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 130, fixed: false, fixedPosition: 'left' },
                 { dataField: 'Register', caption: 'Reg.', allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, width: 130, fixed: false, fixedPosition: 'left' },
         ...
         { dataField: 'Captain', caption: 'Captain', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 110, fixed: false, fixedPosition: 'left' },
...

        {
            ...
            columns: [
                ...
                { dataField: 'Remaining', caption: 'Remaining', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 90, },
                { dataField: 'UpLift', caption: 'UpLift', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 110, },
                { dataField: 'Taxi', caption: 'Taxi', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 80, },
                 { dataField: 'UsedFuel', caption: 'Used', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 110, },
                 { dataField: 'FPFuel', caption: 'SITA', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 80, },
                ...
                { dataField: 'AVGFuelBurnedReg', caption: 'Avg. Reg.', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 90, },
                   ...
                   { dataField: 'FPVar', caption: 'SITA Var.', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 90, customizeText: function (e) { return e.value ? e.value + ' %'  : '0' } },
                { dataField: 'AvgVar', caption: 'Type Var.', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 90, customizeText: function (e) { return e.value ? e.value + ' %' : '0' } },
                 { dataField: 'AvgVarReg', caption: 'Reg. Var.', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 90, customizeText: function (e) { return e.value ? e.value + ' %' : '0' } },
        ...
        },
        {
            ...
            columns: [
                ...
                { dataField: 'STDLocal', caption: 'STD', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 90, format: 'HH:mm', sortIndex: 1, sortOrder: "asc" },
                ...
                { dataField: 'DepartureLocal', caption: 'B/L OFF', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 90, format: 'HH:mm' },
                { dataField: 'ArrivalLocal', caption: 'B/L ON', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 90, format: 'HH:mm' },

                { dataField: 'DurationActualStr', caption: 'B/L Time', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 100, fixed: false, fixedPosition: 'left' },
                 { dataField: 'FlightActualStr', caption: 'F/L Time', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 100, fixed: false, fixedPosition: 'left' },

                   { dataField: 'TotalPax', caption: 'PAX', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
                   { dataField: 'TotalCargoWeight', caption: 'Cargo', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
            ]
    ...
    $scope.dg = {
        ...
        onCellPrepared: function (e) {
            if (e.rowType === "data" && e.column.dataField == "UsedFuel" && e.data.UsedFuel > e.data.AVGFuelBurnedReg)
    ...
    $scope.bind = function () {
        ...
        var url = 'odata/fuel/report/?dt=' + _dt + "&df=" + _df;//2019-06-06T00:00:00';
        if (!$scope.dg_ds) {
            $scope.dg_ds = {
                store: {
                    type: "odata",
