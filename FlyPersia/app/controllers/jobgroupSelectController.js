'use strict';
app.controller('jobgroupSelectController', ['$scope', '$location', 'authService', '$routeParams', '$rootScope', function ($scope, $location, authService, $routeParams, $rootScope) {
    ...
    $scope.dg_columns = [
        ...
        { dataField: 'FullCode', caption: 'Code', allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, encodeHtml: false, width: 200,   },
		  { dataField: 'Remark', caption: 'Code2', allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, encodeHtml: false, width: 200, sortIndex: 0, sortOrder: "asc",visible:false },
    ...
    $scope.popup_add.toolbarItems[0].options.onClick = function (e) {
        ...
        $rootScope.$broadcast('onJobGroupSelectHide', $scope.dg_selected);
        $scope.popup_add_visible = false;
    };
    ////////////////////////////
    $scope.bind = function () {
    ...
    $scope.$on('InitJobGroupSelect', function (event, prms) {
