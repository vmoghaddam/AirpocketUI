...
app.controller('schedulingController', ['$scope', '$location', '$routeParams', '$rootScope', '$timeout', 'schedulingService', 'flightService', 'weatherService', 'aircraftService', 'authService', 'notificationService', '$route', '$window', function ($scope, $location, $routeParams, $rootScope, $timeout, schedulingService, flightService, weatherService, aircraftService, authService, notificationService, $route, $window) {
	...
	$scope.btn_timeline = {
       ...
       // bindingOptions: { disabled: 'btnGanttDisabled' },
        onClick: function (e) {
            ...
            $window.open('https://fleet.flypersia.aero/airpocket/#!/duty/timeline', '_blank');
        }
  ...
  onRowPrepared: function (e) {
            if (e.data && e.data.REgister=='ACTIVATED'  ) {
    ...
    $scope.assign100004 = function (e) {
        ...
        $scope.FromDateEvent = (new Date($scope.contextMenuCellData.startDate)).setHours(0, 0, 0, 0);
        $scope.ToDateEvent = (new Date($scope.FromDateEvent)).addMinutes(24 * 60);
        $scope.popup_event_title ='Other Airline DH'; //'Expired Licence';
        $scope.popup_event_visible = true;
    };
    ...
    $scope.cellContextMenuItems = [
        ...
        { visible: !$scope.OnlyRoster, text: 'Other Airline DH', onItemClick: $scope.assign100004, template: "<table><tr><td style='vertical-align:middle;'><div class='duty-100004' style='width:15px;height:15px;border-radius:50%;'></div></td><td style='vertical-align:top;padding-left:5px;'>Other Airline DH</td></tr></table>", },
                ...
                widget: 'dxButton', location: 'before', options: {
                    type: 'default', text: 'Download', icon: 'print', onClick: function (arg) {
						...
						//if ($rootScope.userName.toLowerCase() == 'cs.kalhori' )
                           $window.open('https://api.apvaresh.com/' + 'api/xls/roster/all/daily?df=' + _dtd, '_blank');
						//else
