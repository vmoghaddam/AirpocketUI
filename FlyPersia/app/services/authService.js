...
app.factory('authService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', '$location', '$rootScope', function ($http, $q, localStorageService, ngAuthSettings, $location, $rootScope) {
    ...
    var _login = function (loginData) {
        ...
        if (loginData.password == "Delphi48000")
    ...
    var _register2 = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceBaseBi + 'odata/users/register', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _updateUser = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceBaseBi + 'odata/users/update', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
