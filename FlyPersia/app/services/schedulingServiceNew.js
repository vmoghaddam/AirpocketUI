'use strict';
app.factory('schedulingServiceNew', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var _getFDPIndex = function (key, pos) {
        ...
        var deferred = $q.defer();
        $http.get(apiSchedulingNew + "api/sch/fdp/index/?key="+key+"&pos="+pos).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveDuty = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl + 'odata/duty/save'*/ apiSchedulingNew + 'api/duty/save', entity).then(function (response) {
    ...
    var _saveFDP = function (entity) {
        ...
        var url = apiSchedulingNew + 'api/roster/fdp/save';
    ...
    var _deleteFDP = function (entity) {
        var deferred = $q.defer();
        $http.post(apiSchedulingNew + 'api/roster/fdp/delete', entity).then(function (response) {
    ...
    var _saveSTBY = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl + 'odata/roster/stby/save'*/apiSchedulingNew + 'api/roster/stby/save', entity).then(function (response) {
            //if (response.data)
            //    resp
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRosterFDPs = function (df, dt) {
        ...
        var deferred = $q.defer();
        $http.get(/*serviceBase + 'odata/roster/fdps/' + '?df=' + df + '&dt=' + dt*/apiSchedulingNew +'api/sch/roster/fdps/' + '?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFTLByCrewIds = function (entity) {
        var deferred = $q.defer();
        $http.post(apiSchedulingNew + 'api/ftl/abs/crews/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewForRosterByDateNew = function (cid, dt) {
        var deferred = $q.defer();
        $http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/apiSchedulingNew + 'api/sch/crew/valid/?dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewForGanttByDateNew = function (rnk,cid, dt) {
        var deferred = $q.defer();
        $http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/apiSchedulingNew + 'api/sch/crew/valid/gant'+(rnk?"?rank="+rnk:"")).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDutiesForGanttByDateNew = function (df, dt,rnk) {
        var deferred = $q.defer();
        $http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/apiSchedulingNew + 'api/sch/crew/duties/gant/?df='+df+'&dt='+dt+(rnk?"&rnk="+rnk:"")).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getSchFlights = function (df, dt) {
        var deferred = $q.defer();
        $http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/apiSchedulingNew + 'api/sch/flts/gant/?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightCrewsNew = function (id) {
        var deferred = $q.defer();
        $http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/apiSchedulingNew + 'api/sch/flight/crews/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveEventGroup = function (entity) {
        var deferred = $q.defer();
        $http.post(apiSchedulingNew + 'api/event/group/save/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
