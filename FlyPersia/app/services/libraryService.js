...
app.factory('libraryService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var _getBook = function (id) {
       ...
       // $http.get(serviceBase + 'odata/library/book/' + id).then(function (response) {
		    $http.get(zapinet + 'odata/library/book/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _exposeBook = function (entity) {
        var deferred = $q.defer();
        $http.post(liburl + 'odata/library/book/expose', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _save = function (entity) {
        ...
        //$http.post($rootScope.serviceUrl + 'odata/library/book/save', entity).then(function (response) {
			$http.post(zapinet + 'odata/library/book/save/old', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	//zapitrn
	 var _getCourseIds = function () {

        var deferred = $q.defer();
        $http.get(	zapitrn+'api/course/ids/'  ).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	  ...
	  serviceFactory.getCourseIds = _getCourseIds;
