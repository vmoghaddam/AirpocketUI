...
var biUrl = serviceBaseBi;
    ...
    var _getFlightsGantt = function (cid,from,to,tzoffset,airport,filter) {
        var url = serviceBaseBi + 'odata/flights/gantt/customer/' + cid + '/' + from + '/' + to + '/' + tzoffset;
        if (airport)
            url += '/' + airport;
       // if (utc)
        //    url += '/' + utc;
    ...
    var _getCrewFlightsTotal = function (df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DDTHH:mm:ss');
        var deferred = $q.defer();
        $http.get(/*serviceBase*/biUrl + 'odata/crew/report/flights/total/?from=' + _df + '&to=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveFlightLog = function (entity) {
        ...
        //$http.post($rootScope.serviceUrl + 'odata/flight/log/save', entity).then(function (response) {
			$http.post('https://fleet.flypersia.aero/zdsp/' + 'odata/flight/log/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    ///////////////////
     ...
     var _fdpsOffbyFlights = function (entity) {
         var deferred = $q.defer();
         $http.post($rootScope.serviceUrlBi + 'odata/flights/off', entity).then(function (response) {
             deferred.resolve(response.data);
         }, function (err, status) {
    ...
    // odata/roster/fdpitem/delete
     ...
     var _dutiesSendSMS = function (entity) {
         ...
         //$http.post($rootScope.serviceUrl + 'odata/duties/sms/save', entity).then(function (response) {
			 $http.post(zapinet + 'odata/duties/sms/save', entity).then(function (response) {
             deferred.resolve(response.data);
         }, function (err, status) {
    ...
    var _dutiesHideVisible = function (entity) {
     ...
     var _updateSMSStatus = function (entity) {
        ...
        // $http.post($rootScope.serviceUrl + 'odata/sms/status/update', entity).then(function (response) {
			 $http.post('https://fleet.flypersia.aero/apivx/' + 'odata/sms/status/update', entity).then(function (response) {
             deferred.resolve(response.data);
         }, function (err, status) {
	...
	var _notifyDelay2 = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseBi + 'odata/notify/delay2/'+id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightReport = function (url) {
     ...
     var _getDelayFlightSummary = function (_df, _dt) {
        ...
        var deferred = $q.defer();
        $http.get(serviceBaseBi + 'odata/delays/flight/summary/' + '?dt=' + _dt + '&df=' + _df).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	 ...
	 var _getDayApts = function (dt) {
        ...
        var deferred = $q.defer();
        $http.get('https://fleet.flypersia.aero/expapi/' + 'api/day/apts?dt='  + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _saveFDP2 = function (entity) {
         var deferred = $q.defer();
         $http.post(liburl  + 'odata/roster/fdp/save', entity).then(function (response) {
             deferred.resolve(response.data);
         }, function (err, status) {
	 ...
	 var _runRAW = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceBaseTRN + 'api/raw', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _getImportFlights = function (fn) {
        ...
        var deferred = $q.defer();
        $http.get('https://fleet.flypersia.aero/apixls/' + 'api/xls/flights3?fn=' +fn).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _syncNira = function (fn) {


        var deferred = $q.defer();
        $http.get('https://fleet.flypersia.aero/apinira/api/nira/notify/'+fn+'/FP').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _getFlightDocs = function (id) {


        var deferred = $q.defer();
        $http.get(apiapsb + 'api/flight/docs/' +id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.getFlightDocs = _getFlightDocs;
 ...
 var _updateATC = function (id,fn) {
    ...
    var _sendCaoMVT = function (id ) {
        ...
        var deferred = $q.defer();
        $http.get('https://fleet.flypersia.aero/apicao/' + 'api/cao/mvt/'+id ).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    /////////////////////////
	 ...
	 var _getSummaryPax = function (y1,y2) {
        var deferred = $q.defer();
        $http.get(zreportflight + 'api/summary/pax/monthly/' + y1+'/'+y2).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.getSummaryPax = _getSummaryPax;
	//////////////////////////////////
    serviceFactory.runRaw = _runRAW;
	 
	 
	 serviceFactory.saveFDP2 = _saveFDP2;
