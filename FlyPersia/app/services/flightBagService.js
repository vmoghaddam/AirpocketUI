...
app.factory('flightBagService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var _epGetASRByFlight = function (flightId) {
        ...
        $http.get(comAPI + 'api/asr/flight/' + flightId /*+ '?from=' + _df + '&to=' + _dt*/).then(function (response) {
            deferred.resolve(response.data)
        });
    ...
    var _saveASR = function (entity) {
     ...
     var _saveDR = function (entity) {
        ...
        var deferred = $q.defer();
        $http.post(apiapsb + 'api/efb/dr/save', entity).then(function (response) {

            deferred.resolve(response.data);

        }, function (err, status) {
			 console.log('dr err',entity);
    ...
    var _epGetDRByFlight = function (flightId) {
        ...
        $http.get(apiapsb + 'api/dr/flight/' + flightId /*+ '?from=' + _df + '&to=' + _dt*/).then(function (response) {
    ...
    var _epGetVRByFlight = function (flightId) {
        var deferred = $q.defer();
        $http.get(comAPI + 'api/voyage/flight/' + flightId /*+ '?from=' + _df + '&to=' + _dt*/).then(function (response) {
    ...
    var _getAppLegs = function (url) {
        ...
        var deferred = $q.defer();
        $http.get(zapi + url).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getAppLegCrews = function (fltid) {
        ...
        var deferred = $q.defer();
        $http.get(zapi + 'api/appleg/crew/'+fltid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getAppLegOFP = function (fltid) {
        ...
        var deferred = $q.defer();
        $http.get(apiapsb + 'api/appleg/ofp/' + fltid).then(function (response) {
    ...
    var _getJL = function (fid) {
        ...
        var deferred = $q.defer();
        $http.get(zapi + "api/jl/"+fid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _remarkVRManager = function (entity) {
        var deferred = $q.defer();
        $http.post(zapi + 'api/vr/remark/manager/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _remarkVRStaff = function (entity) {
        var deferred = $q.defer();
        $http.post(zapi + 'api/vr/remark/staff/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _remarkASRManager = function (entity) {
        var deferred = $q.defer();
        $http.post(zapi + 'api/asr/remark/manager/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _remarkASRStaff = function (entity) {
        var deferred = $q.defer();
        $http.post(zapi + 'api/asr/remark/staff/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
...
var _getMETAR = function (flt) {

        var deferred = $q.defer();
        $http.get(weatherUrl + "api/weather/metar/flight/" + flt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.getMETAR = _getMETAR;

    var _getTAF = function (flt) {

        var deferred = $q.defer();
        $http.get(weatherUrl + "api/weather/taf/flight/" + flt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.getTAF = _getTAF;

    var _getNOTAM = function (flt) {

        var deferred = $q.defer();
        $http.get(weatherUrl + "api/weather/notam/flight/" + flt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
...
//apiapsb
	 var _signDr = function (entity) {
        var deferred = $q.defer();
        $http.post(apiapsb + 'api/dsp/dr/sign/new', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
