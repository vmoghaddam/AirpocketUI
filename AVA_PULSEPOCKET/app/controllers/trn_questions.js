'use strict';
app.controller('trn_questionsController', ['$scope', '$location', 'flightService', 'authService', '$routeParams', '$rootScope', '$window', '$http', 'instructorService', function ($scope, $location, flightService, authService, $routeParams, $rootScope, $window, $http, instructorService) {
    ...
    $scope.popup_questions_title = 'Attendance List';
    ...
    $scope.bind = function () {
        $scope.exam_id = 1
        instructorService.get_questions_list($scope.exam_id).then(function (response) {
