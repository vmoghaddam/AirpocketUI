...
var _getEmployeeBook = function (id,itemId) {
    ...
    var _getFoldersItems = function (uid, fid,pid) {
        ...
        var deferred = $q.defer();
        $http.get(/*serviceBase + 'odata/base/library/employee/folder/'*/zlib+'/api/library/employee/folder/' + uid+'/'+fid+'/'+pid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
 ...
 var _getSearch = function (str,eid) {



        var deferred = $q.defer();
        $http.get(zlib + 'api/library/search/'+str+'/'+eid  ).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
