...
app.config(function ($routeProvider) {
  ...
  $routeProvider.when("/cp", {
    ...
    $routeProvider.when("/appflight", {
        ...
        templateUrl: "app/views/appflight.html?v=7070018",
        //type:'all',
       // type: 'book',
    });
 ...
 $routeProvider.when("/forms", {
	...
	$routeProvider.when("/report", {
        ...
        templateUrl: "app/views/report.html?v=20",
...
var serviceBase ='https://fms.'+domain+'/kapinet2/';//'https://kapinet2.airpocket.online/'; //'https://net.apvaresh.com/';
var webBase ='https://fms.'+domain+'/'; //'https://apvaresh.com/';
var clientBase ='https://cp.apvaresh.ir/'; //'https://cp.apvaresh.com/';
 var serviceBase2 ='https://fms.'+domain+'/kapinet2/';//'https://kapinet2.airpocket.online/';// 'https://net.apvaresh.com/';
 var serviceBaseTRN ='https://fms.'+domain+'/kapi/';//'https://kapi.apvaresh.com/';
 var serviceForms = 'https://fms.'+domain+'/kapiform/'; //'https://kapiforms.airpocket.online/'; 
 
 var apiLock ='https://fms.'+domain+'/kapilock/';
