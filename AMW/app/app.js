...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when("/cp", {
        ...
        templateUrl: "/app/views/firstlogin.html?v=2025"
    });
    ...
    $routeProvider.when("/apps", {
        ...
        templateUrl: "/app/views/apps.html?v=2025" 
    });
    $routeProvider.when("/home", {
        controller: "homeController",
        templateUrl: "/app/views/home.html?v=2025"
    });
    ...
    $routeProvider.when("/login", {
        ...
        templateUrl: "/app/views/login.html?v=2025"
    });
    ...
    $routeProvider.when("/signup", {
        ...
        templateUrl: "/app/views/signup.html?v=2025"
    });

    $routeProvider.when("/orders", {
        controller: "ordersController",
        templateUrl: "/app/views/orders.html?v=2025"
    });

    $routeProvider.when("/refresh", {
        controller: "refreshController",
        templateUrl: "/app/views/refresh.html?v=2025"
    });

    $routeProvider.when("/tokens", {
        controller: "tokensManagerController",
        templateUrl: "/app/views/tokens.html?v=2025"
    });

    $routeProvider.when("/associate", {
        controller: "associateController",
        templateUrl: "/app/views/associate.html?v=2025"
    });

    $routeProvider.when("/test", {
        controller: "testController",
        templateUrl: "/app/views/test.html?v=2025"
    });

    $routeProvider.when("/airport", {
        controller: "airportController",
        templateUrl: "/app/views/airport.html?v=2025",
        isDispatch: false,
    });
    ...
    $routeProvider.when("/option/:parent", {
        ...
        templateUrl: "/app/views/option.html?v=2025",
         
    });

    $routeProvider.when("/document", {
        controller: "libraryController",
        templateUrl: "/app/views/document.html?v=2025",
        isDocument: true,
    });

    $routeProvider.when("/publisher", {
        controller: "organizationController",
        templateUrl: "/app/views/organization.html?v=2025",
        TypeId: 77,
    });
    $routeProvider.when("/author", {
        controller: "personmiscController",
        templateUrl: "/app/views/personmisc.html?v=2025",
        TypeId: 75,
    });
   
    $routeProvider.when("/journal", {
        controller: "journalController",
        templateUrl: "/app/views/journal.html?v=2025",
        TypeId: 1,
    });
    ...
    $routeProvider.when("/notification", {
        ...
        templateUrl: "/app/views/notification.html?v=2025",
        
    });
    $routeProvider.when("/flight", {
        controller: "flightController",
        templateUrl: "/app/views/flight.html?v=2025",
    ...
    $routeProvider.when("/flight/archive", {
        ...
        templateUrl: "/app/views/flightlist.html?v=2025",
        type:-1,
    ...
    $routeProvider.when("/maintenance/flights/irregular", {
        ...
        templateUrl: "/app/views/irregularflight.html?v=2025",
        type: 2,
    ...
    $routeProvider.when("/flight/plans/closed", {
        ...
        templateUrl: "/app/views/flightplanview.html?v=2025",
        type: 50,
    ...
    $routeProvider.when("/commercial/flights/plannig", {
        ...
        templateUrl: "/app/views/flightPlanning.html?v=2025",
    ...
    $routeProvider.when("/commercial/plans/permits", {
        ...
        templateUrl: "/app/views/flightplanpermit.html?v=2025",
        //type: 50,
    ...
    $routeProvider.when("/commercial/plans/crew", {
        ...
        templateUrl: "/app/views/flightPlanCrew.html?v=2025",
        //type: 50,

    });
    $routeProvider.when("/commercial/plans/apply", {
        //controller: "flightPlanApplyController",
        //templateUrl: "/app/views/flightplanapply.html?v=2025",
        controller: "flightPlanApply2Controller",
        templateUrl: "/app/views/flightplanapply2.html?v=2025",

    });
    $routeProvider.when("/commercial/plans", {
        controller: "flightPlanListController",
        templateUrl: "/app/views/flightplanlist.html?v=2025",
    ...
    $routeProvider.when("/crewtest", {
        ...
        templateUrl: "/app/views/crewtest.html?v=2025"
    });
    $routeProvider.when("/crew/assign/cockpit", {
        controller: "crewassignController",
        templateUrl: "/app/views/crewassign.html?v=2025",
        isCockpit: true,
    });
    ...
    $routeProvider.when("/crew/assign/timeline/cabin", {
        ...
        templateUrl: "/app/views/crewassign2.html?v=2025",
        isCockpit: false,
    });
    ...
    $routeProvider.when("/commercial/planning", {
        ...
        templateUrl: "/app/views/plan.html?v=2025",
    ...
    $routeProvider.when("/flight/report/security", {
        ...
        templateUrl: "/app/views/flightreportsecurity.html?v=2025"
    });
    $routeProvider.when("/reg/availability", {
        controller: "regAvailabilityController",
        templateUrl: "/app/views/regAvailability.html?v=2025"
    });
    $routeProvider.when("/route", {
        controller: "routeController",
        templateUrl: "/app/views/route.html?v=2025",
        isDispatch: false,
    });
    $routeProvider.when("/delay/codes", {
        controller: "delayCodesController",
        templateUrl: "/app/views/delayCodes.html?v=2025",
        isDispatch: false,
    });

    $routeProvider.when("/crew/assign/reg/cockpit", {
        controller: "crewassignregController",
        templateUrl: "/app/views/crewassignreg.html?v=2025",
        isCockpit: true,
    });
...
var serviceBaseAPI ='https://api.amwaero.tech/';  //*
var serviceBaseTRN = 'https://apitrn.amwaero.tech/';
 
 
var webBase = 'https://amwaero.tech/';  //*
var serviceBase ='https://apinet.amwaero.tech/'; //*
var serviceBaseAeroTango='https://apinet.amwaero.tech/';
var liburl = serviceBase;
var serviceBase2 =  'https://localhost:5001/'; 
 
var signFiles = 'https://_fbpocket.ir/upload/signs/';
var apimain='https://api.amwaero.tech/';
var comAPI='https://api.amwaero.tech/'; 
var msgUrl="https://apinet.amwaero.tech/"; 
var apiLog='https://apilog.amwaero.tech/'; //*
var schUrl='https://_sch.apvaresh.com/'; 
var apigd='https://api.amwaero.tech/';//'http://api.amwaero.tech/'; 
var netProfile='https://_netprofile.apvaresh.com/'; 
var apireportflight='https://apireportflight.amwaero.tech/'; //* 
var zreportflight=apireportflight ;
var apixls='https://apixls.amwaero.tech/'; //*
var apiScheduling='https://apischeduling.amwaero.tech/';
 var zapiScheduling="https://apischeduling.amwaero.tech/";

var apiExternal = 'https://_xpi.amwaero.tech/';
var airlineCode = 'vrh';

var serviceSKYBAG = 'https://_api.sbvaresh.ir/';
var weatherUrl='https://wxskybag.app/';
var staticFilesSKYBAG = 'https://fbpocket.ir/Upload/';

var apimsg='https://apimsg.amwaero.tech/';
var apiplanning='https://apiplanning.amwaero.tech/'; //*
var apilogdefault='https://apilogdefault.amwaero.tech/'; //*
var apiapsb='https://apiapsb.amwaero.tech/';
var apiprofile='https://apiprofile.amwaero.tech/';
var apiauth='https://apinet.amwaero.tech//'; //*
var atcfiles='https://files.amwaero.tech/air1/atc/';

var apiCAO='https://apicaox.amwaero.tech/';

var zapinet='https://apinet.amwaero.tech/';
var zfuel='https://apifuel.amwaero.tech/';
var zapitrn='https://apitrn.amwaero.tech/';
var vira_api = "https://lmmcore.online/";
var zapinet2='https://zapinet.amwaero.tech/';

var temp_url='https://temp.apinet.amwaero.tech/';
    //'http://localhost:58908/';
    //'http://localhost:40654/';
   var serviceRequest = 'https://apiform.amwaero.tech/';
...
app.run(['authService', 'activityService', 'mntService', 'vira_general_service', '$rootScope', '$location', '$templateCache', function (authService, activityService, mntService, vira_general_service, $rootScope, $location, $templateCache) {
    ...
    ////////////////////////////////
    $rootScope.reportServer = "https://report.amwaero.tech/frmreportview.aspx";
	$rootScope.formsReportServer = "https://formsreport.amwaero.tech/frmreportview.aspx";
    $rootScope.reportServerTRN = "https://reporttrn.amwaero.tech/frmreportview.aspx";
	$rootScope.zreportServerTRN = "https://reporttrn.amwaero.tech/frmreportview.aspx";
	$rootScope.zreportServerTRNForms="https://reporttrn.amwaero.tech/frmreportview.aspx";
	$rootScope.serviceMnt = 'https://apimnt.amwaero.tech/';
    ////////////////////////////////
    ...
    $rootScope.clientsFilesUrl = 'https://files.amwaero.tech/varesh/certificates/';//webBase + 'upload/clientsfiles/';
    ...
    $rootScope.HasMenuAccess = function (key, module) {
       ...
       if (key == 'requests_scheduling') {
        ...
        /* if (key == 'flight_crew_time') {
             exist = Enumerable.From($rootscope.claims).where('$.page=="cabin_report"').FirstOrDefault();
...
console.log('_roles hide crew',_roles);
  ...
  $rootScope.getCertificateTypeList = function () {
    ...
    $rootScope.getSbTemplateAirport = function (data) {
        var tmpl =
            "<div>"
            + "<div class='tmpl-col-left' style='width:50%'>" + data.IATA + "</div>"
            //+ "<div class='tmpl-col-right' style='width:20%'>" + data.SortName + "</div>"
            + "<div class='tmpl-col-right'>" + data.ICAO + "</div>"
