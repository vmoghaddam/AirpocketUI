'use strict';
app.controller('reportEFBController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', 'flightBagService', '$sce', '$window' ,function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route, flightBagService, $sce, $window) {
    ...
    $scope.btn_jl = {
      ...
      $window.open('https://apiapsb.amwaero.tech/' + 'api/jl/amw/xls/' + flt.FlightId, '_blank');
