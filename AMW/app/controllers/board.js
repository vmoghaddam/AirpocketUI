...
//09-03
    ...
    $scope.bag_excess = {
	 ...
	 $scope.extra_bags_weight = {
        ...
        min: 0,
        bindingOptions: {
            value: 'logFlight.exctra_bags_weight',
...
////////////////////////////////////////////////////////
    ...
    $scope.fillLog = function (entity) {
        ...
        entity.exctra_bags_weight = $scope.logFlight.exctra_bags_weight;
        entity.email_weight = $scope.logFlight.email_weight;
        entity.FuelUnitID = $scope.logFlight.FuelUnitID;
        entity.fob = $scope.logFlight.fob;
...
{ dataField: 'RefId', caption: 'Ref', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120 },
    ...
    $scope.sb_timetype = {
        showClearButton: false,
        searchEnabled: false,
        dataSource: [{ id: 0, title: 'LCB' }, { id: 1, title: 'UTC' }],
        displayExpr: 'title',
        valueExpr: 'id',
        onValueChanged: function (e) {
            ...
            },
            {
                widget: 'dxButton', location: 'after', options: {
                    type: 'default', text: 'GD', icon: 'save', bindingOptions: { disabled: 'IsApproved' }, onClick: function (arg) {
                        ...
                        var idsStr = ids.join('_');
                        $window.open(apigd + 'api/xls/gd/amw?flts=' + idsStr, '_blank');
                    }
