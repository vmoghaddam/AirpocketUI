...
app.controller('libraryAddController', ['$scope', '$location', 'libraryService', 'authService', '$routeParams', '$rootScope', function ($scope, $location, libraryService, authService, $routeParams, $rootScope) {
    ...
    $scope.scroll_add_height =$(window).height() - 50;
    $scope.scroll_add = {
    width: '100%',
    bounceEnabled: false,
    showScrollbar: 'never',
  ...
  $scope.popup_fm_visible = false;
    $scope.popup_fm_title = 'File Manager';
    $scope.popup_fm = {
        ...
        onShown: function (e) {
                    ...
                    $("#_fm").jQueryFileExplorer({
 
							root:"/",
 
							rootLabel:"Server",
  script:"https://ava.apilib.airpocket.app/api/FileExplorer/GetPath?path=c:\\"
							});
...
//});
        ...
        bindingOptions: {
            visible: 'popup_fm_visible',

            title: 'popup_fm_title',
