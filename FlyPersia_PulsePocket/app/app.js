...
app.config(function ($routeProvider) {
  ...
  $routeProvider.when("/cp", {
        ...
        templateUrl: "app/views/cp.html?v=13001"
    });
    $routeProvider.when("/apps", {
        controller: "appsController",
        templateUrl: "app/views/apps.html?v=12012"
    });
    $routeProvider.when("/home", {
        controller: "homeController",
        templateUrl: "app/views/home.html?v=147024"
    });
    ...
    $routeProvider.when("/signup", {
        ...
        templateUrl: "app/views/signup.html?v=12006"
    });
    ...
    $routeProvider.when("/appflight", {
        ...
        templateUrl: "app/views/appflightnew.html?v=30070015",
        //type:'all',
       // type: 'book',
    });
    ...
    $routeProvider.when("/applibrary/:fid/:pid", {
        ...
        templateUrl: "app/views/applibrary.html?v=12058",
        //type:'all',
        type:'book',
    });
    $routeProvider.when("/applibrary/books", {
        controller: "appLibraryController",
        templateUrl: "app/views/applibrary.html?v=12458",
        type: 'book',
    });
    $routeProvider.when("/applibrary/papers", {
        controller: "appLibraryController",
        templateUrl: "app/views/applibrary.html?v=12085",
        type: 'paper',
    });
    ...
    $routeProvider.when("/applibrary/item/:id", {
        ...
        templateUrl: "app/views/applibraryitem.html?v=12058",
        
    });

    $routeProvider.when("/appcertificate/all", {
        controller: "appCertificateController",
        templateUrl: "app/views/appcertificate.html?v=65",
        type: 'all',
    });
    $routeProvider.when("/appcertificate/last", {
        controller: "appCertificateController",
        templateUrl: "app/views/appcertificate.html?v=211008",
        type: 'last',
    });
   
    $routeProvider.when("/appcourse/active", {
        controller: "appCourseController",
        templateUrl: "app/views/appcourse.html?v=12008",
        type: 'active',
    });
    ...
    $routeProvider.when("/memoviewer/:url/:title/:id", {
        controller: "appDocumentItemController",
        templateUrl: "app/views/appDocumentItem.html?v=12008",

    });
    $routeProvider.when("/docviewer/:url/:title/:id/:bookId/:dateSigned", {
        controller: "docViewerController",
        templateUrl: "app/views/docviewer.html?v=12008",
    ...
    $routeProvider.when("/appflightstatistics", {
        ...
        templateUrl: "app/views/appflightstatistics.html?v=12008",
        //type:'all',
        // type: 'book',
    });
    ...
    $routeProvider.when("/appdocumentother", {
	 ...
	 $routeProvider.when("/forms", {
        ...
        templateUrl: "app/views/forms.html?v=4205639",

    });
	
 $routeProvider.when("/formsmain", {
        controller: "formsmainController",
        templateUrl: "app/views/formsmain.html?v=2028",

    });
	
 $routeProvider.when("/help", {
        controller: "helpController",
        templateUrl: "app/views/help.html?v=3205628",
...
var serviceBase ='https://fleet.flypersia.aero/zapinet/'; //'https://net.apvaresh.com/';
var webBase ='https://fleet.flypersia.aero/airpocket/'; //'https://apvaresh.com/';
var clientBase ='https://fleet.flypersia.aero/pulsepocket/'; //'https://cp.apvaresh.com/';
 var serviceBase2 ='https://fleet.flypersia.aero/zapinet/';// 'https://net.apvaresh.com/';
 var serviceBaseTRN ='https://fleet.flypersia.aero/zapi/';

var zlib='https://fleet.flypersia.aero/zapilib/';   //*****
var apiQA = 'https://fleet.flypersia.aero/zapiqa/';  //*****

var zscheduling='https://fleet.flypersia.aero/zscheduling/';
var extapi='https://fleet.flypersia.aero/zapi/';
var zauth ='https://fleet.flypersia.aero/zapinet/';
