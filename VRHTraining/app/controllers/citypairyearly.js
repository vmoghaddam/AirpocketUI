'use strict';
app.controller('citypairYearlyController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route) {
    ...
    $scope.bind = function () {
       ...
       // dts.push('month=' + ($scope.month + 1));
        ...
        var url = 'odata/citypair/yearly/report';//2019-06-06T00:00:00';
        if (prms)
            url += '?' + prms;
    ...
    if (!authService.isAuthorized()) {
        ...
        $rootScope.page_title = '> Yearly City Pairs Report';


        $('.citypairyearly').fadeIn(400, function () {
