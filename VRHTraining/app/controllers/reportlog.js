'use strict';
app.controller('reportlog', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', 'flightBagService','qalogService', '$sce', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route, flightBagService,qalogService, $sce) {
   ...
   /////////////////////////
    ...
    $scope.bind = function () {
        ...
        qalogService.getFlightLogMain(df,dt).then(function (response) {
            $scope.loadingVisible = false;
             ...
             $scope.dg_flight_ds = response.Data;
	...
	$scope.bindDetails = function (fid) {
        ...
        qalogService.getFlightLogDetail(fid).then(function (response) {
            $scope.loadingVisible = false;
             ...
             console.log(response);
              $scope.dg_det_flight_ds = response.Data.flight_log;
    ...
    $scope.$watch("selectedTabIndex", function (newValue) {
        ...
        try {
            ...
            if ($scope.dg_det_flight_instance)
                $scope.dg_det_flight_instance.refresh();
        }
        catch (e) {
 ...
 { dataField: 'STDLocal', caption: 'Date', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 110, format: 'yy-MMM-dd', fixed: true, fixedPosition: 'left' },
          { dataField: 'FlightNo', caption: 'Flight No', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 90, fixed: false, fixedPosition: 'left', fixed: true, fixedPosition: 'left' },
         { dataField: 'FromIATA', caption: 'From', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80,fixed: true, fixedPosition: 'left' },
        { dataField: 'ToIATA', caption: 'To', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80,fixed: true, fixedPosition: 'left' },
         { dataField: 'Register', caption: 'Reg', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80,sortIndex: 0, sortOrder: 'desc'   },
      
		
         { dataField: 'STDLocal', caption: 'STD', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm',sortIndex: 1, sortOrder: 'asc' },
         ...
         { dataField: 'FlightStatus', caption: 'Status', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80, fixed: false, fixedPosition: 'left',   },
       
        { dataField: 'IsDeleted', caption: 'Deleted', allowResizing: true, alignment: 'center', dataType: 'boolean', allowEditing: false, width: 80, fixed: true, fixedPosition: 'right', },
     
	 {
		    caption:'Initial',
			columns:[
			{ dataField: 'iSTDLocal', caption: 'Date', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 110, format: 'yy-MMM-dd', sortIndex: 0, sortOrder: 'asc', fixed: true, fixedPosition: 'left' },
          { dataField: 'iFlightNo', caption: 'Flight No', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 90, fixed: false, fixedPosition: 'left', fixed: true, fixedPosition: 'left' },
         { dataField: 'iFromIATA', caption: 'From', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80 },
        { dataField: 'iToIATA', caption: 'To', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80 },
         { dataField: 'iRegister', caption: 'Reg', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80, sortIndex: 2, sortOrder: 'asc' },
      
		
         { dataField: 'iSTDLocal', caption: 'STD', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm', },
         { dataField: 'iSTALocal', caption: 'STA', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm' },
...
$scope.stations = [];
    ...
    $scope.dg_flight = {
        ...
        onSelectionChanged: function (e) {
            ...
            if (!data) {
			   ...
			   $scope.bindDetails($scope.selectedFlight.FlightId);
            }
 ...
 { dataField: 'DateCreate', caption: 'Date', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 140, format: 'yy-MMM-dd HH:mm', fixed: true, fixedPosition: 'left' ,sortIndex: 0, sortOrder: 'asc'},
       { dataField: 'Username', caption: 'User', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 130 ,fixed: true, fixedPosition: 'left'  },
         { dataField: 'FieldName', caption: 'Property', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 130,fixed: true, fixedPosition: 'left' },
        { dataField: 'OldValue', caption: 'Old Value', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, minWidth: 170,fixed: false, fixedPosition: 'left' },
         { dataField: 'NewValue', caption: 'New Value', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, minWidth: 170    },
      
		   { dataField: 'Action', caption: 'Action', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80,  fixed: false, fixedPosition: 'left' },
	 ...
	 $scope.dg_det_flight = {
        ...
        columns: $scope.dg_det_flight_columns,
        onContentReady: function (e) {
            if (!$scope.dg_det_flight_instance)
                $scope.dg_det_flight_instance = e.component;
        ...
        onSelectionChanged: function (e) {
            ...
            if (!data) {
                $scope.dg_det_flight_selected = null;
                
            }
            else {
                $scope.dg_det_flight_selected = data;
