'use strict';
app.controller('vira_shipmentController', ['$scope', '$location', '$routeParams', '$rootScope', 'authService', 'notificationService', '$route', 'mntService', 'vira_general_service',
    function ($scope, $location, $routeParams, $rootScope, authService, notificationService, $route, mntService, vira_general_service) {
        ...
        $scope.delete = function (callback) {
            $scope.loadingVisible = true;
            vira_general_service.delete_shipment($scope.entity.id).then(function (res) {
                $scope.loadingVisible = false;
                if (callback)
                    callback(res);
                else {
