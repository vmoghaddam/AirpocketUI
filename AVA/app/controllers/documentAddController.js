...
app.controller('documentAddController', ['$scope', '$location', 'libraryService', 'authService', '$routeParams', '$rootScope', function ($scope, $location, libraryService, authService, $routeParams, $rootScope) {
    ...
    $scope.grp_ds = [
	 ...
	 $scope.ac_ds_show = [
				{ title: 'B737', selected: false, Id: 37, ManufacturerId: 2, Remark: '' },
        { title: 'MD', selected: false, Id: 35, ManufacturerId: 4, Remark: '' },
    ...
    $scope.sb_Category = {
        ...
        showClearButton: true,
        searchEnabled: true,
        dataSource: [{ Id: 10007, Title: 'PIF' }, { Id: 10008, Title: 'CIF' }, { Id: 95, Title: 'DIF' }, { Id: 300063, Title: 'Safety Notice'},  { Id: 300072, Title: 'Administrative Regulations'}], //$rootScope.getDatasourceOption(94),
        displayExpr: "Title",
        valueExpr: 'Id',
