...
app.factory('schedulingService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var _getCrewDutiesByYearMonth = function (crewid, year, month) {
       ...
       // $http.get(serviceBase + 'odata/roster/fdps/' + crewid + '/' + year + '/' + month).then(function (response) {
		   $http.get(apiScheduling + 'api/roster/fdps/' + crewid + '/' + year + '/' + month).then(function (response) {
    ...
    var _saveFDP = function (entity) {
        var deferred = $q.defer();
        //$http.post( /*$rootScope.serviceUrl*/netsch   + 'odata/roster/fdp/save', entity).then(function (response) {
			var url = apiScheduling + 'api/roster/fdp/save';
    ...
    var _getRosterFDPs = function (df, dt) {
        ...
        //$http.get(serviceBase + 'odata/roster/fdps/' + '?df=' + df + '&dt=' + dt).then(function (response) {
			$http.get(/*serviceBase + 'odata/roster/fdps/' + '?df=' + df + '&dt=' + dt*/apiScheduling +'api/sch/roster/fdps/' + '?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _sendMVT = function (flightId, username) {
        ...
        var deferred = $q.defer();
        $http.get(apisch + 'api/mail/mvt/' + flightId + '/' + username + '/vahid/Chico1359').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getTrainingSessionConvertingErrors = function () {
        ...
        var deferred = $q.defer();
        $http.get(apisch + 'api/idea/session/update/errors').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewsLight = function () {
        ...
        var deferred = $q.defer();
        $http.get(apisch + 'api/crew/light').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewTrainigDuties = function (crewid) {
        ...
        var deferred = $q.defer();
        $http.get(apisch + 'api/training/duties/' + crewid + '/1').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getNiraConflicts = function (df, dt) {
        ...
        var deferred = $q.defer();
        $http.get(apisch + 'api/nira/conflicts/' + df + '/' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getOFP = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(apisch + 'api/ofp/flight/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveOFP = function (entity) {
        var deferred = $q.defer();
        $http.post(apisch + 'api/ofp/parse/text/input', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveOFPT = function (entity) {
        var deferred = $q.defer();
        $http.post(apisch + 'api/ofp/parse/text', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFDPsCrewCount = function (d1, d2) {
        var deferred = $q.defer();
        $http.get(apisch + 'api/fdps/crew/count?dt1=' + d1 + '&dt2=' + d2).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFTLByCrewIds = function (entity) {
        var deferred = $q.defer();
        //$http.post(apisch + 'api/ftl/abs/crews/', entity).then(function (response) {
  ...
  var _getFdpsByFlight = function (ids) {
    ...
    var _getFTLExceedAll = function (id) {
        var deferred = $q.defer();
        $http.get(apisch + 'api/ftl/crew/date/range/exceed/' + '?df&dt&crew=' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDutyTimeLineMonthly = function (year, month, rank, type) {
        var deferred = $q.defer();
        $http.get(apisch + 'api/duty/timeline/' + year + '/' + month + '/' + rank + '/' + type).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDutyTimeLine = function (df, dt, rank, type) {
        var deferred = $q.defer();
        $http.get(apisch + 'api/duty/timeline/' + rank + '/' + type + '?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDutyTimeLineByCrew = function (df, dt, id) {
        var deferred = $q.defer();
        $http.get(apisch + 'api/duty/timeline/crew/' + id + '?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewForRosterByDateNew = function (cid, dt) {
        var deferred = $q.defer();
        //$http.get(apisch + 'api/crew/valid/1?dt=' + dt).then(function (response) {
			$http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/apiScheduling + 'api/sch/crew/valid/?dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
 ...
 var _getSchFlights = function (df, dt) {
    ...
    serviceFactory.getFlightCrewsNew = _getFlightCrewsNew;
	  var _saveEventGroup = function (entity) {
        var deferred = $q.defer();
        $http.post(apiScheduling + 'api/event/group/save/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFTL = function (cid, df) {
        ...
        var deferred = $q.defer();
        $http.get(apisch + "api/ftl/crew/date/?df=" + df + "&crew=" + cid).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightTimeYear = function (cid, y) {
        ...
        var deferred = $q.defer();
        $http.get(apisch + "api/flighttime/crew/year/" + cid + "/" + y).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
            alert(JSON.stringify(err));
            deferred.reject(Exceptions.getMessage(err));
    ...
    var _saveFixTime = function (entity) {
        var deferred = $q.defer();
        $http.post(apisch + 'api/fixtime/save/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.saveFixTime = _saveFixTime;
	  ...
	  var _getFDPLogs = function (df,dt) {

        var deferred = $q.defer();
        $http.get(apischedling + 'api/fdp/log?df=' + df+'&dt='+dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	 ...
	 serviceFactory.getFDPLogs = _getFDPLogs;
    ///////////////////
