...
app.factory('flightService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var serviceFactory = {};
     ...
     $http.get(apireportflight + 'api/report/citypair/daily/' + df + '/' +dt)
 ...
 serviceFactory.get_rptCPD = _get_rptCPD;
   ...
   /* var _getCrewFlightsTotal = function (df, dt) {
	...
	var _getCrewFlightsTotal = function (df, dt) {
        ...
        var _dt = moment(dt).format('YYYY-MM-DD');
        var deferred = $q.defer();
        $http.get(apireportflight + 'api/crew/flights/ALL/ALL?df=' + _df + '&dt=' + _dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _dutiesVisibleByDates = function (entity) {
     ...
     var _sendSMS = function (entity) {
         var deferred = $q.defer();
         $http.post(zapinet + 'odata/sms/save', entity).then(function (response) {
             deferred.resolve(response.data);
         }, function (err, status) {
     ...
     var _updateSMSStatus = function (entity) {
         var deferred = $q.defer();
         $http.post(zapinet + 'odata/sms/status/update', entity).then(function (response) {
             deferred.resolve(response.data);
         }, function (err, status) {
 ...
 /////////////////////////
	...
	var _getFlightPaxDailyReport = function (df, dt) {


        var deferred = $q.defer();
        $http.get(apireportflight + 'api/flightpax/daily?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	serviceFactory.getFlightPaxDailyReport = _getFlightPaxDailyReport;
 ...
 var _updateATC = function (id,fn) {
	...
	///////////////////////////
	var _savePax = function (entity) {
        var deferred = $q.defer();
        $http.post(apiLog + 'api/log/flight/pax/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.savePax = _savePax;
	
	
	 var _getFlightPax = function (id ) {
        var deferred = $q.defer();
        $http.get(apiLog + 'api/log/flight/pax'+'/'+id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
