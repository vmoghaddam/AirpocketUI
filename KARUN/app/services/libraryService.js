...
app.factory('libraryService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var _getBook = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(liburl + 'odata/library/book/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _exposeBook = function (entity) {
        ...
        //$http.post($rootScope.serviceUrl + 'odata/library/book/expose', entity).then(function (response) {
		 $http.post(/*$rootScope.serviceUrl*/liburl + 'odata/library/book/expose', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _save = function (entity) {
        var deferred = $q.defer();
        $http.post(liburl + 'odata/library/book/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
