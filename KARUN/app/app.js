...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when("/home", {
        ...
        templateUrl: "/app/views/home.html?v="+'22349'
    });
  ...
  $routeProvider.when("/rptCityPairDaily", {
    ...
    $routeProvider.when("/person", {
        ...
        templateUrl: "/app/views/person.html?v=9775"
    });
    ...
    $routeProvider.when("/library", {
        ...
        templateUrl: "/app/views/library.html?v=1",
        isDocument:false,
    });
    ...
    $routeProvider.when("/document", {
        controller: "libraryController",
        templateUrl: "/app/views/document.html?v=1",
        isDocument: true,
    });
    ...
    $routeProvider.when("/board", {
        ...
        templateUrl: "/app/views/board.html?v=1675",
        isAdmin: true,
    });
    ...
    $routeProvider.when("/flights/efbs", {
        ...
        templateUrl: "/app/views/reportEFB.html?v=734"
    });
	...
	$routeProvider.when("/scheduling/adminxy", {
        controller: "zschedulingController",
        templateUrl: "/app/views/zscheduling.html?v=123",
        isAdmin: true,
    });
    $routeProvider.when("/scheduling", {
        controller: "zschedulingController",
	...
	$routeProvider.when("/scheduling/z/adminxy", {
        controller: "zschedulingController",
        templateUrl: "app/views/zscheduling.html??v=123",
        isAdmin: true,
    });
 ...
 $routeProvider.when("/report/flight/daily", {
	...
	$routeProvider.when("/report/flight/pax", {
        controller: "reportFlightPaxController",
        templateUrl: "/app/views/reportflightpax.html?v=1"
    });
  ...
  $routeProvider.when("/trn/stat", {
    ...
    $routeProvider.when("/trn/dashboard", {
	  ...
	  $routeProvider.when("/duty/timeline/z", {
        ...
        templateUrl: "/app/views/zdutyTimeline.html?v=6753"
    });
...
app.run(['authService', 'activityService', '$rootScope', '$location', '$templateCache', function (authService, activityService, $rootScope, $location, $templateCache) {
    ...
    ////////////////////////////////
    $rootScope.reportServer = "https://airpocket.karunair.ir/report/frmreportview.aspx";
	...
	$rootScope.HasShowPastCrews = function () {
        
        var role = Enumerable.From($rootScope.roles).Where('$=="Show Closed Flights Crews"').FirstOrDefault();
        if (role)
            return true;
        return false;
    };
...
$rootScope.HasDispatch = function () {
    ...
    $rootScope.HasMenuAccess = function (key, module) {
		...
		||  $rootScope.userName.toLowerCase()==('3052112341')
		||  $rootScope.userName.toLowerCase()==('f.monjezi')
		||  $rootScope.userName.toLowerCase()==('0938692739')
		||  $rootScope.userName.toLowerCase()==('0073890928')
		
		
		||  $rootScope.userName.toLowerCase()==('0490311873')
		||  $rootScope.userName.toLowerCase()==('1741279038')
		
		||  $rootScope.userName.toLowerCase()==('arbab')
		|  $rootScope.userName.toLowerCase()==('r.zabihi')
		;
