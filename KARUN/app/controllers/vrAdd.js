...
app.controller('vrAddController', ['$scope', '$location', 'flightBagService', 'authService', '$routeParams', '$rootScope', '$window', '$http', function ($scope, $location, flightBagService, authService, $routeParams, $rootScope, $window,   $http) {
    ...
    $scope.isOPSManager = false;
    $scope.isOPSStaff = true;
   ...
   $scope.entity = {
	...
	$scope.txt_action = {
        ...
        height: 200,
        bindingOptions: {
            value: 'entity.ActionTaken',
        }
    };
	$scope.txt_other_form = {
        min: 0,
        height: 70,
        bindingOptions: {
            value: 'entity.OtherForm',
        }
    };
    //FLIGHT CANCELLATION
	...
	//DELAY
	$scope.irr_300054 = false;
    $scope.chb_irr_300054 = {
        text: '',
        bindingOptions: {
            value: 'irr_300054',
        }
	...
	$scope.irr_300055 = false;
    $scope.chb_irr_300055 = {
        text: '',
        bindingOptions: {
            value: 'irr_300055',
        }
    ...
    $scope.duty_300059 = false;
    $scope.chb_duty_300059 = {
        text: '',
        bindingOptions: {
            value: 'duty_300059',
        }
...
//EXTENTION OF FDP
 $scope.duty_300060 = false;
    $scope.chb_duty_300060 = {
        text: '',
        bindingOptions: {
            value: 'duty_300060',
        }
...
//FATIQUE REPORT
 $scope.duty_300061 = false;
    $scope.chb_duty_300061 = {
        text: '',
        bindingOptions: {
            value: 'duty_300061',
        }
...
$scope.duty_300062 = false;
    $scope.chb_duty_300062 = {
        text: '',
        bindingOptions: {
            value: 'duty_300062',
	}
...
$scope.frm_asr = false;
    ...
    $scope.chb_frm_cr = {
        text: '',
        bindingOptions: {
            value: 'entity.AttForm_CR',
        }
    };
	
	
	$scope.frm_accident = false;
    $scope.chb_frm_accident = {
        text: '',
        bindingOptions: {
            value: 'entity.AttForm_ACCIDET',
        }
    };
	
	$scope.frm_other = false;
    $scope.chb_frm_other = {
        text: '',
        bindingOptions: {
            value: 'entity.AttForm_Other',
        }
    };
            ...
            },
            {
                ...
                widget: 'dxButton', location: 'after', options: {
                    type: 'default', text: 'Print',   onClick: function (e) {
                          $window.open('https://airpocket.karunair.ir/reportefb/frmreportview.aspx' + '?type=vrk&fid=' +$scope.entity.FlightId, '_blank');
                    }
                }, toolbar: 'bottom'
            },
            {
    ...
    $scope.fill = function (data) {
		...
		$scope.irr_300054 = irregularity.indexOf(300054) != -1;
		$scope.irr_300055 = irregularity.indexOf(300055) != -1;
        ...
        $scope.re_100128 = reason.indexOf(100128) != -1;
		 $scope.re_300056 = reason.indexOf(300056) != -1;
		  $scope.re_300057 = reason.indexOf(300057) != -1;
		  
		   var dis = Enumerable.From(data.EFBDutyDisorders).Select('Number($.DisorderId)').ToArray();
        $scope.duty_300059 = dis.indexOf(300059) != -1;
        $scope.duty_300060 = dis.indexOf(300060) != -1;
        $scope.duty_300061 = dis.indexOf(300061) != -1;
        $scope.duty_300062 = dis.indexOf(300062) != -1;
    ...
    $scope.bind = function () {
        ...
        $scope.loadingVisible = true;
            ...
            flightBagService.epGetVRByFlight($scope.entity.FlightId).then(function (response2) {
                ...
                if (!response2.Data) {
                    $scope.entity.Id = -1;
					$scope.entity.AttForm_ASR=false;
					$scope.entity.AttForm_CSR=false;
					$scope.entity.AttForm_CR=false;
					$scope.entity.AttForm_Other=false;
					$scope.entity.AttForm_ACCIDET=false;
					$scope.entity.IsForInformation=false;
					$scope.entity.IsActionRequired=false;
                    $scope.isNew = true;
                    ...
                    $scope.PIC3 = '';
                    $scope.signDate3 = '';
                    if (response2.Data.JLDatePICApproved) {
                        $scope.isEditable = false;
