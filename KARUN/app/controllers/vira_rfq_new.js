'use strict';
app.controller('vira_rfq_newController', ['$scope', '$rootScope', 'mntService', function ($scope, $rootScope, mntService) {
    ...
    $scope.dg_company = {
        ...
        onSelectionChanged: function (e) {
            ...
            $scope.dg_company_id.Id = e.selectedRowsData[0].Id;

            console.log($scope.dg_company_id.id);
            if (!data) {
                $scope.dg_company_selected = null;
            }
            else
    ...
    $scope.$on('InitNewRFQ', function (event, prms) {
