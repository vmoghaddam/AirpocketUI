'use strict';
app.controller('formmovaledController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route','$window', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route,$window) {
    ...
    if (!authService.isAuthorized()) {
        ...
        $rootScope.page_title = '> Air Transport Report - فرم مولد';


        $('.formmovaled').fadeIn(400, function () {
...

 {
    ...
    $scope.btn_print = {
        ...
        onClick: function (e) {
            ...
            $window.open($rootScope.reportServer + '?type=2&year=' + $scope.reportData.Year + '&month=' + $scope.reportData.Month, '_blank');
           // $scope.bindReport();
