'use strict';
app.controller('cabinReports', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', 'flightBagService', '$sce', 'neerjaService', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route, flightBagService, $sce, neerjaService) {
    ...
    $scope.dg_flight_columns = [
        ...
        { dataField: 'FlightNumber', caption: 'Flight No', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 90, fixed: false, fixedPosition: 'left', fixed: true },
    ...
    $scope.bindEval = function () {
        neerjaService.get_eval($scope.selectedFlight.FlightId, $scope.entity.crew2).then(function (res) {
