  ...
  /*  $scope.IsEditable = $rootScope.roles.indexOf('Admin') != -1 || $rootScope.userName.toLowerCase() == 'i.zamani' || $rootScope.userName.toLowerCase() == 'dehghan'  || $rootScope.userName.toLowerCase() == 'khorshidi'
    ...
    $scope.entity = {
        ...
        Person: {
			...
			TypeFoker50IssueDate: null,
            TypeFoker50ExpireDate: null,
			
			TypeFoker100IssueDate: null,
            TypeFoker100ExpireDate: null,
...
ExpireDateTRG02:null,
 ...
 $scope.entity.Person.Type737IssueDate = null;
        ...
        $scope.entity.Person.TypeAirbusExpireDate = null;
		  ...
		  $scope.entity.Person.TypeFoker50IssueDate = null;
        $scope.entity.Person.TypeFoker50ExpireDate = null;
		
		  $scope.entity.Person.TypeFoker100IssueDate = null;
        $scope.entity.Person.TypeFoker100ExpireDate = null;
...
$scope.entity.Person.ExpireDateTRG02= null;
		...
		$scope.entity.Person.AircraftTypes2 = [];
    ...
    $scope.bindPerson = function (data) {
		...
		$scope.entity.Person.TypeFoker50IssueDate = data.TypeFoker50IssueDate;
        $scope.entity.Person.TypeFoker50ExpireDate = data.TypeFoker50ExpireDate;
		
		
		
		$scope.entity.Person.TypeFoker100IssueDate = data.TypeFoker100IssueDate;
        $scope.entity.Person.TypeFoker100ExpireDate = data.TypeFoker100ExpireDate;
...
$scope.entity.Person.ExpireDateTRG02= data.ExpireDateTRG02 ;
		...
		$scope.entity.Person.AircraftTypes2 = [];//data.AircraftTypes2;
		$.each(data.AircraftTypes2,function(_i,_d){
			var _rec=Enumerable.From($scope.ds_ac_types).Where('$.AircraftTypeId=='+_d.AircraftTypeId).FirstOrDefault();
			if (_rec)
				$scope.entity.Person.AircraftTypes2.push(_rec);
		});
		console.log('ac types 2',$scope.entity.Person.AircraftTypes2);
  ...
  //nasiri
	...
	$scope.ds_ac_types=[
	 {AircraftType:'F100',AircraftTypeId:100},
	 {AircraftType:'F50',AircraftTypeId:50},
	 {AircraftType:'733',AircraftTypeId:733},
	];
	
	
	$scope.tag_ac_types= {
        displayExpr: 'AircraftType',
        //valueExpr: 'AircraftTypeId',
        hideSelectedItems: true,
        searchEnabled: true,
        bindingOptions: {
            dataSource: 'ds_ac_types',
            value:'entity.Person.AircraftTypes2',
    ...
    $scope.date_TypeMDExpireDate = {
	 ...
	 $scope.date_TypeFoker50IssueDate = {
        width: '100%',
        type: 'date',
        displayFormat: $rootScope.DateBoxFormat,
        onValueChanged: function (e) {
            ...
            $scope.entity.Person.TypeFoker50ExpireDate = (new Date(e.value)).addYears(1);
        },
        bindingOptions: {
            value: 'entity.Person.TypeFoker50IssueDate',
            readOnly: 'IsMainDisabled',
            disabled: 'IsCerDisabled',
        }
    };

    $scope.date_TypeFoker50ExpireDate = {
        width: '100%',
        type: 'date',
        displayFormat: $rootScope.DateBoxFormat,

        bindingOptions: {
            value: 'entity.Person.TypeFoker50ExpireDate',
            readOnly: 'IsMainDisabled',
            disabled: 'IsCerDisabled',
        }
    };
	 ...
	 $scope.date_TypeFoker100IssueDate = {
        width: '100%',
        type: 'date',
        displayFormat: $rootScope.DateBoxFormat,
        onValueChanged: function (e) {
            ...
            $scope.entity.Person.TypeFoker100ExpireDate = (new Date(e.value)).addYears(1);
        },
        bindingOptions: {
            value: 'entity.Person.TypeFoker100IssueDate',
            readOnly: 'IsMainDisabled',
            disabled: 'IsCerDisabled',
        }
    };

    $scope.date_TypeFoker100ExpireDate = {
        width: '100%',
        type: 'date',
        displayFormat: $rootScope.DateBoxFormat,

        bindingOptions: {
            value: 'entity.Person.TypeFoker100ExpireDate',
            readOnly: 'IsMainDisabled',
            disabled: 'IsCerDisabled',
        }
    };
   ...
   //FRMS
	...
	$scope.date_LineC1IssueDate = {
        ...
        onValueChanged: function (e) {
            ...
            $scope.entity.Person.LineC1ExpireDate = (new Date(e.value)).addYears(1);
        },
        bindingOptions: {
	...
	$scope.date_LineC2IssueDate = {
        ...
        onValueChanged: function (e) {
            ...
            $scope.entity.Person.LineC2ExpireDate = (new Date(e.value)).addYears(1);
        },
        bindingOptions: {
...
$scope.date_Type737IssueDate = {
   ...
   $scope.date_EGPWSIssueDate = {
        ...
        onValueChanged: function(e) {
			...
			//if ($scope.isNew || !$scope.entity.Person.EGPWSExpireDate)
                      $scope.entity.Person.EGPWSExpireDate = (new Date(e.value)).addYears(3);
    ...
    $scope.popup_add.toolbarItems[18].options.onClick = function (e) {
        //sookq
		if($scope.selectedDepObj.FullCode =='1004' &&  $rootScope.roles.indexOf('Profiles-Ground-Edit')==-1)
		{
            General.ShowNotify('You can not edit the "'+$scope.selectedDep+'" employees.', 'error');
            return;
        }
		if($scope.selectedDepObj.FullCode =='10010' &&  $rootScope.roles.indexOf('Profiles-Crew-Edit')==-1)
		{
            General.ShowNotify('You can not edit the "'+$scope.selectedDep+'" employees.', 'error');
            return;
        }
 ...
 if ($scope.entity.Person.EGPWSIssueDate)
        ...
        if ($scope.entity.Person.LineExpireDate)
		 ...
		 if ($scope.entity.Person.LineC1ExpireDate)
            $scope.entity.Person.LineC1ExpireDate = (new Date($scope.entity.Person.LineC1ExpireDate)).addMinutes(offset);
 ...
 if ($scope.entity.Person.TypeFoker50IssueDate)
            $scope.entity.Person.TypeFoker50IssueDate = (new Date($scope.entity.Person.TypeFoker50IssueDate)).addMinutes(offset);
        if ($scope.entity.Person.TypeFoker50ExpireDate)
            $scope.entity.Person.TypeFoker50ExpireDate = (new Date($scope.entity.Person.TypeFoker50ExpireDate)).addMinutes(offset);

 if ($scope.entity.Person.TypeFoker100IssueDate)
            $scope.entity.Person.TypeFoker100IssueDate = (new Date($scope.entity.Person.TypeFoker100IssueDate)).addMinutes(offset);
        if ($scope.entity.Person.TypeFoker100ExpireDate)
            $scope.entity.Person.TypeFoker100ExpireDate = (new Date($scope.entity.Person.TypeFoker100ExpireDate)).addMinutes(offset);
