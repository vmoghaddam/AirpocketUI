...
app.controller('personController', ['$scope', '$location', '$routeParams', '$rootScope', 'personService', 'authService', 'notificationService', 'flightService', '$route', 'trnService', '$window', '$timeout', function ($scope, $location, $routeParams, $rootScope, personService, authService, notificationService, flightService, $route, trnService, $window, $timeout) {
	...
	$scope.IsNewVisible=$rootScope.roles.indexOf('Profiles-Ground-Edit')!=-1 || $rootScope.roles.indexOf('Profiles-Crew-Edit')!=-1;
    ...
    $scope.dg_columns2 = [
       ...
       //},
		...
		/* {
            dataField: 'JobGroupC1', caption: 'CODE',name:'CODE', allowResizing: true
       ...
       { dataField: 'Name', caption: 'Name', allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, width:300, fixed: screen.width> 1024 ? true : false, fixedPosition: 'left' },
              //  { dataField: 'ScheduleName', caption: 'Schedule', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 200 },
			   ...
			   { dataField: 'Reserved1', caption: 'Type',allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 130 },
		...
		// { dataField: 'Remain2', caption: 'CyberSec', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 90 },
			...
			{ dataField: 'Remain19', caption: 'SMSL3',name:'SMSL3', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
       ...
       // { dataField: 'RemainCAO', caption: 'GRT', name: 'GRT', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100 },
        ...
        //nasiri
       { dataField: 'RemainHotWeather', caption: 'HotWX', name: 'HotWX', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100 },
	   { dataField: 'RemainColdWeather', caption: 'ColdWX', name: 'ColdWX', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100 },
		
		

        { dataField: 'RemainType737', caption: 'Type737',name:'Type737', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
		{ dataField: 'RemainTypeFoker50', caption: 'TypeFK50',name:'TypeFK50', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
		{ dataField: 'RemainTypeFoker100', caption: 'TypeFK100',name:'TypeFK100', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
		{ dataField: 'RemainTypeMD', caption: 'TypeMD',name:'FlightCheck', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
        //moradi2
		...
		{ dataField: 'RemainMB', caption: 'W&B',name:'MB', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
		...
		{ dataField: 'RemainLRC', caption: 'RADIO',name:'RC', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
...
{ dataField: 'Remain25', caption: 'MPA',name:'MPA', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
			...
			{ dataField: 'Remain28', caption: 'CON. TYPE',name:'CONTYPE', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
			{ dataField: 'Remain29', caption: 'MEL',name:'MELQA', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
			{ dataField: 'Remain30', caption: 'AADF',name:'AADF', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
			{ dataField: 'Remain31', caption: 'REF. TYPE',name:'REFTYPE', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
			{ dataField: 'Remain32', caption: 'REGULATION',name:'REGULATION', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
			{ dataField: 'Remain33', caption: 'CC',name:'CCTRN', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
			{ dataField: 'Remain34', caption: 'LOADSHEET',name:'LOADSHEETTRN', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
			{ dataField: 'Remain35', caption: 'ASF',name:'ASFTRN', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
			
			
			{ dataField: 'Remain46', caption: 'SMS',name:'SMS2', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
			{ dataField: 'Remain43', caption: 'SECURITY',name:'AVSEC2', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },
			{ dataField: 'Remain45', caption: 'ERP',name:'ERP2', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },				
			{ dataField: 'Remain47', caption: 'HEALTH',name:'CATERINGHEALTH', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },				
			{ dataField: 'Remain48', caption: 'MANUAL',name:'SECURITYMANUAL', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },				
			{ dataField: 'Remain42', caption: 'P/S',name:'PS2', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },				
			{ dataField: 'Remain44', caption: 'CLEAN',name:'CLEAN', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },				
			{ dataField: 'Remain39', caption: 'M/L',name:'MONEY', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },				
			{ dataField: 'Remain38', caption: 'FTL',name:'FTL', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },				
			{ dataField: 'Remain40', caption: 'CRM',name:'CRM2', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },				
			{ dataField: 'Remain41', caption: 'REC. INS.',name:'RECINS', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },				
			
			{ dataField: 'Remain36', caption: 'AIROPS',name:'AIROPSE', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100,visible:false },				
			{ dataField: 'Remain37', caption: 'AIROPS(CC/FC)',name:'AIROPSCC', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 130,visible:false },				
    ...
    $scope.dg = {
        ...
        onCellPrepared: function (e) {
			...
			if (e.rowType!='data' || ['InActive','JobGroupRoot','JobGroup','Name','Mobile'].indexOf(e.column.dataField)!=-1)
				return;
            ...
            */
            ...
            if (e.column.dataField=="RemainTypeAirbus")   {
				...
				if (e.column.name=="AIROPSE" || e.column.name=="AIROPSCC"){
					if (e.value=='-100000')
									e.cellElement.html('N/A');
					else e.cellElement.html('✓');
				}
				else
				if (e.column.name=="SMSL2" && (e.data['JobGroupRoot']=='ADMINISTRATIVE' || e.data['JobGroupRoot']=='PUBLIC RELATIONS' || e.data['JobGroupRoot']=='CRM')){
					if (e.value=='-100000')
									e.cellElement.html('N/A');
			...
			{ 
				...
				|| e.column.dataField == "Remain31"
				|| e.column.dataField == "Remain28"))
					e.cellElement.html('N/A');
				else
				e.cellElement.html('?');
			}
			if(e.data['JobGroupRoot'] != 'Cabin' && e.data['JobGroupRoot'] != 'Cockpit' && e.data['JobGroupRoot'] != 'F/D' 
			  && e.value == '-100000') {
				e.cellElement.css("backgroundColor", "#ffffff");
				e.cellElement.css("color", "unset");
				e.cellElement.html('N/A');
			}
...
|| e.column.dataField == "Remain28"			))
        ...
        if (value>30 && value<=45 && e.column.dataField!="RemainTypeAirbus" && e.column.dataField!="RemainEGPWS"){
            e.cellElement.css("backgroundColor", "#ffd633");
            e.cellElement.css("color", "#000");
        }
        else if (value > 0 && value <= 30 && e.column.dataField!="RemainTypeAirbus" && e.column.dataField!="RemainEGPWS") {
...
,'IT'
        ...
        onValueChanged: function (e) {
           ...
           $scope.dg_instance.columnOption('oae', 'visible', e.value == 'Cockpit' || e.value == 'Cabin');
			   //$scope.dg_instance.columnOption('HB', 'visible', e.value == 'Cockpit' || e.value == 'Cabin');
...
$scope.dg_instance.columnOption('Reserved1', 'visible', e.value == 'Cockpit');
...
$scope.dg_instance.columnOption('ColdWX', 'visible', e.value == 'Cockpit' || e.value == 'F/D');
			...
			$scope.dg_instance.columnOption('Line', 'visible', e.value == 'Cockpit');
			
$scope.dg_instance.columnOption('AvSec', 'visible', e.value == 'Cockpit' || e.value == 'Cabin' || e.value == 'F/D' || e.value == 'GRND' || e.value == 'COMM' || e.value=='MAINTENANCE' || e.value=='QA' || e.value=='LEGAL' || e.value=='CAMO' || e.value=='TRAINING');
			
			//$scope.dg_instance.columnOption('CyberSec', 'visible',   e.value == 'COMM');
$scope.dg_instance.columnOption('SMS', 'visible', e.value == 'Cockpit' || e.value == 'Cabin' || e.value == 'F/D' || e.value == 'GRND' || e.value == 'COMM'  || e.value=='CAMO'  || e.value=='QA'  || e.value=='MAINTENANCE'  || e.value=='TRAINING'  || e.value=='LEGAL');
...
$scope.dg_instance.columnOption('DG', 'visible', e.value == 'Cockpit' || e.value == 'Cabin' 
   || e.value == 'F/D' || e.value == 'GRND' || e.value == 'COMM'  || e.value=='QA' || e.value=='TRAINING' 
   || e.value=='LOGISTIC'
   || e.value=='CRM'
   || e.value=='SECURITY'
   
   );
$scope.dg_instance.columnOption('CRM', 'visible', e.value == 'Cockpit' || e.value == 'Cabin' || e.value == 'F/D');
$scope.dg_instance.columnOption('CCRM', 'visible', e.value == 'Cockpit' || e.value == 'Cabin' || e.value == 'F/D');
$scope.dg_instance.columnOption('FirstAid', 'visible', e.value == 'Cabin');
$scope.dg_instance.columnOption('FMT', 'visible', e.value == 'Cabin' || e.value == 'Cockpit' || e.value == 'F/D');
$scope.dg_instance.columnOption('FRMS', 'visible', e.value == 'Cockpit');
$scope.dg_instance.columnOption('FlightCheck', 'visible', e.value == 'Cabin');
$scope.dg_instance.columnOption('Type737', 'visible', e.value == 'Cabin');
$scope.dg_instance.columnOption('TypeFK50', 'visible', e.value == 'Cabin');
$scope.dg_instance.columnOption('TypeFK100', 'visible', e.value == 'Cabin');
$scope.dg_instance.columnOption('Type', 'visible', e.value == 'Cabin');
$scope.dg_instance.columnOption('CMC', 'visible', e.value == 'Cockpit' || e.value == 'Cabin');
			
$scope.dg_instance.columnOption('HF', 'visible', /*e.value == 'F/D' ||*/ e.value == 'GRND' || e.value == 'COMM' 
|| e.value=='CAMO' || e.value=='QA'  || e.value=='MAINTENANCE'  || e.value=='TRAINING'  || e.value=='LEGAL'

|| e.value=='CATERING'
|| e.value=='SECURITY'
|| e.value=='SUPPORT'
|| e.value=='ADMINISTRATIVE'
|| e.value=='MANAGEMENT'
|| e.value=='OPERATION'
|| e.value=='LOGISTIC'
|| e.value=='IT'
...
$scope.dg_instance.columnOption('ASD', 'visible', e.value == 'GRND' || e.value == 'COMM'  || e.value=='QA'  || e.value=='MAINTENANCE'
...
|| e.value=='SUPPORT'
			...
			$scope.dg_instance.columnOption('DEICING', 'visible', e.value == 'GRND'  || e.value=='MAINTENANCE'  || e.value=='TRAINING'
|| e.value=='SECURITY'
|| e.value=='LOGISTIC'
			);
			
			$scope.dg_instance.columnOption('ASDIKA', 'visible',   e.value == 'COMM'  || e.value == 'GRND'  || e.value=='MAINTENANCE' || e.value=='CATERING');
$scope.dg_instance.columnOption('GOM', 'visible', e.value == 'GRND' || e.value == 'COMM');
$scope.dg_instance.columnOption('ASF', 'visible', e.value == 'GRND' 
|| e.value == 'COMM'
|| e.value == 'SECURITY'
|| e.value == 'MANAGEMENT'
|| e.value == 'LOGISTIC'
...
$scope.dg_instance.columnOption('ERP', 'visible', e.value == 'F/D' || e.value == 'GRND' || e.value == 'COMM'  || e.value=='CAMO'  || e.value=='QA'  || e.value=='MAINTENANCE'  || e.value=='TRAINING'  || e.value=='LEGAL');
...
$scope.dg_instance.columnOption('MEL', 'visible', e.value == 'F/D'  || e.value=='CAMO');
$scope.dg_instance.columnOption('MET', 'visible', e.value == 'F/D');
$scope.dg_instance.columnOption('PER', 'visible', e.value == 'F/D');
$scope.dg_instance.columnOption('RC', 'visible', e.value == 'F/D'  || e.value=='MAINTENANCE');
...
$scope.dg_instance.columnOption('AIROPS', 'visible',  e.value == 'QA'  || e.value=='TRAINING' || e.value=='OPERATION');	
...
$scope.dg_instance.columnOption('EWIS', 'visible', e.value == 'MAINTENANCE' ||  e.value == 'QA' ||  e.value == 'CAMO' ||  e.value == 'LOGISTIC');
$scope.dg_instance.columnOption('FTS', 'visible', e.value == 'MAINTENANCE'  ||  e.value == 'QA'  ||  e.value == 'CAMO' ||  e.value == 'LOGISTIC');
$scope.dg_instance.columnOption('PART145', 'visible', e.value == 'MAINTENANCE'  ||  e.value == 'QA'  ||  e.value == 'CAMO'  
|| e.value=='TRAINING'  || e.value=='LEGAL' || e.value=='LOGISTIC');
$scope.dg_instance.columnOption('PARTM', 'visible', e.value == 'MAINTENANCE'  ||  e.value == 'QA'  ||  e.value == 'CAMO' || e.value == 'TRAINING');
$scope.dg_instance.columnOption('MOE', 'visible', e.value == 'MAINTENANCE'  ||  e.value == 'QA'  ||  e.value == 'CAMO'  || e.value=='TRAINING' || e.value=='LOGISTIC');
...
$scope.dg_instance.columnOption('B737', 'visible', e.value == 'MAINTENANCE'  ||  e.value == 'QA');
...
$scope.dg_instance.columnOption('ADSB', 'visible', e.value == 'CAMO');
			...
			$scope.dg_instance.columnOption('MELQA', 'visible', e.value == 'QA'  || e.value=='TRAINING');
			$scope.dg_instance.columnOption('CCTRN', 'visible', e.value == 'TRAINING');
			$scope.dg_instance.columnOption('LOADSHEETTRN', 'visible', e.value == 'TRAINING' || e.value == 'LOGISTIC');
			$scope.dg_instance.columnOption('ASFTRN', 'visible', e.value == 'TRAINING');
$scope.dg_instance.columnOption('REGULATION', 'visible',   e.value=='LEGAL');
$scope.dg_instance.columnOption('CONTYPE', 'visible', e.value == 'MAINTENANCE');
//$scope.dg_instance.columnOption('REFTYPE', 'visible', e.value == 'MAINTENANCE');


//SHEIDA
$scope.dg_instance.columnOption('SMS2', 'visible', ['CATERING','SECURITY','ADMINISTRATIVE','MANAGEMENT','PUBLIC RELATIONS','OPERATION','CRM','LOGISTIC'].indexOf( e.value)!=-1);
$scope.dg_instance.columnOption('AVSEC2', 'visible', ['CATERING','SECURITY','SUPPORT','OPERATION','CRM','LOGISTIC'].indexOf( e.value)!=-1);
$scope.dg_instance.columnOption('ERP2', 'visible', ['CATERING','SECURITY','PUBLIC RELATIONS','ADMINISTRATIVE','MANAGEMENT','CRM','LOGISTIC'].indexOf( e.value)!=-1);
$scope.dg_instance.columnOption('CATERINGHEALTH', 'visible', ['CATERING'].indexOf( e.value)!=-1);
$scope.dg_instance.columnOption('SECURITYMANUAL', 'visible', ['SECURITY'].indexOf( e.value)!=-1);
$scope.dg_instance.columnOption('PS2', 'visible', ['SECURITY','LOGISTIC'].indexOf( e.value)!=-1);
$scope.dg_instance.columnOption('CLEAN', 'visible', ['SUPPORT'].indexOf( e.value)!=-1);
$scope.dg_instance.columnOption('MONEY', 'visible', ['ADMINISTRATIVE'].indexOf( e.value)!=-1);
	$scope.dg_instance.columnOption('FTL', 'visible', ['OPERATION'].indexOf( e.value)!=-1);	
$scope.dg_instance.columnOption('CRM2', 'visible', ['CRM'].indexOf( e.value)!=-1);	
$scope.dg_instance.columnOption('RECINS', 'visible', ['LOGISTIC'].indexOf( e.value)!=-1);	

$scope.dg_instance.columnOption('AIROPSE', 'visible', ['IT'].indexOf( e.value)!=-1);
$scope.dg_instance.columnOption('AIROPSCC', 'visible', ['IT'].indexOf( e.value)!=-1);
     ...
     $scope.btn_training = {
       ...
       // onClick: function (e) {
		...
		onClick: function (e) {
            ...
            if (obj)
				$window.open('https://airpocket.karunair.ir/reporttrn/frmreportview.aspx?type=11&pid='+(obj.PersonId*2+1237), '_blank') ;
