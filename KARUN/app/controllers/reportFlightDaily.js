...
$scope.sb_timeunit = {
 ...
 onValueChanged:function(e){
    ...
    $scope.dg_flight_columns = [
        ...
        { dataField: 'DepartureRemark', caption: 'CNL Reason', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 90, fixed: false, fixedPosition: 'left' },
       ...
       // { dataField: 'AircraftType', caption: 'AC TYPE', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 90, sortIndex: 1, sortOrder: 'asc' },
        ...
        { dataField: 'AirlineSold', caption: 'Airline Sale', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120, },
