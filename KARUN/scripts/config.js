...
Config.MenuItems = [
    ...
    { moduleId: 3, key: 'flight_pax', title: 'Pax Report', url: '/report/flight/pax', icon: 'content/images/passengers.png' },
    ...
    { moduleId: 3, key: 'delays_report_flight', title: 'Delayed Flights', url: '/delays/flight', icon: 'content/images/actype2.png' },
    ...
    { moduleId: 3, key: 'user_manager', title: 'Users', url: '/users', icon: 'content/images/user.png' },
