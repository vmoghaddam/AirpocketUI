...
{ moduleId: 3, key: 'flight_calendar_cabin', title: 'Calendar (Cabin)', url: '/crewtest', icon: 'content/images/actype2.png' },
     ...
     { moduleId: 3, key: 'flight_crew_time', title: 'Crew Flight Time', url: '/crew/time/report', icon: 'content/images/actype2.png' },
      ...
      { moduleId: 3, key: 'flight_roster', title: 'Daily Roster', url: '/roster', icon: 'content/images/actype2.png' },
	   ...
	   { moduleId: 3, key: 'flight_daily', title: 'Daily Report', url: '/report/flight/daily', icon: 'content/images/fltdaily.png' },
	      { moduleId: 3, key: 'daily_check', title: 'Daily Check', url: '/board/tbl/check', icon: 'content/images/fltdaily.png' },
		     { moduleId: 3, key: 'flight_opone', title: 'OP1', url: '/opones', icon: 'content/images/fltdaily.png' },
    ...
    { moduleId: 3, key: 'flight_airports', title: 'Airports', url: '/airport', icon: 'content/images/airport.png' },
	{ moduleId: 3, key: 'flight_cities', title: 'Cities', url: '/city', icon: 'content/images/city.png' },
	{ moduleId: 3, key: 'flight_chrs', title: 'Charterers', url: '/chrs', icon: 'content/images/chr.png' },
 ...
 { moduleId: 3, key: 'delays_report', title: 'Delays Report', url: '/delays', icon: 'content/images/actype2.png' },
  { moduleId: 3, key: 'delays_report_flight', title: 'Delays Report', url: '/delays/flight', icon: 'content/images/actype2.png' },
     { moduleId: 3, key: 'atr_forma', title: 'Form A', url: '/forma', icon: 'content/images/forma.png' },
	   { moduleId: 3, key: 'atr_formb', title: 'Form B', url: '/forma', icon: 'content/images/forma.png' },
	     { moduleId: 3, key: 'atr_formc', title: 'Form C', url: '/forma', icon: 'content/images/forma.png' },
      ...
      { moduleId: 3, key: 'atr_citypair', title: 'City-Pair Report', url: '/citypair', icon: 'content/images/citypair.png' },
	   { moduleId: 3, key: 'efb', title: 'EFB Report', url: '/flights/efbs', icon: 'content/images/efb.png' },
	    { moduleId: 3, key: 'chrs', title: 'Charterers', url: '/chrs', icon: 'content/images/chr.png' },
		 { moduleId: 3, key: 'chr_report', title: 'Charterers Report', url: '/chr/report', icon: 'content/images/chr.png' },
