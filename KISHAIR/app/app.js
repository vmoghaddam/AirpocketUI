...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when("/home", {
        ...
        templateUrl: "/app/views/home.html?v="+"7200114"
    });
    $routeProvider.when("/home/:year/:month/:day", {
        controller: "homeController",
        templateUrl: "/app/views/home.html?v=" + "200"
    });

    $routeProvider.when("/login", {
        controller: "loginController",
        templateUrl: "/app/views/login.html?v=10022"
    });
    ...
    $routeProvider.when("/person", {
        ...
        templateUrl: "/app/views/person.html?v=1104"
    });
    $routeProvider.when("/person/crew", {
        controller: "personController",
        templateUrl: "/app/views/person.html?v=1101",
        isCrew:true,
    });
    ...
    $routeProvider.when("/crew/report", {
        ...
        templateUrl: "/app/views/crewReport.html?v=100"
    });
    ...
    $routeProvider.when("/delays/report", {
        ...
        templateUrl: "/app/views/flightDelays.html?v=100"
    });
    ...
    $routeProvider.when("/users", {
        ...
        templateUrl: "/app/views/users.html?v=101"
    });
    ...
    $routeProvider.when("/delays", {
        ...
        templateUrl: "/app/views/delayreport.html?v=1001"
    });
    ...
    $routeProvider.when("/board", {
        ...
        templateUrl: "/app/views/board.html?v=211105871",
        isAdmin: true,
    });
	$routeProvider.when("/flight/board", {
          controller: "boardController",
        templateUrl: "/app/views/board.html?v=21110554",
        isAdmin: true,
    });
	  $routeProvider.when("/flight/board/ceo", {
           controller: "boardController",
        templateUrl: "/app/views/board.html?v=2111054",
        isAdmin: true,
    });
    ...
    $routeProvider.when("/scheduling/admin", {
        ...
        templateUrl: "/app/views/scheduling.html?v=14",
        isAdmin: true,
    });
    $routeProvider.when("/scheduling", {
        controller: "schedulingController",
        templateUrl: "/app/views/scheduling.html?v=163",
        isAdmin: false,
    });
    ...
    $routeProvider.when("/crew/report/fixtime/daily", {
        ...
        templateUrl: "/app/views/fixtimereportdaily.html?v=105"
    });
 ...
 $routeProvider.when("/forms/vacation", {
	...
	$routeProvider.when("/formc", {
        controller: "formcController",
        templateUrl: "/app/views/formc.html?v=20",

    });
	$routeProvider.when("/formb", {
        controller: "formbController",
        templateUrl: "/app/views/formb.html?v=20",
	...
	$routeProvider.when("/chrs", {
	  ...
	  $routeProvider.when("/board/tbl", {
        controller: "boardtblController",
        templateUrl: "/app/views/boardtbl.html?v=1005"
    });
	 $routeProvider.when("/board/tbl/check", {
        controller: "boardtbl2Controller",
        templateUrl: "/app/views/boardtbl2.html?v=100"
    });
	 $routeProvider.when("/report/flight/daily", {
        controller: "reportFlightDailyController",
        templateUrl: "/app/views/reportflightdaily.html?v=101104801"
    });
	 $routeProvider.when("/opones", {
        controller: "oponesController",
        templateUrl: "/app/views/opones.html?v=1000"
    });
...
var pfx="fms";
if (window.location.href.indexOf('fms2') != -1){
	
	pfx="fms2";
}

var serviceBaseAPI ='https://'+pfx+'.'+domain+'/kapi/';//'https://kapi.apvaresh.com/'; 
var serviceBaseTRN = 'https://kapitrn.apoc.ir/';
 
var webBase = 'https://'+pfx+'.'+domain+'/';
var serviceBase ='https://'+pfx+'.'+domain+'/kapinet/';//'https://kainet.apatlas.com/'; 
var serviceBase ='https://'+pfx+'.'+domain+'/kapinet2/'; //'https://kapinet2.airpocket.online/'; 
var apiLock ='https://'+pfx+'.'+domain+'/kapilock/';
var liburl = serviceBase;
var serviceBase2 =  'https://localhost:5001/'; 
  
var signFiles = 'https://fbpocket.ir/upload/signs/';
var gdapi ='https://'+pfx+'.'+domain+'/kapi2/';//'https://kapi2.airpocket.online/'; 
var serviceForms ='https://'+pfx+'.'+domain+'/kapiform/';//'https://kapiform.airpocket.online/'; 
var apiLog ='https://'+pfx+'.'+domain+'/kapilog/';//'https://kapilog.airpocket.online/'; 
var apiDaily='https://'+pfx+'.'+domain+'/kapidaily/';//'https://kapidaily.airpocket.online/';

var apiMSG ='https://'+pfx+'.'+domain+'/kapimsg/';//'https://kapimsg.airpocket.online/'; 
var apiMSGNet ='https://'+pfx+'.'+domain+'/kapinetmsg/';
var apixls ='https://'+pfx+'.'+domain+'/kapixls/';//'https://kapixls.airpocket.online/';
var apixlsmain ='https://'+pfx+'.'+domain+'/kapixlsmain/';//'https://kapixlsmain.airpocket.online/';
var reportServer='https://'+pfx+'.'+domain+'/kreport/frmreportview.aspx';    //'https://kreport.airpocket.online/frmreportview.aspx'; 
var reportServerHttp='http://'+pfx+'.'+domain+'/kreport/frmreportview.aspx';    
var reportFormsServer='https://'+pfx+'.'+domain+'/kreportforms/frmreportview.aspx';  //'https://kreportforms.airpocket.online/frmreportview.aspx';

var apiplanning='https://'+pfx+'.'+domain+'/kapiplanning/';
var apireportflight='https://'+pfx+'.'+domain+'/kapireportflight/';//'https://kapireportflight.airpocket.online/';
var apiCAO='https://'+pfx+'.'+domain+'/kapicao/';
var serviceRequest ='https://'+pfx+'.'+domain+'/kapirequest/';//'https://kapiform.airpocket.online/'; 

var zreportflight='https://'+pfx+'.'+domain+'/zreportflight/'; 
 var zreportflightdelay='https://'+pfx+'.'+domain+'/zreportflightdelay/'; 
 var zapinet ='https://'+pfx+'.'+domain+'/zkpinet/';
...
app.run(['authService', 'activityService', '$rootScope', '$location', '$templateCache', function (authService, activityService, $rootScope, $location, $templateCache) {
    ...
    ////////////////////////////////
    $rootScope.reportServer =reportServer;// "https://localhost:44350/frmreportview.aspx";
	...
	$rootScope.IsDelaysEdit=function(){
		
		 var role = Enumerable.From($rootScope.roles).Where('$=="Delays - Edit"').FirstOrDefault();
        if (role || $rootScope.userName.toLowerCase()=='87740')
            return true;
        return false;
	};
    ...
    $rootScope.HasMenuAccess = function (key, module) {
		...
		if (key=='flight_calendar_cockpit' )
			return $rootScope.userName.toLowerCase().startsWith('cs.') || $rootScope.userName.toLowerCase().startsWith('dis.') || $rootScope.userName.toLowerCase().startsWith('87669')
		 || $rootScope.userName.toLowerCase().startsWith('82817') || $rootScope.userName.toLowerCase().startsWith('86564') || $rootScope.userName.toLowerCase().startsWith('93207')
		|| $rootScope.IsDispatch() 
		|| $rootScope.userName.toLowerCase().startsWith('83402')
		|| $rootScope.userName.toLowerCase().startsWith('403260')
		|| $rootScope.userName.toLowerCase().startsWith('84207')
		| $rootScope.userName.toLowerCase().startsWith('93201')
		//403260
		//84207
	...
	$rootScope.getDatasourceCity = function () {
        return new DevExpress.data.DataSource({
            store:

                new DevExpress.data.ODataStore({
                    url: $rootScope.serviceUrl + 'odata/cities/list',
                    //  key: "Id",
                    // keyType: "Int32",
                    version: 4
                }),
