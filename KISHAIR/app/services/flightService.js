...
app.factory('flightService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var _getFlightsGanttUTC = function (cid, from, to, tzoffset, airport, filter) {
        var url = /*serviceBase*/apiLog + 'odata/flights/gantt/utc/customer/' + cid + '/' + from + '/' + to + '/' + tzoffset;
        if (airport)
            url += '/' + airport;
    ...
    var _saveFlightLog = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl*/ apiLog + 'odata/flight/log/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveJLog = function (entity) {
	 ...
	 var _getLegs = function (dt) {

        var deferred = $q.defer();
        $http.get($rootScope.serviceUrl + 'odata/legs/?dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightsLine = function (id) {
        ...
        var deferred = $q.defer();
        $http.get(zapinet + 'odata/line/flights/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    // odata/roster/fdpitem/delete
     ...
     var _dutiesSendSMS = function (entity) {
         var deferred = $q.defer();
         $http.post(/*$rootScope.serviceUrl*/apiMSGNet + 'odata/duties/sms/save', entity).then(function (response) {
             deferred.resolve(response.data);
         }, function (err, status) {
    ...
    var _sendMVT = function (flightId,username) {
        ...
        var deferred = $q.defer();
        $http.get(apiMSG + 'api/mail/mvt/'+flightId+'/'+username+'/vahid/Chico1359'  ).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	 ...
	 var _sendLDM = function (flightId,username) {

     
        var deferred = $q.defer();
        $http.get(apiMSG + 'api/mail/ldm/'+flightId+'/'+username+'/vahid/Chico1359'  ).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
  ...
  var _getCharterers = function () {
    ...
    serviceFactory.getCharterersReport = _getCharterersReport;
	    ...
	    var _saveCharterer = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceForms + 'api/charterer/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.saveCharterer = _saveCharterer;
	var _deleteCharterer = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceForms + 'api/charterer/delete', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.deleteCharterer = _deleteCharterer;
 ...
 var _getImportFlights = function (fn) {
        ...
        alert('x');
        var deferred = $q.defer();
        $http.get(/*'https://kapi.apoc.ir/'*/'https://fms.kishairlines.ir/kapi/' + 'api/xls/flights3?fn=' +fn).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
 ...
 /////////////////////////
    ...
    serviceFactory.updateATL = _updateATL;
	 ...
	 var _getImportFlights_xxxx = function (fn) {


        var deferred = $q.defer();
        $http.get(/*'https://kapi.apoc.ir/'*/'https://kapi.apvaresh.com/'  + 'api/xls/flights3?fn=' +fn).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
   ...
   var _saveNewReg = function (entity) {
    ...
    serviceFactory.saveNewReg = _saveNewReg;
	   ...
	   var _getFlightDailyReport = function (df, dt, from,to,regs,routes,no,idx,type,chr,status) {


        var deferred = $q.defer();
        $http.get(/*apireportflight*/zreportflight + 'api/flight/daily?df=' + df + '&dt=' + dt + '&from=' + from+'&to='+to+'&regs='+regs+'&routes='+routes+'&no='+no+'&idx='+idx+'&status='+status+'&type2='+type+'&chr='+chr+'&dateref=std').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	//public IHttpActionResult GetDelayedFlight(DateTime df, DateTime dt, string route = "", string regs = "", string types = "", string flts = "", string cats = "", int range = 1)
	 var _getDelayedFlightsReport = function (df, dt, regs,types,flts,route,range) {
        ...
        var deferred = $q.defer();
        $http.get(zreportflightdelay + 'api/flight/delayed?df='+df+'&dt='+dt+'&route='+route+'&regs='+regs+'&cats=&types='+types+'&flts='+flts+'&range='+range).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _getDelayItems = function (flt) {


        var deferred = $q.defer();
        $http.get(apireportflight + 'api/delay/items/'+flt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _getFlightDailyReport = function (df, dt, from,to,regs,routes,no,idx,type,chr,status) {
        ...
        var deferred = $q.defer();
        $http.get(zreportflight + 'api/flight/daily?df=' + df + '&dt=' + dt + '&from=' + from+'&to='+to+'&regs='+regs+'&routes='+routes+'&no='+no+'&idx='+idx+'&status='+status+'&type2='+type+'&chr='+chr+'&dateref=std').then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.getFlightDailyReportFilters = _getFlightDailyReportFilters;
		 ...
		 var _getCityPair = function (y,m,dom ) {


        var deferred = $q.defer();
        $http.get(apireportflight + 'api/citypair/report?year=' + y + '&month=' + m+'&dom=-1' ).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.getCityPair = _getCityPair;
    ...
    var _getAllApts = function ( ) {


        var deferred = $q.defer();
        $http.get($rootScope.serviceUrl + 'odata/airports/all' ).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    serviceFactory.getAllApts = _getAllApts;
	...
	serviceFactory.sendLDM=_sendLDM;
    ...
    serviceFactory.deleteFixTime = _deleteFixTime;
	 ...
	 serviceFactory.getLegs=_getLegs;
