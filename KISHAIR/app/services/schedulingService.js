...
app.factory('schedulingService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
	...
	var _saveFixTimeByDate = function (entity) {
        var deferred = $q.defer();
        $http.post($rootScope.serviceUrl + 'odata/fixtime/date/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	var _saveFixTimeByDate = function (entity) {
        var deferred = $q.defer();
        $http.post(serviceBaseAPI + 'api/fixtime/date/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
	...
	serviceFactory.saveFixTimeByDate=_saveFixTimeByDate;
	
	
	var _setOff = function (df,dt,grp) {
        var deferred = $q.defer();
        $http.get(serviceBaseAPI + "api/set/off?df="+df+"&dt="+dt+"&grp="+grp ).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
