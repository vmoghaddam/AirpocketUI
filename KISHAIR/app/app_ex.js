...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when("/home", {
        ...
        templateUrl: "/app/views/home.html?v="+"7200113"
    });
    ...
    $routeProvider.when("/login", {
        ...
        templateUrl: "/app/views/login.html?v=1002"
    });
    ...
    $routeProvider.when("/person", {
        ...
        templateUrl: "/app/views/person.html?v=1100"
    });
    ...
    $routeProvider.when("/users", {
        ...
        templateUrl: "/app/views/users.html?v=100"
    });
    ...
    $routeProvider.when("/board", {
        ...
        templateUrl: "/app/views/board.html?v=2111055",
        isAdmin: true,
    });
    ...
    $routeProvider.when("/scheduling/admin", {
        ...
        templateUrl: "/app/views/scheduling.html?v=101011w",
        isAdmin: true,
    });
    $routeProvider.when("/scheduling", {
        controller: "schedulingController",
        templateUrl: "/app/views/scheduling.html?v=1010116",
        isAdmin: false,
    });
 ...
 $routeProvider.when("/forms/vacation", {
	...
	$routeProvider.when("/chrs", {
	  ...
	  $routeProvider.when("/board/tbl", {
        ...
        templateUrl: "/app/views/boardtbl.html?v=1002"
    });
	 ...
	 $routeProvider.when("/report/flight/daily", {
        ...
        templateUrl: "/app/views/reportflightdaily.html?v=101104800"
    });
...
//} 
//var serviceBase = 'http://fleet.caspianairlines.com/api/';
var serviceBaseAPI ='https://kapi.apvaresh.com/';// 'https://kapi.apatlas.com/';//'https://kapi.apvaresh.com/';
var serviceBaseTRN = 'https://kapitrn.apoc.ir/';
//var webBase = 'http://localhost:30000/';
//var serviceBase =  'http://localhost:58908/';
var webBase = 'https://fms.kishair.aero/';
var serviceBase ='https://kainet.apatlas.com/';// 'https://kapinet.apvaresh.com/';
var serviceBase = 'https://kapinet2.airpocket.online/';//'https://kapinet2.apoc.ir/';// 'https://kapinet2.apatlas.com/';//'https://kpinet2.apvaresh.com/';
...
var gdapi ='https://kapi2.airpocket.online/';//'https://kapi2.apatlas.com/';// 'https://kapi2.apvaresh.com/';
var serviceForms ='https://kapiform.airpocket.online/';// 'https://kapiform.apvaresh.com/'; 
var apiLog ='https://kapilog.airpocket.online/';//'https://kapilog.apatlas.com/';// 'https://kapilog.apvaresh.com/';
var apiDaily='https://kapidaily.airpocket.online/';

var apiMSG ='https://kapimsg.airpocket.online/';// 'https://kapimsg.apvaresh.com/';
var apixls ='https://kapixls.airpocket.online/';
var apixlsmain ='https://kapixlsmain.airpocket.online/';
var reportServer='https://kreport.airpocket.online/frmreportview.aspx';//'https://kreport.apvaresh.com/frmreportview.aspx';
var reportFormsServer='https://kreportforms.airpocket.online/frmreportview.aspx';

var apiplanning='https://kapiplanning.airpocket.online/';
var apireportflight='https://kapireportflight.airpocket.online/';
...
app.run(['authService', 'activityService', '$rootScope', '$location', '$templateCache', function (authService, activityService, $rootScope, $location, $templateCache) {
    ...
    $rootScope.HasMenuAccess = function (key, module) {
		...
		if (key=='flight_calendar_cockpit' )
			return $rootScope.userName.toLowerCase().startsWith('cs.') || $rootScope.userName.toLowerCase().startsWith('dis.')
