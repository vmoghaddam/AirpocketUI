'use strict';
app.controller('boardtblController', ['$scope', '$location', '$routeParams', '$rootScope', '$timeout', 'flightService', 'weatherService', 'aircraftService', 'authService', 'notificationService', '$route', '$window', 'fbService', '$http', '$q', function ($scope, $location, $routeParams, $rootScope, $timeout, flightService, weatherService, aircraftService, authService, notificationService, $route, $window, fbService, $http, $q) {
    ...
    $scope.IsNoCrewVisible = $rootScope.userName.toLowerCase().startsWith('dis.') 
	|| $rootScope.userName.toLowerCase().startsWith('demo') 
	|| $rootScope.userName.toLowerCase().startsWith('razbani')
	|| $rootScope.userName.toLowerCase().startsWith('87645')
	|| $rootScope.IsDispatch();
    ...
    $scope.IsAdmin = true;
    $scope.IsDelaysEditX=$rootScope.IsDelaysEdit;
    ...
    $scope.popup_date = {
        title: 'Persian Date',
        shading: true,
        //position: { my: 'left', at: 'left', of: window, offset: '50' },
        height: 150,
        width: 300,
        fullScreen: false,
        showTitle: true,
            ...
            pd1 = $(".date1").pDatepicker({
                ...
                onSelect: function (unix) {
                    $scope.$apply(function () {
                        ...
                        $scope._datefrom = new Date(unix);
                    });

                },

            });
            pd1.setDate(new Date($scope._datefrom.getTime()));
    ...
    $scope.calculateTotalDelay = function () {
        ...
        var d2 = new Date($scope.logFlight.Takeoff);
        if (d1 > d2) {
    ...
    $scope.cl_checkin_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLCheckIn', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
    ...
    $scope.cl_park_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLPark', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLCheckIn) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLPark), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_add_tools_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLAddTools', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLAddTools) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLAddTools), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_bus_ready_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLBusReady', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLBusReady) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLBusReady), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_pax_out_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLPaxOut', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLPaxOut) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLPaxOut), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_depo_out_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLDepoOut', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLDepoOut) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLDepoOut), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_service_presence_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLServicePresence', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLServicePresence) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLServicePresence), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_cleaning_start_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLCleaningStart', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLCleaningStart) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLCleaningStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_tech_ready_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLTechReady', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLTechReady) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLTechReady), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_bag_sent_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLBagSent', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLBagSent) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLBagSent), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_catering_load_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLCateringLoad', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLCateringLoad) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLCateringLoad), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_fuel_start_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLFuelStart', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLFuelStart) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLFuelStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_fuel_end_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLFuelEnd', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLFuelEnd) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLFuelEnd), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_cleaning_end_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLCleaningEnd', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLCleaningEnd) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLCleaningEnd), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_boarding_start_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLBoardingStart', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLBoardingStart) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLBoardingStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_boarding_end_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLBoardingEnd', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLBoardingEnd) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLBoardingEnd), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_loadsheet_start_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLLoadSheetStart', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLLoadSheetStart) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLLoadSheetStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_gate_closed = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLGateClosed', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLGateClosed) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLGateClosed), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_traffic_crew_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLTrafficCrew', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLTrafficCrew) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLTrafficCrew), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_load_crew_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLLoadCrew', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLLoadCrew) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLLoadCrew), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_forbidden_obj_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLForbiddenObj', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLForbiddenObj) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLForbiddenObj), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_loadsheet_sign_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLLoadSheetSign', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLLoadSheetSign) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLLoadSheetSign), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_loading_end_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLLoadingEnd', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLLoadingEnd) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLLoadingEnd), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_door_closed_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLDoorClosed', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLDoorClosed) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLDoorClosed), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_eq_dc_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLEqDC', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLEqDC) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLEqDC), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_motor_start_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLMotorStart', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLMotorStart) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLMotorStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_moving_starrt_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLMovingStart', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLMovingStart) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLMovingStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_gpu_start_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLGPUStart', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLGPUStart) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLGPUStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_gpu_end_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLGPUEnd', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLGPUEnd) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLGPUEnd), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_ac_start_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLACStart', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLACStart) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLACStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_ac_end_hh = {
        type: "time", width: "auto", displayFormat: "HHmm", interval: 15, showClearButton: true, rtlEnabled: true, bindingOptions: { value: 'logFlight.CLACEnd', pickerType: 'cl_pickertype' },
        onValueChanged: function (arg) {
            if ($scope.logFlight.CLACEnd) {
                var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLACEnd), new Date($scope.logFlight.STD2));
    ...
    $scope.checkDepStairs = {
        items: equipmentsSelectBox, placeholder: 'انتخاب کنید', showClearButton: true, datasource: equipmentsSelectBox, displayExpr: 'Status', valueExpr: 'ID',
    ...
    $scope.fillLog = function (entity) {
		...
		var nFrom = 0;
		var nTo = 0;
		nFrom = (['EVN'].indexOf( $scope.logFlight.FromAirportIATA)!=-1) ? -30 : 0;
		nTo = (['EVN'].indexOf( $scope.logFlight.ToAirportIATA)!=-1) ? -30 : 0;
		
        if ($scope.logFlight.ChocksOut)
            entity.ChocksOut = ((new Date($scope.logFlight.ChocksOut)).addMinutes(nFrom)).toUTCString();

        if ($scope.logFlight.Takeoff)
            entity.Takeoff = ((new Date($scope.logFlight.Takeoff)).addMinutes(nFrom)).toUTCString();
        //landing
        if ($scope.logFlight.Landing)
            entity.Landing = ((new Date($scope.logFlight.Landing)).addMinutes(nTo)).toUTCString();
        if ($scope.logFlight.ChocksIn)
            entity.ChocksIn = ((new Date($scope.logFlight.ChocksIn)).addMinutes(nTo)).toUTCString();
    ...
    $scope.dep_ready = {
		...
		width: '100%',
		interval: 5, onValueChanged: function (arg) { }, bindingOptions: {
            value: 'logFlight.Ready',
    ...
    $scope.dep_ready_hh = {
        ...
        width: '100%',
        displayFormat: "HHmm",
        interval: 15, onValueChanged: function (arg) { },
 ...
 $scope.calculateTotalDelay();
                ...
                widget: 'dxButton', location: 'after', options: {
                    type: 'success', text: 'Save', icon: 'check', validationGroup: 'deplog', bindingOptions: { disabled: 'IsApproved' }, onClick: function (arg) {
                        ...
                        flightService.getFlightGUID($scope.logFlight.ID).then(function (response) {
                            ...
                            if ($rootScope.EditWindow) {
								if ((Date.now() - new Date($scope.logFlight.ChocksOut).getTime()) / 3600000 > $rootScope.EditWindow) {
                                General.ShowNotify('You don\'t have permission to edit this flight. Ask admin to extend your edit window.', 'error');
                                return;
								}
    ...
    $scope.dg_delay_columns = [
        {
            caption: 'Delay', columns: [
                ...
                { dataField: 'Remark', caption: 'Remark', allowResizing: true, dataType: 'string', allowEditing: true, },
    ...
    $scope.dg_delay = {
		...
		onRowUpdating: function (e) {
            if (e.newData.Amount != null) {
                if (/^([0-9]+):[0-5]?[0-9]$/.test(e.newData.Amount)) {
                    e.key.HH = parseInt(e.newData.Amount.split(":")[0]);
                    e.key.MM = parseInt(e.newData.Amount.split(":")[1]);
                    e.key.Total = e.key.HH * 60 + e.key.MM;
                }
            }
        },
        onSelectionChanged: function (e) {
    ...
    $scope.dg_chistory = {
        ...
        columnAutoWidth: false,
        height: $(window).width() >= 1200 ? 600 : $(window).height() - 230,
    ...
    $scope.popup_history = {
        shading: true,
        width: $(window).width() >= 1200 ? 1100 : $(window).width() - 50,
        height: $(window).width() >= 1200 ? 730 : $(window).height() - 100,
        fullScreen: false,
        showTitle: true,
        dragEnabled: true,
        toolbarItems: [
   ...
   $scope._calculateDelay = function (flt) {
		flt.Delay=0;
		if (flt.STD.getTime()<flt.Takeoff.getTime())
          flt.Delay = Math.abs(flt.STD.getTime() - flt.Takeoff.getTime()) * 60 / 3600000;
    };
    ...
    $scope.modifyFlightTimes = function (flt, utc) {
		...
		var nFrom = 0;
		var nTo = 0;
		nFrom = (['EVN'].indexOf( flt.FromAirportIATA)!=-1) ? +30 : 0;
		nTo = (['EVN'].indexOf( flt.ToAirportIATA)!=-1) ? +30 : 0;

        flt.ChocksOut = getOffsetDate(flt.ChocksOut, m, nFrom);
        flt.ChocksIn = getOffsetDate(flt.ChocksIn, m, nTo);
        flt.Takeoff = getOffsetDate(flt.Takeoff, m, nFrom);
        flt.Landing = getOffsetDate(flt.Landing, m, nTo);
        flt.STA = getOffsetDate(flt.STA, m, nTo);
        flt.STD = getOffsetDate(flt.STD, m, nFrom);


        flt.STA2 = getOffsetDate(flt.STA2, m, nTo);
        flt.STD2 = getOffsetDate(flt.STD2, m, nFrom);
        ...
        $scope._calculateDelay(flt);

        $scope.dg_board_instance.repaint();

    };
	
	$scope.user_station ='All';
$scope.ds_station=['All'];
    $scope.sb_station = {
        width:90,
        showClearButton: false,
        searchEnabled: false,
        ...
        onValueChanged: function (e) {
		   ...
		   $scope.setSTNOrder();
		   $scope.dg_board_instance.refresh();
	...
	$scope.user_sort ='STD';
    $scope.ds_sort=['STD','READY','START','STATUS','REG','REG/STD','AC/REG/STD','DEP STN','ARR STN','FLT NO','PAX','OFFBLOCK','TAKEOFF','LANDING','ONBLOCK','STA','DEP/STD','ARR/STA'];
    $scope.sb_sort = {
        width:150,
        showClearButton: false,
        searchEnabled: false,
        ...
        onValueChanged: function (e) {
		  ...
		  // $scope.setSTNOrder();
		   //$scope.dg_board_instance.refresh();
		   $scope.dg_board_instance.columnOption("STD", "sortIndex", undefined);
		   $scope.dg_board_instance.columnOption("STD", "sortOrder", undefined);
		   
		   $scope.dg_board_instance.columnOption("progress", "sortIndex", undefined);
		   $scope.dg_board_instance.columnOption("progress", "sortOrder", undefined);
		   
		   $scope.dg_board_instance.columnOption("STA", "sortIndex", undefined);
		   $scope.dg_board_instance.columnOption("STA", "sortOrder", undefined);
		   
		   $scope.dg_board_instance.columnOption("Ready", "sortIndex", undefined);
		   $scope.dg_board_instance.columnOption("Ready", "sortOrder", undefined);
		   
		   $scope.dg_board_instance.columnOption("Start", "sortIndex", undefined);
		    $scope.dg_board_instance.columnOption("Start", "sortOrder", undefined);
			
		   $scope.dg_board_instance.columnOption("FromContry", "sortIndex", undefined);
		   $scope.dg_board_instance.columnOption("FromSortName", "sortIndex", undefined);
		    $scope.dg_board_instance.columnOption("FromAirportIATA", "sortIndex", undefined);
			$scope.dg_board_instance.columnOption("ToAirportIATA", "sortIndex", undefined);
			$scope.dg_board_instance.columnOption("FlightNumber", "sortIndex", undefined);
			$scope.dg_board_instance.columnOption("TotalPax", "sortIndex", undefined);
			$scope.dg_board_instance.columnOption("ChocksIn", "sortIndex", undefined);
			$scope.dg_board_instance.columnOption("ChocksOut", "sortIndex", undefined);
			$scope.dg_board_instance.columnOption("Takeoff", "sortIndex", undefined);
			$scope.dg_board_instance.columnOption("Landing", "sortIndex", undefined);
			
			
			$scope.dg_board_instance.columnOption("FromContry", "sortOrder", undefined);
		   $scope.dg_board_instance.columnOption("FromSortName", "sortOrder", undefined);
		    $scope.dg_board_instance.columnOption("FromAirportIATA", "sortOrder", undefined);
			$scope.dg_board_instance.columnOption("ToAirportIATA", "sortOrder", undefined);
			$scope.dg_board_instance.columnOption("FlightNumber", "sortOrder", undefined);
			$scope.dg_board_instance.columnOption("TotalPax", "sortOrder", undefined);
			$scope.dg_board_instance.columnOption("ChocksIn", "sortOrder", undefined);
			$scope.dg_board_instance.columnOption("ChocksOut", "sortOrder", undefined);
			$scope.dg_board_instance.columnOption("Takeoff", "sortOrder", undefined);
			$scope.dg_board_instance.columnOption("Landing", "sortOrder", undefined);
			
		    if (e.value == 'STD'){
				$scope.dg_board_instance.columnOption('STD', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			 ...
			 if (e.value == 'STATUS'){
				$scope.dg_board_instance.columnOption('progress', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			...
			if (e.value == 'STA'){
				$scope.dg_board_instance.columnOption('STA', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			 ...
			 if (e.value == 'READY'){
				$scope.dg_board_instance.columnOption('Ready', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			...
			if (e.value == 'START'){
				$scope.dg_board_instance.columnOption('Start', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
		    ...
		    if (e.value == 'OFFBLOCK'){
				$scope.dg_board_instance.columnOption('ChocksOut', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			...
			if (e.value == 'ONBLOCK'){
				$scope.dg_board_instance.columnOption('ChocksIn', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			...
			if (e.value == 'TAKEOFF'){
				$scope.dg_board_instance.columnOption('Takeoff', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			...
			if (e.value == 'LANDING'){
				$scope.dg_board_instance.columnOption('Landing', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
            ...
            if (e.value == 'FLT NO'){
				$scope.dg_board_instance.columnOption('FlightNumber', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			 ...
			 if (e.value == 'PAX'){
				$scope.dg_board_instance.columnOption('TotalPax', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			 ...
			 if (e.value == 'REG'){
				$scope.dg_board_instance.columnOption('FromSortName', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			 ...
			 if (e.value == 'DEP STN'){
				$scope.dg_board_instance.columnOption('FromAirportIATA', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			...
			if (e.value == 'ARR STN'){
				$scope.dg_board_instance.columnOption('ToAirportIATA', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                }); 
			...
			//$scope.ds_sort=['STD','READY','START','REG','REG/STD','AC/REG/STD','DEP. STN','ARR STN','FLT NO','PAX','OFFBLOCK','TAKEOFF','LANDING','ONBLOCK',];
			 if (e.value == 'AC/REG/STD'){
				 $scope.dg_board_instance.columnOption('FromContry', {  
                    sortOrder: 'asc',  
                    sortIndex: 1  
                });
				$scope.dg_board_instance.columnOption('FromSortName', {  
	...
	$scope.setSTNOrder=function(){
		// _d.STN=0;
		$.each($scope.ganttData.flights,function(_i,_d){
			
			if ($scope.user_station =='All')
				_d.STN=0;
			else
			{
				_d.STN=2;
				if (_d.FromAirportIATA==$scope.user_station)
					_d.STN=0;
				else if (_d.ToAirportIATA==$scope.user_station)
					_d.STN=1;
			}
		});
	};
    ...
    $scope.bindFlights = function (callback) {
        ...
        flightService.getFlightsGanttUTC(Config.CustomerId, (new Date($scope.datefrom)).toUTCDateTimeDigits(), ed, /*offset*/0, null, 1, filter).then(function (response) {
            try {
				...
				var tdydt=Number(moment(new Date($scope.datefrom)).format('YYYYMMDD'));
				
				var _nflts=[]; 
				$.each(response.flights,function(_i,_d){ 
				   _tstns.push(_d.FromAirportIATA);
				   _tstns.push(_d.ToAirportIATA);
				   _d.STN=0;
				   if (Number(moment((new Date(_d.STD)).addMinutes(offset)).format('YYYYMMDD'))==tdydt) {
						//if (Number(moment(new Date(_d.Date)).format('YYYYMMDD'))!=tdydt)
						//if (Number(moment(new Date(_d.STD).addMinutes(offset)).format('YYYYMMDD')) != Number(moment(new Date(_d.ChocksOut).addMinutes(offset)).format('YYYYMMDD')))
						//	_d.FlightNumber	+= "A";
						_nflts.push(_d);
				   }
				});
				$scope.ds_station=Enumerable.From(_tstns).Distinct().OrderBy('$').ToArray();
				$scope.ds_station.unshift('All');
				
				//console.log('TABLE FLIGHTS',_nflts);
				 response.flights=Enumerable.From(_nflts).ToArray();
...
console.log(2);
    ...
    $scope.search = function () {
        ...
        $scope.bindFlights(function () {
			var $dayBar = $('.footer-date');
            $dayBar.empty();
            //var persianDateFrom = new persianDate($scope._datefrom).format('ddd YYYY/MM/DD');
			var persianDateFrom = new Date($scope._datefrom).toLocaleDateString('fa-IR-u-nu-latn', { weekday: 'long', year: 'numeric', month: '2-digit', day: 'numeric'});
            $dayBar.append(persianDateFrom);
			
            if (moment(new Date()).format('YYYY-MM-DD') == moment(new Date($scope._datefrom)).format('YYYY-MM-DD')) {
                $scope.autoUpdate = true;
                $scope.StartUTimer();
    ...
    $scope.popup_chr = {
        shading: true,
        width: $(window).width() >= 1440 ? 1400 : $(window).width() - 50,
        height: $(window).height() - 100, //function () { return $(window).height() * 0.8 },
        fullScreen: false,
        showTitle: true,
        dragEnabled: true,
        toolbarItems: [
...

            {
                widget: 'dxButton', location: 'after', options: {
                    type: 'success', text: 'Download', icon: 'save', onClick: function (e) {
                        ...
                        //$window.open('https://kapixls.airpocket.online/' + 'api/xls/' + '?dt1=' + moment(new Date($scope.datefrom)).format('YYYY-MM-DD') + '&dt2=' + moment(new Date($scope.dateEnd)).format('YYYY-MM-DD') + "&chr=" + $scope.tt_chr + "&crew=" + $scope.tt_crew + "&cnl=" + $scope.tt_cnl + "&sort=" + $scope.tt_sort + "&time=" + $scope.tt_time+ "&sep=" + ($scope.tt_sepdate?1:0), '_blank');
						$window.open('https://fms.kishair.aero/kapixls/' + 'api/xls/' + '?dt1=' + moment(new Date($scope.datefrom)).format('YYYY-MM-DD') + '&dt2=' + moment(new Date($scope.dateEnd)).format('YYYY-MM-DD') + "&chr=" + $scope.tt_chr + "&crew=" + $scope.tt_crew + "&cnl=" + $scope.tt_cnl + "&sort=" + $scope.tt_sort + "&time=" + $scope.tt_time+ "&sep=" + ($scope.tt_sepdate?1:0), '_blank');
                    }
                }, toolbar: 'bottom'
            },
    ...
    $scope.popup_clgd = {
        shading: true,
        width: $(window).width() >= 1024 ? 820 : $(window).width() - 50,
        height: 300,
        fullScreen: false,
        showTitle: true,
        dragEnabled: true,
        toolbarItems: [
            ...
            {
                widget: 'dxButton', location: 'after', options: {
                    type: 'default', text: 'Crew List', icon: '', bindingOptions: { disabled: 'IsApproved' }, onClick: function (arg) {
            ...
            {
                widget: 'dxButton', location: 'after', options: {
                    type: 'default', text: 'GD', icon: '', bindingOptions: { disabled: 'IsApproved' }, onClick: function (arg) {
            ...
            {
                widget: 'dxButton', location: 'after', options: {
                    type: 'danger', icon: 'remove', onClick: function (e) {
                        $scope.popup_clnew_visible = false;
                        $scope.popup_clgd_visible = false;
                    }
                }, toolbar: 'bottom'
    ...
    $scope.tabs_ln = [
        ...
        { text: "Crew", id: 'dep_crew' },
        { text: "Park/Diversion/QRF", id: 'dep_diversion' },
    ...
    $scope.scroll_lognew_height = !$scope.popup_lognew_full ? $scope.lognew_height - 230 : $(window).height() - 230;
    ...
    $scope.popup_lognew = {
        ...
        toolbarItems: [
            {
                widget: 'dxButton', location: 'before', options: {
                    type: 'default', text: $(window).width() <= 800 ? '' : 'J-Log', icon: $(window).width() <= 800 ? 'card' : '', onClick: function (e) {
            ...
            {
                widget: 'dxButton', location: 'before', options: {
                    type: 'default', text: $(window).width() <= 800 ? '' : 'Crew List/GD', icon: $(window).width() <= 800 ? 'menu' : '', onClick: function (e) {
            ...
            {
                widget: 'dxButton', location: 'before', options: {
                    type: 'default', text: $(window).width() <= 800 ? '' : 'Charterer', icon: $(window).width() <= 800 ? 'money' : '', onClick: function (e) {
                        $scope.popup_chr_visible = true;
                    }
                }, toolbar: 'bottom'
            },
			{
                widget: 'dxButton', location: 'before', options: {
                    type: 'default', text: $(window).width() <= 800 ? '' : 'Sec Dep', icon: $(window).width() <= 800 ? 'fas fa-plane-departure' : '',   onClick: function (e) {

                    $window.open(apixls+'api/xls/security/dep?id='+ $scope.logFlight.ID, '_blank');
                        
                    }, onContentReady: function (e) {
                        e.element[0].id = "small_font_size1";
                    },
                }, toolbar: 'bottom'
            },
			 {
                widget: 'dxButton', location: 'before', options: {
                     type: 'default', text: $(window).width() <= 800 ? '' : 'Sec Arr', icon: $(window).width() <= 800 ? 'fas fa-plane-arrival' : '',   onClick: function (e) {

                    $window.open(apixls+'api/xls/security/arr?id='+ $scope.logFlight.ID, '_blank');
                        
                     }, onContentReady: function (e) {
                         e.element[0].id = "small_font_size2";
                     },
                }, toolbar: 'bottom'
            },
			{
                widget: 'dxButton', location: 'before', options: {
                    type: 'default', text: $(window).width() <= 800 ? '' : 'History', icon: $(window).width() <= 800 ? 'fa fa-history' : '', bindingOptions: { disabled: 'IsApproved' }, visible: true, onClick: function (arg) {
            ...
            {
                widget: 'dxButton', location: 'after', options: {
                    type: 'success', text: $(window).width() <= 800 ? '' : 'Save', icon: $(window).width() <= 800 ? 'check' : '', validationGroup: 'deplog', bindingOptions: { disabled: 'IsApproved' }, onClick: function (arg) {
                        //2020-11-22
                        flightService.getFlightGUID($scope.logFlight.ID).then(function (response) {
        ...
        onShowing: function (e) {
			var $farsiFlightDate = $('.lognew-flight-date');
            $farsiFlightDate.empty();
            var persianFlightDate = new Date($scope.logFlight.STD).toLocaleDateString('fa-IR-u-nu-latn', { weekday: 'long', year: 'numeric', month: '2-digit', day: 'numeric' });
            $farsiFlightDate.append(persianFlightDate);
            $scope.selectedTabLNIndex = -1;
            $scope.depReadOnly = false;
    ...
    $scope.dg_board_columns = [
        {
            cellTemplate: function (container, options) {
                $("<div style='text-align:center'/>")
                    ...
                    .appendTo(container);
            }, name: 'row', caption: '#', width: 50, fixed: false, fixedPosition: 'left', allowResizing: false, cssClass: 'rowHeader'
        },
		//{ dataField: 'Manufacturer', caption: 'Date', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 110, fixed: false, fixedPosition: 'left', fixed: false, fixedPosition: 'left' },
        { dataField: 'STN', caption: 'STN',visible:false, allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 50,  sortIndex: 0, sortOrder: 'asc' },

        { dataField: 'FlightNumber', caption: 'Flt No', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80, fixed: false, fixedPosition: 'left', fixed: false, fixedPosition: 'left' },
        //{ dataField: 'FromContry', caption: 'AC', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 70,  },
		{ dataField: 'FromSortName', caption: 'Reg', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80,  },
        { dataField: 'FromAirportIATA', caption: 'From', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80 },
        { dataField: 'ToAirportIATA', caption: 'To', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80 },

        { dataField: 'STD', caption: 'STD', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 80, format: 'HH:mm', sortIndex: 1, sortOrder: 'asc' },
        ...
        { dataField: 'TotalPax', caption: 'Pax', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 80, },
        { dataField: 'Delay', caption: 'Delay', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 80, },
        
        { dataField: 'FlightStatus', caption: 'Status', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80, fixed: true, fixedPosition: 'right' },
		 { dataField: 'progress', caption: 'progress',visible:false, allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 90, fixed: true, fixedPosition: 'right' },
        { dataField: 'LinkedFlightNumber', caption: '', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, minWidth: 110, fixed: true, fixedPosition: 'right'},
    ...
    $scope.dg_board = {
        ...
        onCellPrepared(e) {
			...
			if (e.rowType === "data" && e.column.dataField == "Start" && !e.data.IsStart)
                e.cellElement.html("");
			
			if (e.rowType === "data" && e.column.dataField == "Ready" && !e.data.IsReady)
                e.cellElement.html("");
			
			if (e.rowType === "data" && e.column.dataField == "ChocksOut" && !e.data.IsOffBlock)
                e.cellElement.html("");
			if (e.rowType === "data" && e.column.dataField == "Takeoff" && !e.data.IsTakeOff)
                e.cellElement.html("");
			
			if (e.rowType === "data" && e.column.dataField == "Landing" && !e.data.IsLanding)
                e.cellElement.html("");
            if (e.rowType === "data" && e.column.dataField == "ChocksIn" && !e.data.IsOnBlock)
                e.cellElement.html("");


        },
        onRowPrepared: function (e) {
            if (e.rowType === "data" && e.data && e.data.FlightStatusID == 4) {
                e.rowElement.css('background', '#ff8566');

            } else
                if (e.rowType === "data" && e.data && e.data.Delay <= 15 && (e.data.FlightStatusID == 2 || e.data.FlightStatusID == 3 || e.data.FlightStatusID == 15)) {
                    e.rowElement.css('background', '#66ff66');

                } else
                    if (e.rowType === "data" && e.data && e.data.FlightStatusID == 7) {
                        e.rowElement.css('background', '#ffff66');

                    }
                    else if (e.rowType === "data" && e.data && e.data.FlightStatusID == 5) {
                        e.rowElement.css('background', '#ffff66');

                    }
                    else
                        if (e.rowType === "data" && e.data && e.data.Delay >= 15) {
                            e.rowElement.css('background', '#ff99ff');

                        }
                        else
                            if (e.rowType === "data" && e.data && e.data.FlightStatusID == 27) {
                                e.rowElement.css('background', '#ffff66');
        ...
        bindingOptions: {
            dataSource: 'ganttData.flights', //'dg_employees_ds',
            //visible: 'gridview'
        }
    };
    ///////////////////////
    ...
    $scope.$on('$viewContentLoaded', function () {
		...
		flightService.getAllApts().then(function (response) {
             //console.log('APTS',response);
			 $scope._all_apts=response;
