app.controller('crewassignregController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route) {
    try {
        ...
        $scope.bindFlights = function (saveState) {
            ...
            flightService.getPlanItemsGanttCrewAssignReg($scope.plansDto).then(function (response) {
                $scope.loadingVisible = false;
        ...
        $scope.positions = [
            ...
            { title: 'CCM', ds: ['FA'] },
             { title: 'SCCM', ds: ['Purser', 'FA'] },
              { title: 'SCCM(i)', ds: ['ISCCM', 'Purser', 'FA'] },
                { title: 'ISCCM', ds: ['ISCCM', 'Purser', 'FA'] },
        ];
        $scope.positionIds = [
        ...
        $scope.$on('$viewContentLoaded', function () {
            ...
            $('.crewassignreg').fadeIn(400, function () {
            });
