'use strict';
app.controller('kpiRPKRegController', ['$scope', '$location', 'personService', 'authService', 'biService', '$routeParams', '$rootScope', function ($scope, $location, personService, authService, biService, $routeParams, $rootScope) {
    $scope.fieldName = '';
    $scope.indexName = '';
    $scope.ds_month = [
    ...
    $scope.selectType = function (t, name) {
        ...
        $scope.dg_monthly2_ds = Enumerable.From($scope.total.items)
            .Where(function (x) { return oyears.indexOf(Number(x.Year)) != -1 && $scope.selectedTypes.indexOf(x.RegisterID) != -1; })
            .OrderBy('Number($.Year)')
            .ThenBy('Number($.Month)')
            .ThenBy('$.Register')
            .ToArray();
        ...
        $scope.dg_daily2_ds = Enumerable.From($scope.ds_daily.items)
            .Where(function (x) { return oyears.indexOf(Number(x.Year)) != -1 && smsids.indexOf(Number(x.Month)) != -1 && $scope.selectedTypes.indexOf(x.RegisterID) != -1; })
            .OrderBy('Number($.Year)')
            .ThenBy('Number($.Month)')
            .ThenBy('Number($.Day)')
            .ThenBy('$.Register')
    ...
    $scope.rebuild = function () {
        ...
        $.each(/*newMainSeries*/$scope.years, function (_i, _d) {
            $.each($scope.grouped, function (_j, _t) {
                console.log(_t.RegisterID + '    ' + $scope.selectedTypes.indexOf(Number(_t.RegisterID)));
                var rpkSeries = {
                    year: _d,
                    valueField: 'UsedPerPaxKiloDistanceKM' + '_' + _d + '_' + _t.RegisterID,
                    name: 'RPK ' + _t.Register + ' (' + _d + ')',
                    showInLegend: true,
                ...
                var askSeries = {
                    year: _d,
                    valueField: 'UsedPerSeatKiloDistanceKM' + '_' + _d + '_' + _t.RegisterID,
                    name: 'ASK ' + _t.Register + ' (' + _d + ')',
                    showInLegend: true,
                    dashStyle: 'dot',
                ...
                var ftkSeries = {
                    year: _d,
                    valueField: 'UsedPerWeightToneDistance' + '_' + _d + '_' + _t.RegisterID,
                    name: 'FTK ' + _t.Register + ' (' + _d + ')',
                    showInLegend: true,
                    color: $rootScope.getColorFromSet2(c),
                    visible: $scope.selectedTypes.indexOf(_t.RegisterID) != -1,
                };
                var ftbSeries = {
                    year: _d,
                    valueField: 'UsedPerWeightToneBlockTime' + '_' + _d + '_' + _t.RegisterID,
                    name: 'FTB ' + _t.Register + ' (' + _d + ')',
                    showInLegend: true,
                    color: $rootScope.getColorFromSet2(c),
                    visible: $scope.selectedTypes.indexOf(_t.RegisterID) != -1,
                };
                var fblSeries = {
                    year: _d,
                    valueField: 'UsedPerBlockTime' + '_' + _d + '_' + _t.RegisterID,
                    name: 'FBL ' + _t.Register + ' (' + _d + ')',
                    showInLegend: true,
                    color: $rootScope.getColorFromSet2(c),
                    visible: $scope.selectedTypes.indexOf(_t.RegisterID) != -1,
                };
                var fcSeries = {
                    year: _d,
                    valueField: 'UsedPerLeg' + '_' + _d + '_' + _t.RegisterID,
                    name: 'FC ' + _t.Register + ' (' + _d + ')',
                    showInLegend: true,
                    color: $rootScope.getColorFromSet2(c),
                    visible: $scope.selectedTypes.indexOf(_t.RegisterID) != -1,
                };
                ...
                var paxSeries = {
                    year: _d,
                    name: 'Pax ' + _t.Register + ' (' + _d + ')', pane: "pax", type: 'bar', valueField: 'TotalPax' + '_' + _d + '_' + _t.RegisterID,
                    color: $rootScope.getColorFromSet2(c), showInLegend: false,
                    visible: $scope.selectedTypes.indexOf(_t.RegisterID) != -1,
                };
                var weightSeries = {
                    year: _d,
                    name: 'Weight ' + _t.Register + ' (' + _d + ')', pane: "weight", type: 'bar', valueField: 'WeightTone' + '_' + _d + '_' + _t.RegisterID,
                    color: $rootScope.getColorFromSet2(c), showInLegend: false,
                    visible: $scope.selectedTypes.indexOf(_t.RegisterID) != -1,
                };
                var usedSeries = {
                    year: _d,
                    name: 'Used ' + _t.Register + ' (' + _d + ')', pane: "used", type: 'bar', valueField: 'UsedKilo' + '_' + _d + '_' + _t.RegisterID,
                    color: $rootScope.getColorFromSet2(c), showInLegend: false,
                    visible: $scope.selectedTypes.indexOf(_t.RegisterID) != -1,
                };
                var disSeries = {
                    year: _d,
                    name: 'Distance ' + _t.Register + ' (' + _d + ')', pane: "dis", type: 'bar', valueField: 'DistanceKM' + '_' + _d + '_' + _t.RegisterID,
                    visible: $scope.selectedTypes.indexOf(_t.RegisterID) != -1,
                    color: $rootScope.getColorFromSet2(c), showInLegend: false,
                };
                var legSeries = {
                    year: _d,
                    name: 'Cycles ' + _t.Register + ' (' + _d + ')', pane: "legs", type: 'bar', valueField: 'Legs' + '_' + _d + '_' + _t.RegisterID,
                    visible: $scope.selectedTypes.indexOf(_t.RegisterID) != -1,
                    color: $rootScope.getColorFromSet2(c), showInLegend: false,
                };
                var blSeries = {
                    year: _d,
                    name: 'BlockTime ' + _t.Register + ' (' + _d + ')', pane: "bl", type: 'bar', valueField: 'BlockTime' + '_' + _d + '_' + _t.RegisterID,
                    visible: $scope.selectedTypes.indexOf(_t.RegisterID) != -1,
                    color: $rootScope.getColorFromSet2(c), showInLegend: false,
                };
    ...
    */
    ...
    $scope.year = null;
    $scope.grouped = null;
    $scope.$on('InitkpiRPKReg', function (event, prms) {
        $scope.selectedTypes = [];
        $scope.prms = null;
        $scope.total = null;
        $scope.month = null;
        ...
        $scope.selectedTypes.push(Number(prms.type.RegisterID));
