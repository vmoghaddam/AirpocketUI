...
//$window.open('#!/citypair/yearly/', '_blank');
    ...
    var pd1 = null;
    var pd2 = null;
	$scope.tempFromDate = null;
	$scope.tempToDate = null;
    $scope.popup_date = {
        ...
        onShown: function (e) {
            ...
            pd1 = $(".date1").pDatepicker({
                ...
                onSelect: function (unix) {
                    ...
                    $scope.$apply(function () {
						$scope.tempFromDate = new Date(unix);
            ...
            pd2 = $(".date2").pDatepicker({
                ...
                onSelect: function (unix) {
                    $scope.$apply(function () {
						$scope.tempToDate = new Date(unix);
	...
	$scope.btn_submitDate = {
        ...
        bindingOptions: {},
        onClick: function (e) {
            $scope.dt_from = $scope.tempFromDate;
			$scope.dt_to = $scope.tempToDate;
			pd1.destroy();
            pd2.destroy();
			$scope.popup_date_visible = false;
    ...
    $scope.statusDs = [
        ...
        { Id: -2, Title: 'All (includes cnl flights)' },
		{ Id: -3, Title: 'All (excludes cnl flights)' },
    ];
    $scope.statuses = [];
    $scope.tag_status = {
...
$scope.sb_timeunit = {
        ...
        onSelectionChanged: function (e) {
            ...
            switch (e.selectedItem) {
                case 'ALL':
                    ...
                    $scope.dg_flight_instance.columnOption('newstd_local', 'visible', true);
                    ...
                    $scope.dg_flight_instance.columnOption('newstd_utc', 'visible', true);
                ...
                case 'LOCAL':
                    ...
                    $scope.dg_flight_instance.columnOption('newstd_utc', 'visible', false);
                ...
                case 'UTC':
                    ...
                    $scope.dg_flight_instance.columnOption('newstd_local', 'visible', false);
 ...
 $scope._code = 'IATA';
    ...
    $scope.bind = function () {
        ...
        flightService.getFlightDailyReport(_df, _dt, _org, _des, _regs, _route, _no, _idx, _type2, _chr, _status).then(function (response) {
            $scope.loadingVisible = false;

            $.each(response, function (_i, _d) {
				
				if(_d.FlightStatusID == 4) {
					_d.FlightTime = 0;
					_d.BlockTime = 0;
				}
				if(_d.FlightType2.includes('خارج')){
					var nFrom = 0;
					if(['NJF','KWI'].indexOf( _d.FromAirportIATA)!=-1) //utc +3
						nFrom = +30;
					else if(['MCT','TBS','BUS','EVN','DXB','DWC'].indexOf( _d.FromAirportIATA)!=-1) //utc +4
						nFrom = -30;
					else if(['KBL','KDH'].indexOf( _d.FromAirportIATA)!=-1) //utc +4.5
						nFrom = -60;
					else if(['SCO','DYU','TAS'].indexOf( _d.FromAirportIATA)!=-1) //utc +5
						nFrom = -90;
					else if(['ALA','FRU'].indexOf( _d.FromAirportIATA)!=-1) //utc +6
						nFrom = -150;
						
					var nTo = 0;
					if(['NJF','KWI'].indexOf( _d.ToAirportIATA)!=-1) //utc +3
						nTo = +30;
					else if(['MCT','TBS','BUS','EVN','DXB','DWC'].indexOf( _d.ToAirportIATA)!=-1) //utc +4
						nTo = -30;
					else if(['KBL','KDH'].indexOf( _d.ToAirportIATA)!=-1) //utc +4.5
						nTo = -60;
					else if(['SCO','DYU','TAS'].indexOf( _d.ToAirportIATA)!=-1) //utc +5
						nTo = -90;
					else if(['ALA','FRU'].indexOf( _d.ToAirportIATA)!=-1) //utc +6
						nTo = -150;
					//if(nFrom!= 0)
						//console.log(_d.STD, _d.NEWSTD, _d.Departure, _d.BlockOff, _d.TakeOff);
					//if(nTo!= 0)
						//console.log(_d.STA, _d.Arrival, _d.BlockOn, _d.Landing);
					if(nFrom != 0) {
						_d.STD = (new Date(_d.STD)).addMinutes(nFrom);
						_d.NEWSTD = (_d.NEWSTD != null) ? (new Date(_d.NEWSTD)).addMinutes(nFrom) : null;
						_d.Departure = (new Date(_d.Departure)).addMinutes(nFrom);
						_d.BlockOff = (new Date(_d.BlockOff)).addMinutes(nFrom);
						_d.TakeOff = (new Date(_d.TakeOff)).addMinutes(nFrom);
						_d.BlockTime -= nFrom;						
						_d.FlightTime -= nFrom;
						_d.ScheduledTime -= nFrom;
					}
					if(nTo != 0){
						_d.STA = (new Date(_d.STA)).addMinutes(nTo);
						_d.Arrival = (new Date(_d.Arrival)).addMinutes(nTo);
						_d.BlockOn = (new Date(_d.BlockOn)).addMinutes(nTo);
						_d.Landing = (new Date(_d.Landing)).addMinutes(nTo);
						_d.BlockTime += nTo;						
						_d.FlightTime += nTo;
						_d.ScheduledTime += nTo;
					}
    ...
    $scope.export = function () {
        ...
        $window.open(apiDaily + 'api/flight/daily/export?' + 'df=' + _df + '&dt=' + _dt + '&from=' + _org + '&to=' + _des + '&regs=' + _regs + '&routes=' + _route + '&no=' + _no + '&idx=' + _idx + '&status=' + _status + '&type2=' + _type2 + '&chr=' + _chr
 ...
 onValueChanged:function(e){
    ...
    $scope.dg_flight_columns = [
		...
		{caption:'Date', alignment: 'center',columns:[
		 //{ dataField: 'TakeOffDay', caption: 'AD', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 120, format: 'yy-MMM-dd', fixed: false, fixedPosition: 'left' },
        //{ dataField: 'TakeOffDayLocal', caption: 'Shamsi', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 120, fixed: false, fixedPosition: 'left' , sortIndex: 0, sortOrder: 'asc',},
		{ dataField: 'STDDayLocal', caption: 'AD', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 120, format: 'yyyy-MM-dd', fixed: false, fixedPosition: 'left',sortIndex: 0, sortOrder: 'asc' },
        ...
        //{ dataField: 'ChertererSold', caption: 'Charter Sale', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120, },
        {
            caption: 'Baggage', alignment: 'center', columns: [
                { dataField: 'BaggageCount', caption: 'PCs', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
        ...
        },
        {
            caption: 'Cargo', alignment: 'center', columns: [
                { dataField: 'CargoCount', caption: 'PCs', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
        ...
        {
            caption: 'Extra Baggage', alignment: 'center', columns: [
                { dataField: 'ExBagWeight', caption: 'Weight', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, name: 'exbag_weight' },
                { dataField: 'ExBagCost', caption: 'Cost', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, name: 'exbag_cost' },
            ]
        },
      ...
      {caption:'Ref. STD',alignment: 'center',columns:[
        ...
        {caption: 'New STD', alignment: 'center', columns: [
                { dataField: 'NEWSTDLocal', caption: 'LOCAL', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm', sortIndex: 3, sortOrder: 'asc', name: 'newstd_local' },
                { dataField: 'NEWSTD', caption: 'UTC', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm', sortIndex: 4, sortOrder: 'asc', name: 'newstd_utc' },
            ]},
   ...
   {caption:'TakeOff',alignment: 'center',columns:[
    { dataField: 'TakeOffLocal', caption: 'LOCAL', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm',name:'takeoff_local' },
        ...
        { dataField: 'JLFlightTime2', caption: 'J/L Flight', allowResizing: true, alignment: 'center', dataType: 'datetime', format: 'HH:mm', allowEditing: false, width: 100 },
...
{caption:'OffBlock',alignment: 'center',columns:[
  { dataField: 'BlockOffLocal', caption: 'LOCAL', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm',name:'offblock_local' },
      ...
      {caption:'OnBlock',alignment: 'center',columns:[
        ...
        { dataField: 'JLBlockTime2', caption: 'J/L Block', allowResizing: true, alignment: 'center', dataType: 'datetime', format: 'HH:mm', allowEditing: false, width: 100 },
        


        { dataField: 'Delay2', caption: 'Delay OffBlock', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120, },
        { dataField: 'Delay3', caption: 'Delay TakeOff', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120, },
		...
		{
            caption: 'Airports Distance', alignment: 'center', columns: [
                { dataField: 'Distance', caption: 'KM', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 80, name: 'distance_km' },
                { dataField: 'DistanceNM', caption: 'NM', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 80, name: 'distance_nm' },
            ]
        },
    ...
    $scope.dg_flight = {
        ...
        onContentReady: function (e) {
			console.log($scope.dg_flight_ds);
            if (!$scope.dg_flight_instance)
        ...
        summary: {
            ...
            calculateCustomSummary: function (options) {
				...
				if (options.name === "DelayTotal_Takeoff") {
                    if (options.summaryProcess === "start") {
                        options.totalValueMinutes = 0;
                        options.totalValue = '';
                    ...
                    if (options.summaryProcess === "calculate") {
                        ...
                        options.totalValueMinutes = options.totalValueMinutes + options.value.DelayTakeoff;
                        options.totalValue = pad(Math.floor(options.totalValueMinutes / 60)).toString() + ':' + pad(options.totalValueMinutes % 60).toString();

                    }
                }
                if (options.name === "DelayAvg_Takeoff") {
                    if (options.summaryProcess === "start") {
                        options.totalValueMinutes = 0;
                        options.totalValue = '';
                        options.cnt = 0;
