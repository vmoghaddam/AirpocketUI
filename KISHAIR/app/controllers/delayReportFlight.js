...
app.controller('delayReportFlightController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', '$window',function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route,$window) {
    ...
    $scope.dg_codes = {
	 ...
	 $scope.bindDetails=function(){
		 //$scope._fltid
		 flightService.getDelayItems($scope._fltid).then(function (response) {
            $scope.loadingVisible = false;
    ...
    $scope.dg_flight_columns = [
        ...
        },
        {
            caption: 'Delay',
            columns: [
                { dataField: 'Delay2', caption: 'MVT', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 90 },
				{ dataField: 'Items2', caption: 'USER', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 90 },
