...
app.controller('usersController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route) {
    ...
    $scope.sb_employees = {
        ...
        onSelectionChanged: function (arg) {
            ...
            if ($scope.employee) {
                ...
                //JobGroupCode
                $scope.dto.IsFlightCrew = $scope.employee.JobGroupCode.startsWith('00101') || $scope.employee.JobGroupCode.startsWith('00102');
                $scope.dto.IsCockpit = $scope.employee.JobGroupCode.startsWith('00101');
                $scope.dto.IsCabin = $scope.employee.JobGroupCode.startsWith('00102');
                $scope.dto.IsFD = $scope.employee.JobGroupCode == '00103';
                $scope.dto.IsFM = $scope.employee.JobGroupCode =='004';
                $scope.dto.IsFLM = $scope.employee.JobGroupCode == '005';
            }
    ...
    $scope.btn_edit = {
        ...
        onClick: function (e) {
           ...
           $scope.dto = {
               ...
               Post: selected.Post,
               IsDisabled: selected.IsDisabled ? 1 : 0,
			   IsLocked: selected.IsLocked ? 1 : 0,
               Remark: selected.Remark,
               IsFlightCrew: selected.IsFlightCrew,
               IsCabin: selected.IsCabin,
               IsCockpit: selected.IsCockpit,
               IsFD: selected.IsFD,
               IsFM: selected.IsFM,
               IsFLM: selected.IsFLM,
               Roles: null,
			   EditWindow: selected.EditWindow,
	...
	$scope.txt_editwindow = {
        hoverStateEnabled: false,
        bindingOptions: {
            value: 'dto.EditWindow',
    ...
    $scope.popup_add.toolbarItems[0].options.onClick = function (e) {
       ...
       // alert($scope.dto.Roles);
        ...
        $scope.dto.Email = $scope.dto.UserName.replace(/\s/g, '') + '.'+$scope.dto.FirstName.replace(/\s/g, '') + '.' + $scope.dto.LastName.replace(/\s/g, '') + '@airpocket.ir';
        $scope.dto.IsDisabled = $scope.dto.IsDisabled ? 1 : 0;
		$scope.dto.EditWindow = $scope.dto.EditWindow == "" ? null : $scope.dto.EditWindow;
        $scope.loadingVisible = true;
        if (!$scope.IsEdit) {
            if ($scope.personId)
    ...
    $scope.dg_flight_total_columns = [
        ...
        { dataField: 'IsDisabled', caption: 'Dis.', allowResizing: true, alignment: 'center', dataType: 'boolean', allowEditing: true, width: 80, fixed: true, fixedPosition: 'left' },
		{ dataField: 'IsLocked', caption: 'Lck.', allowResizing: true, alignment: 'center', dataType: 'boolean', allowEditing: true, width: 80, fixed: true, fixedPosition: 'left' },
         { dataField: 'UserName', caption: 'UserName',width:150, allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, fixed: true, fixedPosition: 'left',  },
        { dataField: 'LastName', caption: 'Last Name',width:200, allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, fixed: false, fixedPosition: 'left', },
        { dataField: 'FirstName', caption: 'First Name',width:170, allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, fixed: false, fixedPosition: 'left', },
          
        { dataField: 'PhoneNumber', caption: 'Phone', width: 120, allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, fixed: false, fixedPosition: 'left', },

        { dataField: 'IsFlightCrew', caption: 'Crew', allowResizing: true, alignment: 'center', dataType: 'boolean', allowEditing: true, width: 80, },
        //{ dataField: 'IsCockpit', caption: 'Cockpit', allowResizing: true, alignment: 'center', dataType: 'boolean', allowEditing: true, width: 80, },
        //{ dataField: 'IsCabin', caption: 'Cabin', allowResizing: true, alignment: 'center', dataType: 'boolean', allowEditing: true, width: 80, },
        { dataField: 'IsFD', caption: 'FD', allowResizing: true, alignment: 'center', dataType: 'boolean', allowEditing: true, width: 80, },
        { dataField: 'IsFM', caption: 'FM', allowResizing: true, alignment: 'center', dataType: 'boolean', allowEditing: true, width: 80, },
        { dataField: 'Department', caption: 'Department', width: 150, allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, fixed: false, fixedPosition: 'left', },
        { dataField: 'Post', caption: 'Post', width: 120, allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, fixed: false, fixedPosition: 'left', },
        { dataField: 'Station', caption: 'Station', width: 100, allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, fixed: false, fixedPosition: 'left', },
		{ dataField: 'EditWindow', caption: 'Edit Window (hr)', width: 150, allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, fixed: false, fixedPosition: 'left', },
        { dataField: 'Remark', caption: 'Remark', minWidth: 250, allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, fixed: false, fixedPosition: 'left', },
    ...
    $scope.dg_flight_total = {
        ...
        onRowPrepared: function (e) {
            ...
            if (e.rowType === "data" && e.data.IsDisabled) {

                e.rowElement.css("backgroundColor", "#ffa64d");
            }
            //42 %  10
