...
app.controller('personAddController', ['$scope', '$location', 'personService', 'authService', '$routeParams', '$rootScope', '$window', 'trnService', function ($scope, $location, personService, authService, $routeParams, $rootScope, $window, trnService) {
    ...
    $scope.IsEditable = $rootScope.roles.indexOf('Admin') != -1 || $rootScope.userName.toLowerCase() == 'mohammadifard'
	  ...
	  || $rootScope.userName.toLowerCase() == '82356'
	  || $rootScope.userName.toLowerCase() == '82817'
	  || $rootScope.userName.toLowerCase() == '81148'
	  || $rootScope.userName.toLowerCase() == '82356'
	  || $rootScope.userName.toLowerCase() == '93207'
	  || $rootScope.userName.toLowerCase() == '84189'
	  || $rootScope.userName.toLowerCase() == '85309'
	  || $rootScope.userName.toLowerCase() == '86564'
	  || $rootScope.userName.toLowerCase() == '84207'
        ;

    $scope.IsTrainingReadOnly = $rootScope.userName.toLowerCase() == 'trn.barzegar' || $rootScope.userName.toLowerCase() == 'trn.rezaei' || $rootScope.userName.toLowerCase() == 'trn.abdollahi' || $rootScope.userName.toLowerCase() == '84189' || $rootScope.userName.toLowerCase() == '93207' || $rootScope.userName.toLowerCase() == '81148';
    $scope.IsLicReadOnly = $rootScope.userName.toLowerCase() == 'trn.abdollahi' || $rootScope.userName.toLowerCase() == 'trn.moradi' || $rootScope.userName.toLowerCase() == '93207' || $rootScope.userName.toLowerCase() == '82817' || $rootScope.userName.toLowerCase() == '84207';
    $scope.IsCerDisabled = $rootScope.userName.toLowerCase() == 'ops.soltani';

    $scope.IsTrainingDisabled = $rootScope.userName.toLowerCase() == 'trn.barzegar' || $rootScope.userName.toLowerCase() == 'trn.rezaei' || $rootScope.userName.toLowerCase() == '84189' || $rootScope.userName.toLowerCase() == '81148';
    $scope.IsLicDisabled = $rootScope.userName.toLowerCase() == 'trn.moradi'  || $rootScope.userName.toLowerCase() == 'trn.tanhaei'
	|| $rootScope.userName.toLowerCase() == '82817' || $rootScope.userName.toLowerCase() == '85309' || $rootScope.userName.toLowerCase() == '86564' || $rootScope.userName.toLowerCase() == '84207';
    ...
    $scope.date_DangerousGoodsIssueDate = {
        ...
        onValueChanged: function (e) {
            ...
            //    return;
		if ($scope.IsDispatch())
            $scope.entity.Person.DangerousGoodsExpireDate = (new Date(e.value)).addYears(3);
		else
    ...
    $scope.date_SMSIssueDate = {
        ...
        onValueChanged: function (e) {
            ...
            $scope.entity.Person.SMSExpireDate = (new Date(e.value)).addYears(2);
        },
        bindingOptions: {
    ...
    $scope.date_DateIssueNDT = {
        ...
        onValueChanged: function (e) {
            ...
            $scope.entity.Person.DateExpireNDT = (new Date(e.value)).addYears(3);
        },
        bindingOptions: {
    ...
    $scope.date_PBNRNAVIssueDate = {
        ...
        onValueChanged: function (e) {
             ...
             $scope.entity.Person.PBNRNAVExpireDate = (new Date(e.value)).addYears(3);
         },
        bindingOptions: {
    ...
    $scope.date_ProficiencyCheckDate = {
        ...
        bindingOptions: {
            ...
            readOnly: false, //'IsLicReadOnly',
            disabled:false //'IsCerDisabled',
        }
    };
    //soltani
    ...
    $scope.IsDispatch = function () {
        if (!$scope.selectedJobGroup)
            return false;
        return $scope.selectedJobGroup.FullCode.startsWith('00103');
    };
    $scope.sb_group = {
        showClearButton: true,
        searchEnabled: true,
