...
app.controller('delayReportController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', '$window',function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route,$window) {
    ...
    $scope.btn_print = {
        ...
        onClick: function (e) {
            ...
            if ($scope.range)
                range = $scope.range;
            $window.open('https://kreport.airpocket.online/frmreportview.aspx'+ '?type=3&p=' + days + '&df=' + _dfrom+'&dt='+_dto+'&cats='+cts+'&range='+range, '_blank');
    ...
    $scope.dg_flight_columns = [
        ...
        },
        {
            caption: 'Delay',
            columns: [
                { dataField: 'Delay2', caption: 'hh:mm', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 90 },
                { dataField: 'Delay', name: 'Delaymm', caption: 'mm', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 90 },
               ...
               // { dataField: 'MapTitle2', caption: 'Category', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 150 },
			    { dataField: 'ICategory', caption: 'Category', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 150 },
               { dataField: 'Code', caption: 'Code', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 70 }, 
{ dataField: 'DelayRemark', caption: 'Remark', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 350 },			   
...
'TECHNICAL'
    ...
    if (!authService.isAuthorized()) {
        ...
        $rootScope.page_title = '> Delays Report';


        $('.delaysreport').fadeIn(400, function () {
