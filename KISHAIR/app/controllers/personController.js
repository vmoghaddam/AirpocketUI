...
app.controller('personController', ['$scope', '$location', '$routeParams', '$rootScope', 'personService', 'authService', 'notificationService', 'flightService', '$route', 'trnService', '$window', '$timeout', function ($scope, $location, $routeParams, $rootScope, personService, authService, notificationService, flightService, $route, trnService, $window, $timeout) {
    ...
    $scope.IsTrainingDisabled = $rootScope.userName.toLowerCase() == 'trn.barzegar' || $rootScope.userName.toLowerCase() == 'trn.rezaei' || $rootScope.userName.toLowerCase() == 'trn.abdollahi' || $rootScope.userName.toLowerCase() == '81148' || $rootScope.userName.toLowerCase() == '84189';
    $scope.IsLicDisabled = $rootScope.userName.toLowerCase() == 'trn.moradi' ||  $rootScope.userName.toLowerCase() == 'trn.tanhaei' || $rootScope.userName.toLowerCase() == '82817' ||  $rootScope.userName.toLowerCase() == '85309';
    ...
    $scope.groupDs = ['Cockpit', 'Cabin', 'Dispatch' ];
    $scope.dg_columns2 = [
    ...
    if (!$scope.IsTrainingDisabled) {
        $scope.dg_columns2.push(
			...
			{ dataField: 'RemainNDT', caption: '3YR Recurrent', name: '3YR Recurrent', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 120 },
            ...
            { dataField: 'RemainProficiency', caption: 'English', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 90 , visible: false},
    ...
    $scope.sb_rankgroup = {
        ...
        searchEnabled: false,
        dataSource: ['Cockpit','Cabin','Dispatch' ,'All'],
        //readOnly:true,
        onValueChanged: function (e) {
            ...
            if (e.value == 'Cockpit') {
				...
				$scope.dg_instance.columnOption('3YR Recurrent', 'visible', true);
                $scope.dg_instance.columnOption('English', 'visible', false);
				$scope.dg_instance.columnOption('AvSec', 'visible', false);
                //04-30
                $scope.dg_instance.columnOption('SEPTT', 'caption', 'ESET');
            }  else if (e.value == 'Dispatch') {
                $scope.dg_instance.columnOption('Licence', 'visible', false);
                $scope.dg_instance.columnOption('CMC', 'visible', false);
                $scope.dg_instance.columnOption('LPC', 'visible', false);
                $scope.dg_instance.columnOption('OPC', 'visible', false);
                $scope.dg_instance.columnOption('ESET', 'visible', false);
                $scope.dg_instance.columnOption('SEPT-P', 'visible', false);
                $scope.dg_instance.columnOption('Line', 'visible', false);
                $scope.dg_instance.columnOption('Hot W.', 'visible', false);
                $scope.dg_instance.columnOption('Cold W.', 'visible', false);
                $scope.dg_instance.columnOption('SMS', 'visible', false);
                $scope.dg_instance.columnOption('PreFlight', 'visible', false);
				$scope.dg_instance.columnOption('LPR', 'visible', true);
                $scope.dg_instance.columnOption('Recurrent', 'visible', true);
                $scope.dg_instance.columnOption('English', 'visible', true);
				$scope.dg_instance.columnOption('3YR Recurrent', 'visible', false);
				$scope.dg_instance.columnOption('AvSec', 'visible', false);
            } else if (e.value == 'Cabin') {
                ...
                $scope.dg_instance.columnOption('English', 'visible', false);
				$scope.dg_instance.columnOption('3YR Recurrent', 'visible', false);
				$scope.dg_instance.columnOption('AvSec', 'visible', true);
				$scope.dg_instance.columnOption('Hot W.', 'visible', false);
                $scope.dg_instance.columnOption('Cold W.', 'visible', false);
                $scope.dg_instance.columnOption('PreFlight', 'visible', false);
