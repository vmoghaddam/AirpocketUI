'use strict';
app.controller('formmovaledYearlyController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', '$window', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route, $window) {
    ...
    $scope.bind = function () {
        ...
        flightService.getFormAYearlyReport($scope.yf, $scope.yt).then(function (response) {
    ...
    $scope.dg_total_columns = [
       ...
       // { dataField: 'YearMonth', caption: 'سال/ماه', allowResizing: true, alignment: 'center', dataType: 'numeric', allowEditing: false, fixed: true, fixedPosition: 'right', width: 170 },
    ...
    if (!authService.isAuthorized()) {
        ...
        $rootScope.page_title = '> Air Transport Yearly Report - فرم مولد';


        $('.formmovaledyearly').fadeIn(400, function () {
    ...
    $scope.btn_print = {
        ...
        onClick: function (e) {
            ...
            $window.open($rootScope.reportServer + '?type=6&year=' + $scope.reportData.Year , '_blank');
            // $scope.bindReport();
