'use strict';
app.controller('boardTestController', ['$scope', '$location', '$routeParams', '$rootScope', '$timeout', 'flightService', 'weatherService', 'aircraftService', 'authService', 'notificationService', '$route', '$window', 'fbService', '$http','$q','logService', function ($scope, $location, $routeParams, $rootScope, $timeout, flightService, weatherService, aircraftService, authService, notificationService, $route, $window, fbService, $http,$q,logService) {
...
////////////////////////////////////////////////////////
 ...
 //janfe
    ...
    $scope.bindFlights = function (callback) { 
        ...
        logService.getFlightsGanttUTCNew(Config.CustomerId, (new Date($scope.datefrom)).toUTCDateTimeDigits(), ed, /*offset*/0, null, 1, filter).then(function (response) {
        var endTime = performance.now()           
		   try {
			   console.log(`Call to doSomething took ${endTime - startTime} milliseconds`)
			    ...
			    console.log(`2 Call to doSomething took ${endTime - startTime} milliseconds`)
                callback();
            }
            catch (ex) {
                alert(ex);
    ...
    $scope.initSelection = function () {  
        ...
        $scope.selectionElement = Selection.create({
            ...
            $.each(selected, function (_i, _d) {
				console.log(_d);
                  // console.log('___sel',_d.data('flightId'));
                var $d = $(_d);
			...
			console.log('___sel',_ids);
			console.log('___sel',$scope.ati_selectedFlights);
