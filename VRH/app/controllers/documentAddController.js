...
app.controller('documentAddController', ['$scope', '$location', 'libraryService', 'authService', '$routeParams', '$rootScope', function ($scope, $location, libraryService, authService, $routeParams, $rootScope) {
    ...
    $scope.sb_sender = {
        ...
        searchEnabled: true,
        dataSource: ['Safety & QA Department','Flight Operations Department'],
    ...
    $scope.sb_Category = {
        ...
        showClearButton: true,
        searchEnabled: true,
        dataSource: [{ Id: 10007, Title: 'PIF' }, { Id: 10008, Title: 'CIF' }, { Id: 95, Title: 'DIF' }, { Id: 300063, Title: 'Safety Notice'},], //$rootScope.getDatasourceOption(94),
        displayExpr: "Title",
        valueExpr: 'Id',
        onSelectionChanged: function (e) {
            ...
            if (e.selectedItem.Id == 10007) {
                ...
                var exist = Enumerable.From($scope.grp_ds).Where(function (x) { return x.code == '00101'; }).FirstOrDefault();
                if (exist)
                    exist.selected = true;
            }
