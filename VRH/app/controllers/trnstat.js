...
$scope.active = 1;
    ...
    $scope.dg_course_columns = [
        ...
        { dataField: 'LastName', caption: 'LastName', allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, width: 180, fixed: true, fixedPosition: 'left' },
        ...
        { dataField: 'CourseType', caption: 'Type', allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, width: 160, fixed: true, fixedPosition: 'left' },
        { dataField: 'No', caption: 'ClassID', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 100, fixed: true, fixedPosition: 'left' },
        ...
        { dataField: 'CoursePeopleStatus', caption: 'Result', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 100, fixed: true, fixedPosition: 'right' },
        { dataField: 'DateIssue', caption: 'Issue', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, format: 'yyyy-MMM-dd', width: 110, fixed: true, fixedPosition: 'right' },
        { dataField: 'DateExpire', caption: 'Expire', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, format: 'yyyy-MMM-dd', width: 110, fixed: true, fixedPosition: 'right' },
        { dataField: 'Remains', caption: 'Rem.', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 80, fixedPosition: 'right', fixed: true },
        //04-30
    ...
    $scope.bind = function () {
        if ($scope.selectedTab.id == 'course') {
            ...
            $scope.loadingVisible = true;
             trnService.getTrnStatCoursePeople(_df, _dt, $scope.coursetype ? $scope.coursetype : -1, result, $scope.status ? $scope.status : -1, '-1', '-1', ($scope.inst1 ? $scope.inst1 : -1), ($scope.inst2 ? $scope.inst2 : -1), ($scope.rank ? $scope.rank : 1), ($scope.active ? $scope.active : 1), ($scope.grp ? $scope.grp:-1)).then(function (response) {
                $scope.loadingVisible = false;
	...
	$scope.group_ds = {
        store: {
            type: "odata",
            url: $rootScope.serviceUrl + 'odata/base/jobgroups/' + '4',
