    ...
    $scope.dg_columns2 = [
       ...
       // { dataField: 'RemainCAO', caption: 'GRT', name: 'GRT', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100 },
        ...
        { dataField: 'RemainCMC', caption: 'CMC', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 90 },
		 ...
		 { dataField: 'RemainEGPWS', caption: 'FMT', name: 'FMT', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100 ,visible:false},
...
$scope.dg_instance.columnOption('FMT', 'visible', e.value == 'Cabin');
...
$scope.dg_instance.columnOption('HF', 'visible', e.value == 'CRM' || e.value == 'GRND' || e.value == 'COMM' 
...
$scope.dg_instance.columnOption('AVSEC2', 'visible', ['CATERING','SECURITY','SUPPORT','OPERATION','CRM','LOGISTIC','ADMINISTRATIVE'].indexOf( e.value)!=-1);
