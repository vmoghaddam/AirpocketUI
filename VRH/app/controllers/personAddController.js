...
$scope.entity.Person.LAR_IssueDate= null;
$scope.entity.Person.LOAD_CONTROL_IssueDate= null;
$scope.entity.Person.LAR_ExpireDate= null;
...
$scope.entity.Person.LAR_IssueDate= data.LAR_IssueDate;
$scope.entity.Person.LOAD_CONTROL_IssueDate= data.LOAD_CONTROL_IssueDate;
$scope.entity.Person.LAR_ExpireDate= data.LAR_ExpireDate;
...
$scope.date_Type737IssueDate = {
   ...
   $scope.date_EGPWSIssueDate = {
    ...
    $scope.date_UpsetRecoveryTrainingIssueDate = {
        ...
        onValueChanged: function (e) {
          ...
          //      return;
			...
			//if ($scope.isNew || !$scope.entity.Person.UpsetRecoveryTrainingExpireDate)
			var y=1;
			if ($scope.group_title=="Flight Dispatcher")
				y=3;
            $scope.entity.Person.UpsetRecoveryTrainingExpireDate = (new Date(e.value)).addYears(y);
        },
        bindingOptions: {
	...
	$scope.cal_exp_dates=function(grp){
		 
	  if (grp=='Flight Dispatcher' && $scope.entity && $scope.entity.Person.UpsetRecoveryTrainingIssueDate){
	     $scope.entity.Person.UpsetRecoveryTrainingExpireDate = (new Date($scope.entity.Person.UpsetRecoveryTrainingIssueDate)).addYears(3);
		  //alert(grp);
	  }
		else if ($scope.entity && $scope.entity.Person.UpsetRecoveryTrainingIssueDate){
			 $scope.entity.Person.UpsetRecoveryTrainingExpireDate = (new Date($scope.entity.Person.UpsetRecoveryTrainingIssueDate)).addYears(1);
		}
		
		if (grp=='Flight Dispatcher' && $scope.entity && $scope.entity.Person.ERPIssueDate){
	      $scope.entity.Person.ERPExpireDate = (new Date($scope.entity.Person.ERPIssueDate)).addYears(2);
		  //alert(grp);
	    }
    ...
    $scope.sb_group = {
		...
		onSelectionChanged:function(e){
			...
			$scope.cal_exp_dates($scope.group_title);
...
if ($scope.entity.Person.IssueDate23)
 ...
 if ($scope.entity.Person.ExpireDate26)
		...
		if ($scope.entity.Person.LAR_IssueDate)
            $scope.entity.Person.LAR_IssueDate = (new Date($scope.entity.Person.LAR_IssueDate)).addMinutes(offset);
...
if ($scope.entity.Person.LAR_ExpireDate)
            $scope.entity.Person.LAR_ExpireDate = (new Date($scope.entity.Person.LAR_ExpireDate)).addMinutes(offset);
   ...
   $scope.date_DateIssue3 = {
	...
	$scope.date_DateIssue6 = {
        ...
        onValueChanged: function (e) {
			...
			var	y=3;
            $scope.entity.Person.ExpireDate6 = (new Date(e.value)).addYears(y);
	...
	$scope.date_LAR_IssueDate = {
        ...
        onValueChanged: function (e) {
            ...
            if (!e.value) {
			 ...
			 $scope.entity.Person.LAR_ExpireDate = (new Date(e.value)).addYears(3); 
            
        },
        bindingOptions: {
            value: 'entity.Person.LAR_IssueDate',
            readOnly: 'IsMainDisabled',
        }
    };
	
	
	$scope.date_LAR_ExpireDate = {
        width: '100%',
        type: 'date',
        displayFormat: $rootScope.DateBoxFormat,

        bindingOptions: {
            value: 'entity.Person.LAR_ExpireDate',
            readOnly: 'IsMainDisabled',
        }
    };
	...
	$scope.date_LOAD_CONTROL_IssueDate = {
        ...
        onValueChanged: function (e) {
            ...
            if (!e.value) {
			 ...
			 $scope.entity.Person.LOAD_CONTROL_ExpireDate = (new Date(e.value)).addYears(3); 
