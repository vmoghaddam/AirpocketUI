'use strict';
app.controller('reportlogduty', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', 'flightBagService', 'qalogService', '$sce', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route, flightBagService, qalogService, $sce) {
    ...
    $scope.bind = function () {
      ...
      //  var dt = moment($scope.dt_to).format('YYYY-MM-DD');
       // $scope.loadingVisible = true;
        ...
        qalogService.getProfilesCrew().then(function (response) {
    ...
    $scope.bindDetails = function (cid,pid) {
        //iruser558387
       ...
       $scope.loadingVisible = true;
        ...
        qalogService.getDutyLog(cid).then(function (response) {
            $scope.loadingVisible = false;

            console.log(response);
            $scope.dg_det_crew_ds = response.Data ;
    ...
    $scope.dg_profile_columns = [
        ...
        { dataField: 'Name', caption: 'Name', allowResizing: true, alignment: 'left', dataType: 'string', allowEditing: false, width: 200, fixed: screen.width > 1024 ? true : false, fixedPosition: 'left' },
 ...
 { dataField: 'NID', caption: 'NID', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 130 },
    ...
    $scope.dg_profile = {
        ...
        onSelectionChanged: function (e) {
            ...
            if (!data) {
                ...
                $scope.bindDetails($scope.selectedProfile.Id,$scope.selectedProfile.PersonId);
            }
       ...
       // { dataField: 'Username', caption: 'User', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 130, fixed: true, fixedPosition: 'left' },
...

        {
            caption: 'Issue Date', columns: [
                { dataField: 'DateIssueOld', caption: 'Old Value', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, minWidth: 170, fixed: false, fixedPosition: 'left' },
                { dataField: 'DateIssue', caption: 'New Value', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, minWidth: 170 },
            ]
        },

        {
            caption: 'Expire Date', columns: [
                { dataField: 'DateExpireOld', caption: 'Old Value', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, minWidth: 170, fixed: false, fixedPosition: 'left',format: 'yyyy-MMM-dd' },
                { dataField: 'DateExpire', caption: 'New Value', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, minWidth: 170,format: 'yyyy-MMM-dd'  },
            ]
        },
    ...
    $scope.dg_det_crew_columns = [
        { dataField: 'DateCreate', caption: 'Date', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 140, format: 'yy-MMM-dd HH:mm', fixed: true, fixedPosition: 'left', sortIndex: 0, sortOrder: 'desc' },
        ...
        { dataField: 'CrewName', caption: 'Name', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 130, fixed: false, fixedPosition: 'left' },
        ...
        },
		{
            caption: 'RELATED',
            columns: [
			{ dataField: 'Log2_DateCreate', caption: 'Date', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 140, format: 'yy-MMM-dd HH:mm', fixed: false, fixedPosition: 'left',  },
			{ dataField: 'RelatedFDP_DutyType', caption: 'Type', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 130, fixed: false, fixedPosition: 'left' },
                //{ dataField: 'Position', caption: 'Pos', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120, fixed: false, fixedPosition: 'left' },
                //Route
                { dataField: 'RelatedFDP_Route', caption: 'Route', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 150, fixed: false, fixedPosition: 'left' },
                //Flights
                { dataField: 'RelatedFDP_Flts', caption: 'Flights', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 150, fixed: false, fixedPosition: 'left' },
				{ dataField: 'RelatedFDP_InitStart', caption: 'Start', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 140, format: 'yy-MMM-dd HH:mm', fixed: false, fixedPosition: 'left', sortIndex: 0, sortOrder: 'asc' },
    ...
    $scope.dg_det_crew = {
        ...
        onRowPrepared: function (e) {
            if (e.data &&  e.data.RelatedFDP_Id  ) {
    ...
    if (!authService.isAuthorized()) {
        ...
        $rootScope.page_title = '> Profiles Log';


        $('.reportlogduty').fadeIn(400, function () {
