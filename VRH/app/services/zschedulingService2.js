'use strict';
app.factory('zschedulingService2', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var _getFDPIndex = function (key, pos) {
        ...
        var deferred = $q.defer();
        $http.get(zscheduling + "api/sch/fdp/index/?key="+key+"&pos="+pos).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveDuty = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl + 'odata/duty/save'*/ zscheduling + 'api/duty/save', entity).then(function (response) {
    ...
    var _saveFDP = function (entity) {
        var deferred = $q.defer();
        var old_url = $rootScope.serviceUrl + 'odata/roster/fdp/save';
        var url = zscheduling + 'api/roster/fdp/save';
    ...
    var _deleteFDP = function (entity) {
        var deferred = $q.defer();
        $http.post(zscheduling + 'api/roster/fdp/delete', entity).then(function (response) {
    ...
    var _saveSTBY = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl + 'odata/roster/stby/save'*/zscheduling + 'api/roster/stby/save', entity).then(function (response) {
            //if (response.data)
            //    resp
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getRosterFDPs = function (df, dt) {
        ...
        var deferred = $q.defer();
        $http.get(/*serviceBase + 'odata/roster/fdps/' + '?df=' + df + '&dt=' + dt*/zscheduling +'api/sch/roster/fdps/' + '?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFDPStats = function (ids, dh) {
        if (!dh)
            dh = 0;
        var deferred = $q.defer();
        $http.get(zscheduling + 'api/fdp/stat/' + ids + '/' + dh).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _checkStbyActivation = function (extended, stbyid, leg, duty, maxfdp) {
        ...
        $http.get(zscheduling + 'api/stby/ceased/stat/' + extended + '/' + stbyid + '/' + leg + '/' + duty + '/' + maxfdp).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _fdpsOffbyFlights = function (entity) {
        ...
        $http.post(zscheduling + 'api/flights/off', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _activateStby = function (entity) {
        ...
        $http.post(zscheduling + 'api/stby/activate', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFTLByCrewIds = function (entity) {
        var deferred = $q.defer();
        $http.post(zscheduling + 'api/ftl/abs/crews/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFdpsByFlight = function (ids) {
        var deferred = $q.defer();
        $http.get(zscheduling + 'api/fdps/flight/' + ids).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewForRosterByDateNew = function (cid, dt) {
        var deferred = $q.defer();
        $http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/zscheduling + 'api/sch/crew/valid/?dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getCrewForGanttByDateNew = function (rnk,cid, dt) {
        var deferred = $q.defer();
        $http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/zscheduling + 'api/sch/crew/valid/gant'+(rnk?"?rank="+rnk:"")).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDutiesForGanttByDateNew = function (df, dt,rnk) {
        var deferred = $q.defer();
        $http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/zscheduling + 'api/sch/crew/duties/gant/?df='+df+'&dt='+dt+(rnk?"&rnk="+rnk:"")).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getDutiesForGanttByDateCrewNew = function (df, dt, crew) {
        var deferred = $q.defer();
        $http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/zscheduling + 'api/sch/crew/duties/gant/crew/?df=' + df + '&dt=' + dt + (  "&crewid=" + crew  )).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getSchFlights = function (df, dt) {
        var deferred = $q.defer();
        $http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/zscheduling + 'api/sch/flts/gant/?df=' + df + '&dt=' + dt).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _getFlightCrewsNew = function (id) {
        var deferred = $q.defer();
        $http.get(/*serviceBaseAPI + 'api/crew/valid/1?dt=' + dt*/zscheduling + 'api/sch/flight/crews/' + id).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _saveEventGroup = function (entity) {
        var deferred = $q.defer();
        $http.post(zscheduling + 'api/event/group/save/', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
