...
app.factory('libraryService', ['$http', '$q', 'ngAuthSettings', '$rootScope', function ($http, $q, ngAuthSettings, $rootScope) {
    ...
    var _exposeBook = function (entity) {
        var deferred = $q.defer();
        $http.post(/*$rootScope.serviceUrl*/zapinet + 'odata/library/book/expose', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
    ...
    var _save = function (entity) {
        var deferred = $q.defer();
        $http.post(zapinet + 'odata/library/book/save', entity).then(function (response) {
            deferred.resolve(response.data);
        }, function (err, status) {
