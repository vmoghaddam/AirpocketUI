...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when("/person", {
        ...
        templateUrl: "/app/views/person.html?v=81009"
    });
    ...
    $routeProvider.when("/library", {
        ...
        templateUrl: "/app/views/library.html?v=341",
        isDocument:false,
    });
    ...
    $routeProvider.when("/library/:type/:publisher/:author", {
        controller: "libraryController",
        templateUrl: "/app/views/library.html?v=708",
        isDocument: false,
    });
    ...
    $routeProvider.when("/document", {
        controller: "libraryController",
        templateUrl: "/app/views/document.html?v=677",
        isDocument: true,
    });
    ...
    $routeProvider.when("/delay/codes", {
	 ...
	 $routeProvider.when("/fixtimes", {
        controller: "fix_timesController",
        templateUrl: "/app/views/fix_time.html",
        isDispatch: false,
    });
    ...
    $routeProvider.when("/board", {
        ...
        templateUrl: "/app/views/board.html?v=4212051",
        isAdmin: true,
    });
    ...
    $routeProvider.when("/flights/efbs", {
        ...
        templateUrl: "/app/views/reportEFB.html?v=5063"
    });
    ...
    $routeProvider.when("/scheduling/xadminxxxx", {
        controller: "schedulingController",
        templateUrl: "/app/views/scheduling.html?v=101010",
        isAdmin: true,
    });
    $routeProvider.when("/schedulingxxxx", {
        controller: "schedulingController",
	...
	$routeProvider.when("/scheduling/z", {
        ...
        templateUrl: "/app/views/schedulingvrh.html?v=56" ,
        isAdmin: false,
    });
 ...
 $routeProvider.when("/report/flight/daily", {
  ...
  $routeProvider.when("/qa/dashboard", {
    ...
    $routeProvider.when("/qa/status/:type/:title", {
        ...
        templateUrl: "app/views/qaReportStatus.html?v=1103"
    });
	...
	$routeProvider.when("/duty/timeline/z", {
        ...
        templateUrl: "/app/views/zdutyTimeline.html?v=8556"
    });
